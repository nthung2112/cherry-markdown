import {
  ...
  aI as hr,
  aJ as lr,
} from "./index-B0beL7ox.js";
import { p as fr } from "./chunk-4BX2VUAB-CcLLIeQS.js";
import { p as cr } from "./treemap-KMMF4GRG-8nUewU-W.js";
import { c as Fe } from "./cytoscape.esm-5J0xJHOV.js";
import "./min-CeHOP0ym.js";
import "./baseUniq-DfLQT-4m.js";
var he = { exports: {} },
  le = { exports: {} },
  fe = { exports: {} },
  gr = fe.exports,
        ...
        (function (P, N) {
          ...
          return (function (A) {
            ...
            return (
              ...
              (N.d = function (u, h, a) {
                N.o(u, h) ||
                  Object.defineProperty(u, h, { configurable: !1, enumerable: !0, get: a });
              }),
              (N.n = function (u) {
                var h =
                  u && u.__esModule
                ...
                (o.prototype.remove = function (c) {
                  ...
                  if (c instanceof r) {
                    ...
                    for (var T = f.edges.slice(), d, v = T.length, L = 0; L < v; L++)
                      ((d = T[L]),
                        d.isInterGraph ? this.graphManager.remove(d) : d.source.owner.remove(d));
                    ...
                    (d.source.edges.splice(C, 1),
                      d.target != d.source && d.target.edges.splice(G, 1));
              ...
              ((a.prototype.addRoot = function () {
                ...
                (a.prototype.add = function (e, r, l, i, g) {
                  if (l == null && i == null && g == null) {
                    ...
                    if (t == o) return ((l.isInterGraph = !1), t.add(l, i, g));
                    if (
                      ((l.isInterGraph = !0),
                      (l.source = i),
                      (l.target = g),
                ...
                (a.prototype.remove = function (e) {
                  if (e instanceof u) {
                    ...
                    for (var i, g = l.length, t = 0; t < g; t++) ((i = l[t]), r.remove(i));
                    var o = [];
                    o = o.concat(r.getNodes());
                    var s;
                    g = o.length;
                    for (var t = 0; t < g; t++) ((s = o[t]), r.remove(s));
              ...
              ((h.calcSeparationAmount = function (a, e, r, l) {
                ...
                (h.getIntersection2 = function (a, e, r) {
                  var l = a.getCenterX(),
                    ...
                    g = e.getCenterX(),
                    t = e.getCenterY();
                  if (a.intersects(e)) return ((r[0] = l), (r[1] = i), (r[2] = g), (r[3] = t), !0);
                  var o = a.getX(),
                    s = a.getY(),
                    c = a.getRight(),
                    f = a.getX(),
                    ...
                    m = !1;
                  if (l === g) {
                    if (i > t) return ((r[0] = l), (r[1] = s), (r[2] = g), (r[3] = Y), !1);
                    if (i < t) return ((r[0] = l), (r[1] = T), (r[2] = g), (r[3] = C), !1);
                  } else if (i === t) {
                    if (l > g) return ((r[0] = o), (r[1] = i), (r[2] = G), (r[3] = t), !1);
                    if (l < g) return ((r[0] = c), (r[1] = i), (r[2] = b), (r[3] = t), !1);
                  } else {
                ...
                (h.getIntersection = function (a, e, r, l) {
                  ...
                  return (
                    ...
                    K === 0
                      ? null
                      : ((d = (C * Y - G * Z) / K), (v = (b * Z - L * Y) / K), new u(d, v))
                  );
                }),
            ...
            function (A, P, N) {
              ...
              ((o.RANDOM_SEED = 1),
                ...
                (o.prototype.getFlatForest = function () {
                  for (
                    var s = [], c = !0, f = this.graphManager.getRoot().getNodes(), T = !0, d = 0;
                    d < f.length;
                    d++
                  )
            ...
            function (A, P, N) {
              ...
              ((i.prototype.initParameters = function () {
                ...
                (i.prototype.calcIdealEdgeLengths = function () {
                  for (
                    var t, o, s, c, f, T, d, v = this.getGraphManager().getAllEdges(), L = 0;
                    L < v.length;
                    L++
                  )
                    ((t = v[L]),
                      ...
                      t.isInterGraph &&
                        ...
                        this.useSmartIdealEdgeLengthCalculation &&
                          (t.idealLength += T + d - 2 * e.SIMPLE_NODE_SIZE),
                ...
                (i.prototype.calcRepulsionForce = function (t, o) {
                  ...
                  if (s.intersects(c)) {
                    ...
                    ((t.repulsionForceX -= Y * G),
                      (t.repulsionForceY -= Y * Z),
                      (o.repulsionForceX += Y * G),
                      (o.repulsionForceY += Y * Z));
                  } else
                    (this.uniformLeafNodeSizes && t.getChild() == null && o.getChild() == null
                      ? ((d = c.getCenterX() - s.getCenterX()),
                        (v = c.getCenterY() - s.getCenterY()))
                      : (r.getIntersection(s, c, T), (d = T[2] - T[0]), (v = T[3] - T[1])),
                      Math.abs(d) < a.MIN_REPULSION_DIST && (d = l.sign(d) * a.MIN_REPULSION_DIST),
              ...
              var a = N(11),
                e = (function () {
                  function r(l, i) {
                    ...
                    var g = void 0;
                    (l instanceof a ? (g = l.size()) : (g = l.length),
                ...
                for (
                  ...
                  for (var c = t + 1; c < this.n; c++) {
                    if (
                      ...
                      f = -f / h[t][t];
                      for (var d = t; d < this.m; d++) h[d][c] += f * h[d][t];
                    }
                    e[c] = h[t][c];
                  }
                  if (
                  ...
                  if (t < g) {
                    e[t] = 0;
                    for (var L = t + 1; L < this.n; L++) e[t] = u.hypot(e[t], e[L]);
                    if (e[t] !== 0) {
                      e[t + 1] < 0 && (e[t] = -e[t]);
                    ...
                    if (
                      ...
                      for (var G = t + 1; G < this.n; G++)
                        for (var Z = t + 1; Z < this.m; Z++) r[Z] += e[G] * h[Z][G];
                  ...
                  for (var E = i - 1; E >= 0; E--)
                    if (this.s[E] !== 0) {
                      for (var y = E + 1; y < a; y++) {
                        ...
                        R = -R / this.U[E][E];
                        for (var S = E; S < this.m; S++) this.U[S][y] += R * this.U[S][E];
                      }
                      for (var W = E; W < this.m; W++) this.U[W][E] = -this.U[W][E];
                      this.U[E][E] = 1 + this.U[E][E];
                      for (var D = 0; D < E - 1; D++) this.U[D][E] = 0;
                    } else {
                ...
                for (var V = this.n - 1; V >= 0; V--) {
                  if (
                    ...
                    for (var X = V + 1; X < a; X++) {
                      ...
                      et = -et / this.V[V + 1][V];
                      for (var w = V + 1; w < this.n; w++) this.V[w][X] += et * this.V[w][V];
                    }
                ...
                return (
                  u(e, [
                    ...
                    },
                    {
                      key: "getAllIndexes",
                      value: function (l, i) {
                        for (var g = [], t = -1; (t = l.indexOf(i, t + 1)) !== -1; ) g.push(t);
                        return g;
                      },
                    },
                    {
                  ...
                  ((O.prototype.newGraphManager = function () {
                      ...
                      if (this.constraints.relativePlacementConstraint) {
                        ...
                        if (
                          ...
                          if (this.constraints.alignmentConstraint.horizontal)
                            for (
                              var D = this.constraints.alignmentConstraint.horizontal, p = 0;
                              p < D.length;
                              p++
                            )
                              ...
                              if (w.left) {
                                ...
                                (n.nodesInRelativeHorizontal.includes(H) ||
                                  ...
                                  n.nodeToRelativeConstraintMapHorizontal
                                    .get(H)
                                    .push({ right: $, gap: w.gap }),
                                  n.nodeToRelativeConstraintMapHorizontal
                                    .get($)
                                    .push({ left: H, gap: w.gap }));
                              } else {
                                var _ = S.has(w.top) ? S.get(w.top) : w.top,
                                  ht = S.has(w.bottom) ? S.get(w.bottom) : w.bottom;
                                (n.nodesInRelativeVertical.includes(_) ||
                                  ...
                                  n.nodeToRelativeConstraintMapVertical
                                    .get(_)
                                    .push({ bottom: ht, gap: w.gap }),
                                  n.nodeToRelativeConstraintMapVertical
                                    .get(ht)
                                    .push({ top: _, gap: w.gap }));
                              }
                            }));
                        else {
                          var q = new Map(),
                    ...
                    (O.prototype.updateDisplacements = function () {
                      ...
                      if (
                        ...
                        if (this.constraints.alignmentConstraint.horizontal)
                          for (
                            var M = this.constraints.alignmentConstraint.horizontal, p = 0;
                            p < M.length;
                            p++
                          ) {
                        ...
                        if (s.RELAX_MOVEMENT_ON_CONSTRAINTS)
                            ...
                            this.nodesInRelativeVertical.forEach(function (z) {
                              if (!n.fixedNodesOnHorizontal.has(z)) {
                                ...
                                (n.dummyToNodeForHorizontalAlignment.has(z)
                                  ...
                                  n.nodeToTempPositionMapVertical.set(
                                    z,
                                    n.nodeToTempPositionMapVertical.get(z) + w
                                  ),
                                  n.dummyToNodeForHorizontalAlignment.has(z)
                          ...
                          for (var p = 0; p < this.componentsOnHorizontal.length; p++) {
                            ...
                            if (this.fixedComponentsOnHorizontal[p])
                              for (var y = 0; y < D.length; y++)
                                this.dummyToNodeForVerticalAlignment.has(D[y])
                              ...
                              for (var q = 0, V = 0, y = 0; y < D.length; y++)
                                if (this.dummyToNodeForVerticalAlignment.has(D[y])) {
                                  ...
                                  ((q += X.length * this.idToNodeMap.get(X[0]).displacementX),
                                    (V += X.length));
                                } else ((q += this.idToNodeMap.get(D[y]).displacementX), V++);
                          ...
                          for (var p = 0; p < this.componentsOnVertical.length; p++) {
                            ...
                            if (this.fixedComponentsOnVertical[p])
                              for (var y = 0; y < D.length; y++)
                                this.dummyToNodeForHorizontalAlignment.has(D[y])
                              ...
                              for (var q = 0, V = 0, y = 0; y < D.length; y++)
                                if (this.dummyToNodeForHorizontalAlignment.has(D[y])) {
                                  ...
                                  ((q += X.length * this.idToNodeMap.get(X[0]).displacementY),
                                    (V += X.length));
                                } else ((q += this.idToNodeMap.get(D[y]).displacementY), V++);
                              for (var et = q / V, y = 0; y < D.length; y++)
                                this.dummyToNodeForHorizontalAlignment.has(D[y])
                                  ? this.dummyToNodeForHorizontalAlignment
                                      .get(D[y])
                    ...
                    (O.prototype.groupZeroDegreeMembers = function () {
                      ...
                      for (
                        ...
                        var R = E[y],
                          M = R.getParent();
                        this.getNodeDegreeWithChildren(R) === 0 &&
                          (M.id == null || !this.getToBeTiled(M)) &&
                          p.push(R);
                      }
                      ...
                      Object.keys(m).forEach(function (W) {
                        if (m[W].length > 1) {
                          ...
                          ((V.id = D),
                            ...
                            (n.idToDummyNode[D] = V));
                          var X = n.getGraphManager().add(n.newGraph(), V),
                            et = q.getChild();
                          et.add(V);
                    ...
                    (O.prototype.calcIdealRowWidth = function (n, m) {
                      ...
                      n.forEach(function (z) {
                        ((R += z.getWidth()),
                          (M += z.getHeight()),
                          z.getWidth() > S && (S = z.getWidth()));
                      });
                      var W = R / y,
                        D = M / y,
                        q = Math.pow(p - E, 2) + 4 * (W + E) * (D + p) * y,
                    ...
                    (O.prototype.tileNodesByFavoringDim = function (n, m, p) {
                      ...
                      for (var V = 0; V < n.length; V++) {
                        var X = n[V];
                        if (M.rows.length == 0) this.insertNodeToRow(M, X, 0, m);
                        else if (this.canAddHorizontal(M, X.rect.width, X.rect.height)) {
                          var et = M.rows.length - 1;
                          (M.idealRowWidth || (et = this.getShortestRowIndex(M)),
                            this.insertNodeToRow(M, X, et, m));
                        } else this.insertNodeToRow(M, X, M.rows.length, m);
                    ...
                    (O.prototype.insertNodeToRow = function (n, m, p, E) {
                      ...
                      var W = 0;
                      (S > n.rowHeight[p] &&
                        ((W = n.rowHeight[p]), (n.rowHeight[p] = S), (W = n.rowHeight[p] - W)),
                        (n.height += W),
                        n.rows[p].push(m));
                    }),
                    ...
                    (O.prototype.canAddHorizontal = function (n, m, p) {
                      ...
                      var D;
                      return (
                        n.width < m ? (D = (n.height + S) / m) : (D = (n.height + S) / n.width),
                        D < 1 && (D = 1 / D),
                        W < 1 && (W = 1 / W),
                        W < D
                      );
                      ...
                      for (var n = [], m = !0, p; m; ) {
                          ...
                          if (
                            ...
                            if (s.PURE_INCREMENTAL) {
                              var M = p.getEdges()[0].getOtherEnd(p),
                                S = new L(
                                  p.getCenterX() - M.getCenterX(),
                                  p.getCenterY() - M.getCenterY()
                                );
                        ...
                        if (m == !0) {
                          for (var W = [], D = 0; D < y.length; D++)
                            y[D][0].getEdges().length == 1 &&
                              (W.push(y[D]), y[D][0].getOwner().remove(y[D][0]));
                          (n.push(W),
                ...
                902: (a, e, r) => {
                  ...
                  ((s.handleConstraints = function (c) {
                    ...
                    f.relativePlacementConstraint &&
                      f.relativePlacementConstraint.forEach(function (F) {
                        !F.gap &&
                          F.gap != 0 &&
                          (F.left
                            ? (F.gap =
                    ...
                    var Y = function (U, B) {
                            ...
                            ? (ut.push(ot),
                              J ||
                                (B == "horizontal"
                                  ...
                                  : tt.set(ot, d.has(ot) ? L[d.get(ot)] : k.get(ot))))
                            ...
                            at.forEach(function (lt) {
                              ...
                              if (
                                ...
                                (ot.forEach(function (st) {
                                  B == "horizontal"
                                    ? (tt.set(st, d.has(st) ? v[d.get(st)] : k.get(st)),
                                      (Lt += tt.get(st)))
                                    : (tt.set(st, d.has(st) ? L[d.get(st)] : k.get(st)),
                                      (Lt += tt.get(st)));
                                }),
                                  (Lt = Lt / ot.length),
                                  lt.forEach(function (st) {
                                ...
                                (lt.forEach(function (st) {
                                  B == "horizontal"
                                    ...
                                    : (ft += d.has(st) ? L[d.get(st)] : k.get(st));
                                }),
                                  (ft = ft / lt.length),
                                  lt.forEach(function (st) {
                                    tt.set(st, ft);
                                ...
                                if (J && J.has(ft.id)) {
                                  ...
                                  if (
                                    (B == "horizontal"
                                      ...
                                      : (st = d.has(ft.id) ? L[d.get(ft.id)] : k.get(ft.id)),
                                    tt.set(ft.id, st),
                                    st < tt.get(ot) + ft.gap)
                                  ) {
                              ...
                              try {
                                for (
                                  ...
                                  B == "horizontal"
                                    ...
                                    : (kt = d.has(St) ? L[d.get(St)] : k.get(St));
                                  var Kt = tt.get(St);
                                  (kt < Lt && (Lt = kt),
                                    kt > st && (st = kt),
                                    Kt < ft && (ft = Kt),
                      ...
                      it = function (U) {
                        ...
                        else if (k > at) for (var tt = 0; tt < d.size; tt++) L[tt] = -1 * L[tt];
                      },
                      n = function (U) {
                        var B = [],
                          J = new g(),
                        ...
                        (f.relativePlacementConstraint.forEach(function (F) {
                          F.left
                            ? (W.has(F.left)
                                ...
                                : W.set(F.left, [
                                    { id: F.right, gap: F.gap, direction: "horizontal" },
                                  ]),
                            ...
                            : (W.has(F.top)
                                ...
                                : W.set(F.top, [
                                    { id: F.bottom, gap: F.gap, direction: "vertical" },
                                  ]),
                      ...
                      if (f.fixedNodeConstraint && f.fixedNodeConstraint.length > 1)
                        ...
                        (function () {
                          ...
                          if (f.alignmentConstraint.vertical) {
                            for (
                              var U = f.alignmentConstraint.vertical,
                                B = function (tt) {
                                  var j = new Set();
                        ...
                        if (V < D.size / 2) (it(f.relativePlacementConstraint), (R = !1), (M = !1));
                        else {
                          var z = new Map(),
                            w = new Map(),
                            H = [];
                          ...
                          (q[X].forEach(function (F, U) {
                            ((y[U] = [v[d.get(F)], L[d.get(F)]]),
                              (E[U] = []),
                              $.has(F) ? (E[U][0] = $.get(F)) : (E[U][0] = v[d.get(F)]),
                              _.has(F) ? (E[U][1] = _.get(F)) : (E[U][1] = L[d.get(F)]));
                          }),
                            (R = !0));
                        }
                      }
                    ...
                    if (i.ENFORCE_CONSTRAINTS) {
                      if (f.fixedNodeConstraint && f.fixedNodeConstraint.length > 0) {
                        var Et = { x: 0, y: 0 };
                        (f.fixedNodeConstraint.forEach(function (F, U) {
                          var B = { x: v[d.get(F.nodeId)], y: L[d.get(F.nodeId)] },
                            J = F.position,
                            k = Y(J, B);
                          ((Et.x += k.x), (Et.y += k.y));
                        }),
                      ...
                      f.relativePlacementConstraint &&
                        (function () {
                          ...
                          try {
                            for (
                              var ge = _t.keys()[Symbol.iterator](), Le;
                              !(te = (Le = ge.next()).done);
                              te = !0
                            ) {
                              var ue = Le.value;
                          ...
                          try {
                            for (
                              var ve = Jt.keys()[Symbol.iterator](), Me;
                              !(de = (Me = ve.next()).done);
                              de = !0
                            ) {
                              var ue = Me.value;
                          ...
                          if (
                            ...
                            ((L = d[0]),
                              ...
                              d.forEach(function (y) {
                                y.connectedEdges().length < b &&
                                  ((b = y.connectedEdges().length), (L = y));
                              }),
                              Z.push(L.id()));
                            var E = t.collection();
                            (E.merge(d[0]),
                    ...
                    (g.relocateComponent = function (t, o, s) {
                      if (!s.fixedNodeConstraint) {
                        ...
                        if (s.quality == "draft") {
                          ...
                          try {
                            for (
                              var C = o.nodeIndexes[Symbol.iterator](), G;
                              !(v = (G = C.next()).done);
                              v = !0
                            ) {
                              var Z = G.value,
                  ...
                  var l = r(548),
                    ...
                    T = function (v, L) {
                      ...
                      var n = function (D) {
                        ...
                        p = l.calcParentsWithoutChildren(b, C),
                        E = function W(D, q, V, X) {
                          for (var et = q.length, z = 0; z < et; z++) {
                            var w = q[z],
                              H = null;
                            w.intersection(p).length == 0 && (H = w.children());
                            var $ = void 0,
                              _ = w.layoutDimensions({
                              ...
                              if (X.randomize)
                                if (!w.isParent())
                                  $ = D.add(
                                    new g(
                                      V.graphManager,
                                      new t(K[Y.get(w.id())] - _.w / 2, O[Y.get(w.id())] - _.h / 2),
                            ...
                            else $ = D.add(new g(this.graphManager));
                            if (
                              (($.id = w.data("id")),
                              ($.nodeRepulsion = m(X.nodeRepulsion, w)),
                        ...
                        y = function (D, q, V) {
                          ...
                          v.idealEdgeLength != null &&
                            (et > 0
                              ? (f.DEFAULT_EDGE_LENGTH = c.DEFAULT_EDGE_LENGTH = X / et)
                              : n(v.idealEdgeLength)
                        ...
                        l(v, [
                          {
                            ...
                            value: function () {
                                ...
                                if (p) {
                                  ...
                                  if (
                                    ...
                                    if (C.tile) {
                                      var S = new Map(),
                                        ...
                                        D = [],
                                        q = 0,
                                        V = { nodeIndexes: S, xCoords: W, yCoords: D },
                                        X = [];
                                      if (
                                  ...
                                  if (O.length > 1) {
                                    ...
                                    O.forEach(function (vt, rt) {
                                      var gt = void 0;
                                      if (
                                        (C.quality == "draft" && (gt = Y[rt].nodeIndexes),
                                          ...
                                          .forEach(function (Ot) {
                                            if (C.quality == "draft")
                                              if (!Ot.isParent())
                                                ((At = gt.get(Ot.id())),
                                                  mt.nodes.push({
                                                    x: Y[rt].xCoords[At] - Ot.boundingbox().w / 2,
                                                    y: Y[rt].yCoords[At] - Ot.boundingbox().h / 2,
                                  ...
                                  if (
                                    (it.push({ x: E.x1 + E.w / 2, y: E.y1 + E.h / 2 }), C.randomize)
                                  ) {
                                    var y = s(C);
                                    Y.push(y);
                                  }
                                  C.quality == "default" || C.quality == "proof"
                                    ? (K.push(f(C, Y[0])), t.relocateComponent(it[0], K[0], C))
                              ...
                              if (C.quality == "default" || C.quality == "proof" || C.randomize) {
                                ...
                                ((C.eles = Z.not(Nt)),
                                  Z.nodes().not(":parent").not(Nt).layoutPositions(b, C, Q),
                                  It.length > 0 &&
                    ...
                    t = function (s) {
                      var c = s.cy,
                        ...
                        D = function (U, B, J) {
                          ...
                          if (J) {
                            for (var ot = 0; ot < m; ot++) O[ot][B] < K[ot] && (K[ot] = O[ot][B]);
                        ...
                        q = function (U) {
                          ...
                          if (U) {
                            ...
                            for (var at = 0; at < S; at++) ((Y[at] = B), (B = D(B, at, U)));
                          } else {
                            W();
                            for (var J = 0; J < S; J++) D(Y[J], J, U);
                          }
                          for (var ct = 0; ct < m; ct++)
                            for (var nt = 0; nt < S; nt++) O[ct][nt] *= O[ct][nt];
                          for (var tt = 0; tt < S; tt++) it[tt] = [];
                          for (var j = 0; j < S; j++)
                            for (var ut = 0; ut < S; ut++) it[j][ut] = O[Y[ut]][j];
                        },
                        V = function () {
                          for (
                            var U = g.svd(it),
                        ...
                        X = function () {
                          for (
                            var U = void 0, B = void 0, J = [], k = [], at = [], ct = [], nt = 0;
                            nt < m;
                            nt++
                          )
                      ...
                      (l.connectComponents(c, f, l.getTopMostNodes(T), v),
                        d.forEach(function (F) {
                          l.connectComponents(
                            c,
                            f,
                            l.getTopMostNodes(F.descendants().intersection(f)),
                            v
                          );
                        }));
                      ...
                      (d.forEach(function (F) {
                        for (
                          var U = F.children().intersection(f);
                        ...
                        T.forEach(function (F) {
                          var U = void 0;
                          (F.isParent() ? (U = L.get(b.get(F.id()))) : (U = L.get(F.id())),
                            F.neighborhood()
                              .nodes()
                              .forEach(function (B) {
                                f.intersection(F.edgesWith(B)).length > 0 &&
                                  (B.isParent() ? C[U].push(b.get(B.id())) : C[U].push(B.id()));
                              }));
                        }));
                      var Nt = function (U) {
                          var B = L.get(U),
                          ...
                          v.get(U).forEach(function (k) {
                            (c.getElementById(k).isParent() ? (J = b.get(k)) : (J = k),
                              C[B].push(J),
                              C[L.get(J)].push(U));
                          });
                        },
                      ...
                      if (m > 2) {
                        ...
                        return (
                          s.quality == "draft" || s.step == "all"
                            ? (q(R), V(), X(), (Et = { nodeIndexes: L, xCoords: G, yCoords: Z }))
                            : (L.forEach(function (F, U) {
                                (G.push(c.getElementById(U).position("x")),
                                  Z.push(c.getElementById(U).position("y")));
                              }),
                              (Et = { nodeIndexes: L, xCoords: G, yCoords: Z })),
                          Et
                        );
                      } else {
                        var Ht = L.keys(),
    ...
    ((ae = class {
      constructor() {
        ((this.nodes = {}),
          ...
          (this.getAccDescription = _e),
          (this.setAccDescription = tr),
          this.clear());
      }
      clear() {
        ((this.nodes = {}),
      ...
      addService({ id: x, icon: A, in: P, title: N, iconText: u }) {
      ...
      addJunction({ id: x, in: A }) {
        ((this.registeredIds[x] = "node"),
          (this.nodes[x] = { id: x, type: "junction", edges: [], in: A }));
      }
      getJunctions() {
      ...
      addGroup({ id: x, icon: A, in: P, title: N }) {
        ...
        ((this.registeredIds[x] = "group"), (this.groups[x] = { id: x, icon: A, title: N, in: P }));
      }
      getGroups() {
...
`,
  ...
  Rr = Ir,
  re = dt(
    (I) => `<g><rect width="80" height="80" style="fill: #087ebf; stroke-width: 0px;"/>${I}</g>`,
    "wrapIcon"
  ),
  ne = {
  ...
  Sr = dt(async function (I, x, A) {
    ...
    await Promise.all(
      x.edges().map(async (e) => {
        ...
        const G = P + 4;
        if (
          (g && (Wt(l) ? (T += l === "L" ? -G : G) : (d += l === "T" ? -G : G + 18)),
          c && (Wt(o) ? (b += o === "L" ? -G : G) : (C += o === "T" ? -G : G + 18)),
          !g &&
            A.getNode(r)?.type === "junction" &&
            (Wt(l) ? (T += l === "L" ? u : -u) : (d += l === "T" ? u : -u)),
          !c &&
            A.getNode(t)?.type === "junction" &&
            (Wt(o) ? (b += o === "L" ? u : -u) : (C += o === "T" ? u : -u)),
          e[0]._private.rscratch)
        ) {
          const Z = I.insert("g");
          if (
            (Z.insert("path")
              .attr("d", `M ${T},${d} L ${v},${L} L${b},${C} `)
              .attr("class", "edge")
              .attr("id", sr(r, t, { prefix: "L" })),
            i)
          ) {
            const Y = Wt(l) ? se[l](T, h) : T - a,
              K = qt(l) ? se[l](d, h) : d - a;
            Z.insert("polygon")
              .attr("points", Ie[l](h))
              .attr("transform", `translate(${Y},${K})`)
              .attr("class", "arrow");
          }
          if (s) {
            const Y = Wt(o) ? se[o](b, h) : b - a,
              K = qt(o) ? se[o](C, h) : C - a;
            Z.insert("polygon")
              .attr("points", Ie[o](h))
              .attr("transform", `translate(${Y},${K})`)
          ...
          if (f) {
            ...
            else if (Y === "Y") O.attr("transform", "translate(" + v + ", " + L + ") rotate(-90)");
            else if (Y === "XY") {
              const it = ye(l, o);
              if (it && Nr(it)) {
  ...
  Fr = dt(async function (I, x, A) {
    ...
    await Promise.all(
      x.nodes().map(async (e) => {
        const r = ie(e);
        if (r.type === "group") {
          const { h: l, w: i, x1: g, y1: t } = e.boundingBox(),
            o = I.append("rect");
  ...
  br = dt(async function (I, x, A) {
    ...
    for (const N of A) {
      ...
      const a = u.append("g");
      if (N.icon)
        a.html(`<g>${await pe(N.icon, { height: h, width: h, fallbackPrefix: ne.prefix })}</g>`);
      else if (N.iconText) {
        ...
        const g = a
            ...
            .append("div")
            .html(nr(N.iconText, P)),
          t =
            parseInt(
              window
                .getComputedStyle(g.node(), null)
...
function $e(I, x, A, P, N, { spatialMaps: u, groupAlignments: h }) {
  return new Promise((a) => {
    const e = or("body").append("div").attr("id", "cy").attr("style", "display:none"),
      r = Fe({
    ...
    (g.one("layoutstop", () => {
      function t(o, s, c, f) {
        ...
        const { x: v, y: L } = o,
          { x: b, y: C } = s;
        ((d =
          (f - L + ((v - c) * (L - C)) / (v - b)) / Math.sqrt(1 + Math.pow((L - C) / (v - b), 2))),
          (T = Math.sqrt(Math.pow(f - L, 2) + Math.pow(c - v, 2) - Math.pow(d, 2))));
        ...
        return ((d = Math.abs(d) * Z), (T = T * Y), { distances: d, weights: T });
      }
        ...
        if (o.data?.()) {
          ...
          if (s !== f && c !== T) {
            const d = o.sourceEndpoint(),
              v = o.targetEndpoint(),
              { sourceDir: L } = be(o),
              [b, C] = qt(L) ? [d.x, v.y] : [v.x, d.y],
              { weights: G, distances: Z } = t(d, v, b, C);
...
var Gr = dt(async (I, x, A, P) => {
    ...
    (await Sr(i, o, N),
      await Fr(t, o, N),
      Xe(N, o),
      qe(void 0, l, N.getConfigField("padding"), N.getConfigField("useMaxWidth")));
  }, "draw"),
  Ur = { draw: Gr },
  $r = {
    parser: Ge,
