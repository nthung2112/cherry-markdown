...
import { s as we } from "./chunk-QN33PNHL-aoRFC8jA.js";
import { p as Ce } from "./chunk-4BX2VUAB-CcLLIeQS.js";
import { p as Te } from "./treemap-KMMF4GRG-8nUewU-W.js";
import { b as O } from "./defaultLocale-C4B-KCzX.js";
...
function Ze(t, a, l, n, o, s) {
  for (
    ...
    while (!p && b < r);
    for (
      g = N = p, R = Math.max(S / x, x / S) / (v * t), M = p * p * R, V = Math.max(N / M, M / g);
      b < r;
      ++b
    ) {
      if (
  ...
  return (
    ...
    (u.paddingOuter = function (r) {
      return arguments.length
        ? u.paddingTop(r).paddingRight(r).paddingBottom(r).paddingLeft(r)
        : u.paddingTop();
    }),
  ...
  ne =
    ((E = class {
      ...
      addNode(a, l) {
        (this.nodes.push(a),
          this.levels.set(a, l),
          l === 0 && (this.outerNodes.push(a), (this.root ??= a)));
      }
      getRoot() {
      ...
      addClass(a, l) {
        ...
        (o &&
          o.forEach((s) => {
            (xe(s) && (n?.textStyles ? n.textStyles.push(s) : (n.textStyles = [s])),
    ...
    t.forEach((n) => {
      ...
      for (
        o.classSelector = n?.classSelector,
          n?.cssCompiledStyles && (o.cssCompiledStyles = [n.cssCompiledStyles]),
    ...
    const ie = ee.leaves(),
      j = V.selectAll(".treemapLeafGroup")
        ...
        .attr(
          "class",
          (e, i) =>
            `treemapNode treemapLeafGroup leaf${i}${e.data.classSelector ? ` ${e.data.classSelector}` : ""}x`
        )
        .attr("transform", (e) => `translate(${e.x0},${e.y0})`);
    (j
      .append("rect")
      ...
      .attr("fill", (e) => (e.parent ? g(e.parent.data.name) : g(e.data.name)))
      .attr("style", (e) => P({ cssCompiledStyles: e.data.cssCompiledStyles }).nodeStyles)
      .attr("fill-opacity", 0.3)
      .attr("stroke", (e) => (e.parent ? g(e.parent.data.name) : g(e.data.name)))
      .attr("stroke-width", 3),
      j
        .append("clipPath")
