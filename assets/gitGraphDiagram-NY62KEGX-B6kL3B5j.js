import { p as Y } from "./chunk-4BX2VUAB-CcLLIeQS.js";
import { I as K } from "./chunk-QZHKN3VN-BXb4re_p.js";
import {
  _ as l,
  q as U,
  p as V,
...
import { p as dr } from "./treemap-KMMF4GRG-8nUewU-W.js";
...
var xr = l(function () {
  ...
  Dr = l((t) => Pr(t) + k, "calculateCommitPosition"),
  Fr = l((t, r) => {
  ...
  G = l((t, r, s = 0) => {
    ...
    if (s > 5) return n;
    if (q.every((d) => Math.abs(d - n) >= 10)) return (q.push(n), n);
...
`,
  ...
  te = ee,
  de = { parser: Or, db: S, renderer: re, styles: te };
