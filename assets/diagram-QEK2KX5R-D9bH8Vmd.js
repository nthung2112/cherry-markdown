...
import { p as V } from "./chunk-4BX2VUAB-CcLLIeQS.js";
import { p as W } from "./treemap-KMMF4GRG-8nUewU-W.js";
import "./min-CeHOP0ym.js";
import "./baseUniq-DfLQT-4m.js";
var m = { showLegend: !0, ticks: 5, max: null, min: 0, graticule: "circle" },
  w = { axes: [], curves: [], options: m },
  h = structuredClone(w),
  B = P.radar,
  j = l(() => f({ ...B, ...C().radar }), "getConfig"),
  b = l(() => h.axes, "getAxes"),
  q = l(() => h.curves, "getCurves"),
  K = l(() => h.options, "getOptions"),
  N = l((a) => {
    h.axes = a.map((t) => ({ name: t.name, label: t.label ?? t.name }));
  }, "setAxes"),
  U = l((a) => {
    h.curves = a.map((t) => ({ name: t.name, label: t.label ?? t.name, entries: X(t.entries) }));
  }, "setCurves"),
  X = l((a) => {
  ...
  tt = l((a, t, e, r) => {
    const s = r.db,
      ...
      u = D(t),
      p = et(u, c),
      g = n.max ?? Math.max(...i.map((y) => Math.max(...y.entries))),
      x = n.min,
...
var st = { draw: tt },
  ...
  gt = { parser: Q, db: $, renderer: st, styles: it };
