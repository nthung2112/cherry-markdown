...
import { i as b, G as B } from "./graph-VRRTmXQU.js";
import { l as I } from "./layout-ChlB-LGg.js";
import { c as L } from "./clone-Ctkm08MQ.js";
import { m as A } from "./min-CeHOP0ym.js";
...
var d = new Map(),
  ...
  G = w((e, t, n, a) => {
    ...
    (e !== a && r.push(e),
      ...
      r.forEach((o) => {
        if (t.children(o).length > 0) G(o, t, n, a);
        else {
          const l = t.node(o);
  ...
  R = w((e, t) => {
    ...
    let a = [...n];
    for (const r of n) (J.set(r, e), (a = [...a, ...R(r, t)]));
    return a;
  }, "extractDescendants"),
  ie = w((e, t, n) => {
    ...
    (e.nodes().forEach(function (n) {
      ...
      e.nodes().forEach(function (n) {
        const a = e.children(n),
          r = e.edges();
        a.length > 0
          ? (i.debug("Cluster identified", n, y),
            r.forEach((o) => {
              const l = D(o.v, n),
                u = D(o.w, n);
              l ^ u &&
                (i.warn("Edge: ", o, " leaves cluster ", n),
                i.warn("Descendants of XXX ", n, ": ", y.get(n)),
...
Parent cluster`,
        ...
        if ((i.info("(Insert) Node XXX" + f + ": " + JSON.stringify(t.node(f))), s?.clusterNode)) {
          ...
          const N = await j(X, s.graph, n, a, t.node(f), o),
            x = N.elem;
          (z(s, x),
            (s.diff = N.diff || 0),
            i.info(
          ...
          t.children(f).length > 0
            ...
            : (i.trace("Node - the non recursive path XAX", f, X, t.node(f), l),
              await $(X, t.node(f), { config: o, dir: l }));
      })
    ),
      await w(async () => {
    ...
    let O = 0,
      { subGraphTitleTotalMargin: S } = q(o);
    return (
      await Promise.all(
      ...
      i.warn("Returning from recursive render XAX", u, O),
      { elem: u, diff: O }
    );
  }, "recursiveRender"),
  ge = w(async (e, t) => {
      ...
      e.edges.forEach((o) => {
        if (o.start === o.end) {
          ...
          ((v.label = ""),
            ...
            (X.arrowTypeStart = "none"),
            (X.arrowTypeEnd = "none"),
            (X.id = l + "-cyclic-special-mid"),
            (p.label = ""),
            m.isGroup && ((v.fromCluster = l), (p.toCluster = l)),
            (p.id = l + "-cyclic-special-2"),
            (p.arrowTypeStart = "none"),
            n.setEdge(l, u, v, l + "-cyclic-special-0"),
            n.setEdge(u, c, X, l + "-cyclic-special-1"),
            n.setEdge(c, l, p, l + "-cyc<lic-special-2"));
