import { s as G, a as W, S as N } from "./chunk-DI55MBZ5-BPG2Fdhn.js";
import {
  _ as f,
  c as t,
  d as H,
...
import { G as O } from "./graph-VRRTmXQU.js";
import { l as J } from "./layout-ChlB-LGg.js";
import "./chunk-55IACEB6-CSXIgZv6.js";
import "./chunk-QN33PNHL-aoRFC8jA.js";
...
var X = f(
  ...
  $ = f((e, i, d) => {
    ...
    (i.doc,
      (g = a - c),
      p > x && (g = (x - o) / 2 + c),
      Math.abs(a - B.x) < c && p > x && (g = a - (p - x) / 2));
  ...
  j = f((e, i, d, c) => {
    ...
    for (const w of a) {
      ...
      if (p.length > 0) {
        ...
        ((n += s),
          o.attr("x", i + t().state.noteMargin),
          o.attr("y", d + n + 1.25 * t().state.noteMargin));
      }
    }
  ...
  K = f((e, i) => {
    ...
    return (
      d.attr("height", l + 2 * t().state.noteMargin),
      d.attr("width", n + t().state.noteMargin * 2),
      d
    );
  }, "drawNote"),
  L = f(function (e, i) {
    ...
    return (
      (c.width = l.width + 2 * t().state.padding),
      (c.height = l.height + 2 * t().state.padding),
      c
    );
  }, "drawState"),
  R = 0,
  ...
  A = f((e, i, d, c, n, l, x) => {
    ...
    (a.edges().forEach(function (r) {
      r !== void 0 &&
        a.edge(r) !== void 0 &&
        (S.debug("Edge " + r.v + " -> " + r.w + ": " + JSON.stringify(a.edge(r))),
