import { b8 as Cp, bB as Ut } from "./index-B0beL7ox.js";
import { m as ot, f as kp, d as Np } from "./min-CeHOP0ym.js";
import { b as bp, l as Op, d as Pp, m as Lp, r as Il, n as na } from "./baseUniq-DfLQT-4m.js";
function Mp(t, e) {
  return bp(ot(t, e));
}
function Dp(t, e) {
  return t && t.length ? Op(t, Pp(e)) : [];
}
function ue(t) {
...
class re {
  ...
  join(e = ",") {
    ...
    let r = "",
      i,
      s = !1;
    do ((i = n.next()), i.done || (s && (r += e), (r += Gp(i.value))), (s = !0));
    while (!i.done);
    return r;
  }
  indexOf(e, n = 0) {
    ...
    return new re(
      ...
      (n) => {
        do {
          ...
          if (!r) {
            const s = e(i);
            if (Hi(s)) n.iterator = s[Symbol.iterator]();
    ...
    return new re(
      ...
      (r) => {
        do {
          ...
          if (!i)
            if (Hi(s)) r.iterator = s[Symbol.iterator]();
            else return { done: !1, value: s };
        } while (r.iterator);
        return Ae;
      }
  ...
  limit(e) {
    return new re(
      ...
      (n) => (n.size++, n.size > e ? Ae : this.nextFn(n.state))
    );
  }
  distinct(e) {
    return new re(
...
const Up = new re(
  ...
  Ae = Object.freeze({ done: !0, value: void 0 });
function ie(...t) {
  if (t.length === 1) {
    const e = t[0];
    ...
    if (typeof e.length == "number")
      return new re(
        () => ({ index: 0 }),
        (n) => (n.index < e.length ? { done: !1, value: e[n.index++] } : Ae)
      );
  }
  return t.length > 1
    ? new re(
        ...
        (e) => {
          do {
            ...
            if (e.collIndex < t.length) {
              ...
              Hi(n)
                ? (e.iterator = n[Symbol.iterator]())
                : n && typeof n.length == "number" && (e.array = n);
            }
...
function Fa(t) {
  return new ko(t, (e) => (Lr(e) ? e.content : []), { includeRoot: !0 });
}
function Bp(t, e) {
...
function jp(t, e) {
  if (
    t.end.line < e.start.line ||
    (t.end.line === e.start.line && t.end.character <= e.start.character)
  )
    return st.Before;
  if (
    t.start.line > e.end.line ||
    (t.start.line === e.end.line && t.start.character >= e.end.character)
  )
    return st.After;
  const n =
      t.start.line > e.start.line ||
      (t.start.line === e.start.line && t.start.character >= e.start.character),
    r =
      t.end.line < e.end.line || (t.end.line === e.end.line && t.end.character <= e.end.character);
  return n && r ? st.Inside : n ? st.OverlapBack : r ? st.OverlapFront : st.Outside;
}
function Kp(t, e) {
  return jp(t, e) > st.After;
}
const Hp = /^[\w\p{L}]$/u;
function Wp(t, e) {
  if (t) {
    const n = zp(t, !0);
    if (n && wl(n, e)) return n;
    if (Df(t)) {
...
const aa = "NamedArgument",
  nr = "Negation";
function Jp(t) {
  return F.isInstance(t, nr);
}
const ui = "NumberLiteral",
  ci = "Parameter",
  rr = "ParameterReference";
function Zp(t) {
...
class Hf extends Lf {
  ...
  getTypeMetaData(e) {
    switch (e) {
      case Xn:
        return { name: Xn, properties: [{ name: "cardinality" }, { name: "lookahead" }] };
      case ai:
        return { name: ai, properties: [{ name: "elements", defaultValue: [] }] };
      case oi:
        return { name: oi, properties: [{ name: "elementType" }] };
      case Jn:
        return { name: Jn, properties: [{ name: "true", defaultValue: !1 }] };
      case Zn:
        return { name: Zn, properties: [{ name: "left" }, { name: "right" }] };
      case Qn:
        return { name: Qn, properties: [{ name: "left" }, { name: "right" }] };
      case li:
        return {
          name: li,
          properties: [
      ...
      case sa:
        return { name: sa, properties: [{ name: "path" }] };
      case er:
        return { name: er, properties: [{ name: "name" }] };
      case tr:
        return {
          name: tr,
          properties: [
      ...
      case nr:
        return { name: nr, properties: [{ name: "value" }] };
      case ui:
        return { name: ui, properties: [{ name: "value" }] };
      case ci:
        return { name: ci, properties: [{ name: "name" }] };
      case rr:
        return { name: rr, properties: [{ name: "parameter" }] };
      case ir:
        return {
          name: ir,
          properties: [
      ...
      case fi:
        return { name: fi, properties: [{ name: "referenceType" }] };
      case Ci:
        return { name: Ci, properties: [{ name: "name" }] };
      case sr:
        return {
      ...
      case di:
        return { name: di, properties: [{ name: "value" }] };
      case fn:
        return {
          name: fn,
          properties: [
      ...
      case ar:
        return { name: ar, properties: [{ name: "name" }, { name: "type" }] };
      case oa:
        return {
          name: oa,
          properties: [
      ...
      case hi:
        return { name: hi, properties: [{ name: "types", defaultValue: [] }] };
      case or:
        return {
          name: or,
          properties: [
      ...
      case dr:
        return { name: dr, properties: [{ name: "cardinality" }, { name: "lookahead" }] };
      case hr:
        return {
          name: hr,
          properties: [
      ...
      case Er:
        return { name: Er, properties: [{ name: "cardinality" }, { name: "lookahead" }] };
      default:
    ...
    (r) => {
      for (; r.keyIndex < r.keys.length; ) {
        ...
        if (!i.startsWith("$")) {
          const s = t[i];
          if (ue(s)) {
            if ((r.keyIndex++, kl(s, n))) return { done: !1, value: s };
          } else if (Array.isArray(s)) {
            for (; r.arrayIndex < s.length; ) {
              const a = r.arrayIndex++,
                o = s[a];
              if (ue(o) && kl(o, n)) return { done: !1, value: o };
            }
            r.arrayIndex = 0;
          }
        }
...
const zi = [];
for (let t = C("0"); t <= C("9"); t++) zi.push(t);
const Vi = [C("_")].concat(zi);
for (let t = C("a"); t <= C("z"); t++) Vi.push(t);
for (let t = C("A"); t <= C("Z"); t++) Vi.push(t);
const bl = [
    C(" "),
    C("\f"),
...
`),
  ...
  characterClassEscape() {
    ...
    if (cn(e)) return { type: "Set", value: e, complement: n };
  }
  controlEscapeAtom() {
    let e;
    switch (this.popChar()) {
...
`);
    ...
    if (cn(e)) return { type: "Character", value: e };
  }
...
`:
  ...
  characterClass() {
    ...
    let n = !1;
    for (
      this.consumeChar("["), this.peekChar(0) === "^" && (this.consumeChar("^"), (n = !0));
      this.isClassAtom();
    ) {
      ...
      if ((r.type, Nl(r) && this.isRangeDash())) {
        ...
        } else (la(r.value, e), e.push(C("-")), la(i.value, e));
      } else la(r.value, e);
    }
...
`:
  ...
  positiveInteger() {
    let e = this.popChar();
    if (pm.test(e) === !1) throw Error("Expecting a positive integer");
    for (; pi.test(this.peekChar(0)); ) e += this.popChar();
    return parseInt(e, 10);
  }
  integerIncludingZero() {
    let e = this.popChar();
    if (pi.test(e) === !1) throw Error("Expecting an integer");
    for (; pi.test(this.peekChar(0)); ) e += this.popChar();
    return parseInt(e, 10);
  }
  patternCharacter() {
...
`:
  ...
  parseHexDigits(e) {
    ...
    for (let i = 0; i < e; i++) {
      ...
      if (hm.test(s) === !1) throw Error("Expecting a HexDecimal digits");
      n += s;
    }
...
function $m(t) {
  return Array.prototype.map
    .call(t, (e) => (/\w/.test(e) ? `[${e.toLowerCase()}${e.toUpperCase()}]` : As(e)))
    .join("");
}
function Rm(t, e) {
  const n = Am(t),
...
function qf(t, e) {
  ...
  const i = [r].concat(Sm(t));
  for (const a of i) Yf(a, n, e);
  const s = new Set();
  for (const a of t.rules) (n.has(a.name) || (Zt(a) && a.hidden)) && s.add(a);
  return s;
}
function Yf(t, e, n) {
  (e.add(t.name),
...
function Im(t, e) {
  return !t || !e ? [] : Po(t, e, t.astNode, !0);
}
function Xf(t, e, n) {
  if (!t || !e) return;
  const r = Po(t, e, t.astNode, !0);
  if (r.length !== 0)
...
function Po(t, e, n, r) {
  ...
  return Lr(t) && t.astNode === n ? t.content.flatMap((i) => Po(i, e, n, !1)) : [];
}
function wm(t, e, n) {
  if (!t) return;
  const r = Cm(t, e, t?.astNode);
  if (r.length !== 0)
    return (n !== void 0 ? (n = Math.max(0, Math.min(n, r.length - 1))) : (n = 0), r[n]);
}
function Cm(t, e, n) {
  if (t.astNode !== n) return [];
  if (Wt(t.grammarSource) && t.grammarSource.value === e) return [t];
...
function Zf(t, e, n) {
  ...
  n.set(t, void 0);
  for (const s of Wr(e)) {
    if (Ht(s) && s.feature.toLowerCase() === "name") return (n.set(t, s), s);
    if (zt(s) && Ne(s.rule.ref)) return i(s, s.rule.ref);
    if (em(s) && !((r = s.typeRef) === null || r === void 0) && r.ref) return i(s, s.typeRef.ref);
  }
}
function Qf(t) {
  return ed(t, new Set());
...
function ed(t, e) {
  ...
  for (const n of Wr(t))
    if (zt(n)) {
      if (!n.rule.ref || (Ne(n.rule.ref) && !ed(n.rule.ref, e))) return !1;
    } else {
      if (Ht(n)) return !1;
      if (vs(n)) return !1;
    }
...
function Lo(t) {
  ...
  if (t.returnType) {
    ...
    if (e) {
      if (Ne(e)) return e.name;
      if (Uf(e) || Bf(e)) return e.name;
    }
  }
}
function Mo(t) {
  var e;
  if (Ne(t)) return Qf(t) ? t.name : (e = Lo(t)) !== null && e !== void 0 ? e : t.name;
  if (Uf(t) || Bf(t) || Qp(t)) return t.name;
  if (vs(t)) {
    const n = Nm(t);
    if (n) return n;
  } else if (Gf(t)) return t.name;
  throw new Error("Cannot get name of Unknown Type");
}
function Nm(t) {
  var e;
  if (t.inferredType) return t.inferredType.name;
  if (!((e = t.type) === null || e === void 0) && e.ref) return Mo(t.type.ref);
}
function bm(t) {
  var e, n, r;
  return Zt(t)
    ? (n = (e = t.type) === null || e === void 0 ? void 0 : e.name) !== null && n !== void 0
      ? n
      : "string"
    : (r = Lo(t)) !== null && r !== void 0
      ? r
      : t.name;
}
function Do(t) {
...
function Bn(t, e) {
  ...
  if (om(t)) {
    ...
    return lt(Bn(n.definition), { cardinality: t.cardinality, lookahead: t.lookahead });
  } else {
    if (rm(t)) return Mm(t);
    if (lm(t)) return Lm(t);
    if (im(t)) {
      const n = t.regex.lastIndexOf("/"),
        r = t.regex.substring(1, n),
        i = t.regex.substring(n + 1);
      return (
        e && ((e.i = i.includes("i")), (e.s = i.includes("s")), (e.u = i.includes("u"))),
        lt(r, { cardinality: t.cardinality, lookahead: t.lookahead, wrap: !1 })
      );
    } else {
      if (um(t)) return lt(Fo, { cardinality: t.cardinality, lookahead: t.lookahead });
...
function Lm(t) {
  return lt(`${Fo}*?${Bn(t.terminal)}`, { cardinality: t.cardinality, lookahead: t.lookahead });
}
function Mm(t) {
  return lt(`(?!${Bn(t.terminal)})${Fo}*?`, { cardinality: t.cardinality, lookahead: t.lookahead });
}
function Dm(t) {
  return t.right
    ? lt(`[${ca(t.left)}-${ca(t.right)}]`, {
        cardinality: t.cardinality,
        lookahead: t.lookahead,
        wrap: !1,
      })
    : lt(ca(t.left), { cardinality: t.cardinality, lookahead: t.lookahead, wrap: !1 });
}
function ca(t) {
  return As(t.value);
}
function lt(t, e) {
  ...
  return (
    (e.wrap !== !1 || e.lookahead) &&
      (t = `(${(n = e.lookahead) !== null && n !== void 0 ? n : ""}${t})`),
...
function Fm(t) {
  const e = [],
    n = t.Grammar;
  for (const r of n.rules) Zt(r) && _m(r) && Tm(Do(r)) && e.push(r.name);
  return { multilineCommentRules: e, nameRegexp: Hp };
}
var td = typeof global == "object" && global && global.Object === Object && global,
  Gm = typeof self == "object" && self && self.Object === Object && self,
  Ye = td || Gm || Function("return this")(),
  be = Ye.Symbol,
  nd = Object.prototype,
  Um = nd.hasOwnProperty,
  Bm = nd.toString,
  zn = be ? be.toStringTag : void 0;
function jm(t) {
  var e = Um.call(t, zn),
    n = t[zn];
  try {
...
var zm = "[object Null]",
  Vm = "[object Undefined]",
  Ol = be ? be.toStringTag : void 0;
function kt(t) {
  return t == null ? (t === void 0 ? Vm : zm) : Ol && Ol in Object(t) ? jm(t) : Wm(t);
}
function Ue(t) {
...
function Es(t) {
  return typeof t == "symbol" || (Ue(t) && kt(t) == qm);
}
function Ss(t, e) {
...
var M = Array.isArray,
  Pl = be ? be.prototype : void 0,
  Ll = Pl ? Pl.toString : void 0;
function rd(t) {
  if (typeof t == "string") return t;
  if (M(t)) return Ss(t, rd) + "";
  if (Es(t)) return Ll ? Ll.call(t) : "";
  var e = t + "";
  return e == "0" && 1 / t == -1 / 0 ? "-0" : e;
}
var Ym = /\s/;
function Xm(t) {
  for (var e = t.length; e-- && Ym.test(t.charAt(e)); );
  return e;
}
var Jm = /^\s+/;
function Zm(t) {
  return t && t.slice(0, Xm(t) + 1).replace(Jm, "");
}
function Oe(t) {
  var e = typeof t;
...
function rg(t) {
  ...
  t = Zm(t);
  var n = eg.test(t);
  return n || tg.test(t) ? ng(t.slice(2), n ? 2 : 8) : Qm.test(t) ? Ml : +t;
}
var Dl = 1 / 0,
  ig = 17976931348623157e292;
function sg(t) {
  if (!t) return t === 0 ? t : 0;
  if (((t = rg(t)), t === Dl || t === -Dl)) {
    var e = t < 0 ? -1 : 1;
...
function ht(t) {
  if (!Oe(t)) return !1;
  var e = kt(t);
  return e == og || e == lg || e == ag || e == ug;
}
var fa = Ye["__core-js_shared__"],
  Fl = (function () {
...
var hg = /[\\^$.*+?()[\]{}|]/g,
  pg = /^\[object .+?Constructor\]$/,
  mg = Function.prototype,
  gg = Object.prototype,
  yg = mg.toString,
  Tg = gg.hasOwnProperty,
  vg = RegExp(
    "^" +
      yg
        .call(Tg)
...
var qi = (function () {
  ...
  kg = qi
    ? function (t, e) {
        return qi(t, "toString", { configurable: !0, enumerable: !1, value: Cg(e), writable: !0 });
      }
    : On,
  Ng = wg(kg);
function id(t, e) {
...
function sd(t, e, n, r) {
  for (var i = t.length, s = n + -1; ++s < i; ) if (e(t[s], s, t)) return s;
  return -1;
}
function bg(t) {
  return t !== t;
...
function _s(t, e) {
  ...
  return (
    (e = e ?? Pg),
    !!e && (n == "number" || (n != "symbol" && Lg.test(t))) && t > -1 && t % 1 == 0 && t < e
  );
}
function Uo(t, e, n) {
  e == "__proto__" && qi
    ? qi(t, e, { configurable: !0, enumerable: !0, value: n, writable: !0 })
    : (t[e] = n);
}
function zr(t, e) {
  return t === e || (t !== t && e !== e);
...
function Is(t, e, n) {
  var r = t[e];
  (!(Dg.call(t, e) && zr(r, n)) || (n === void 0 && !(e in t))) && Uo(t, e, n);
}
function Vr(t, e, n, r) {
  var i = !n;
  n || (n = {});
  for (var s = -1, a = e.length; ++s < a; ) {
    var o = e[s],
      l = void 0;
    (l === void 0 && (l = t[o]), i ? Uo(n, o, l) : Is(n, o, l));
  }
  return n;
}
var Ul = Math.max;
function Fg(t, e, n) {
  return (
    (e = Ul(e === void 0 ? t.length - 1 : e, 0)),
    function () {
      for (var r = arguments, i = -1, s = Ul(r.length - e, 0), a = Array(s); ++i < s; )
        a[i] = r[e + i];
      i = -1;
      for (var o = Array(e + 1); ++i < e; ) o[i] = r[i];
      return ((o[e] = n(a)), Eg(t, this, o));
    }
  );
}
function Bo(t, e) {
  return Ng(Fg(t, e, On), t + "");
}
...
function od(t, e, n) {
  if (!Oe(n)) return !1;
  var r = typeof e;
  return (r == "number" ? Xe(n) && _s(e, n.length) : r == "string" && e in n) ? zr(n[e], t) : !1;
}
function Ug(t) {
  return Bo(function (e, n) {
    var r = -1,
      ...
      a = i > 2 ? n[2] : void 0;
    for (
      s = t.length > 3 && typeof s == "function" ? (i--, s) : void 0,
        a && od(n[0], n[1], a) && ((s = i < 3 ? void 0 : s), (i = 1)),
        e = Object(e);
      ++r < i;
    ) {
      var o = n[r];
...
function qr(t) {
  var e = t && t.constructor,
    n = (typeof e == "function" && e.prototype) || Bg;
  return t === n;
}
function jg(t, e) {
...
var ld = Object.prototype,
  Hg = ld.hasOwnProperty,
  Wg = ld.propertyIsEnumerable,
  ws = Bl(
    (function () {
      return arguments;
    })()
    ...
    ? Bl
    : function (t) {
        return Ue(t) && Hg.call(t, "callee") && !Wg.call(t, "callee");
      };
function zg() {
  return !1;
}
var ud = typeof exports == "object" && exports && !exports.nodeType && exports,
  jl = ud && typeof module == "object" && module && !module.nodeType && module,
  Vg = jl && jl.exports === ud,
  Kl = Vg ? Ye.Buffer : void 0,
  qg = Kl ? Kl.isBuffer : void 0,
  Mr = qg || zg,
  Yg = "[object Arguments]",
  Xg = "[object Array]",
  Jg = "[object Boolean]",
  ...
  gy = "[object Uint8ClampedArray]",
  yy = "[object Uint16Array]",
  Ty = "[object Uint32Array]",
  B = {};
B[cy] = B[fy] = B[dy] = B[hy] = B[py] = B[my] = B[gy] = B[yy] = B[Ty] = !0;
B[Yg] =
  B[Xg] =
  B[ly] =
  B[Jg] =
  ...
  B[oy] =
    !1;
function vy(t) {
  return Ue(t) && jo(t.length) && !!B[kt(t)];
}
function Cs(t) {
  return function (e) {
    return t(e);
...
var cd = typeof exports == "object" && exports && !exports.nodeType && exports,
  br = cd && typeof module == "object" && module && !module.nodeType && module,
  $y = br && br.exports === cd,
  da = $y && td.process,
  At = (function () {
    try {
  ...
  Hl = At && At.isTypedArray,
  Ko = Hl ? Cs(Hl) : vy,
  Ry = Object.prototype,
  Ay = Ry.hasOwnProperty;
function fd(t, e) {
  var n = M(t),
    r = !n && ws(t),
    i = !n && !r && Mr(t),
...
var Ey = dd(Object.keys, Object),
  Sy = Object.prototype,
  xy = Sy.hasOwnProperty;
function hd(t) {
  if (!qr(t)) return Ey(t);
  var e = [];
  for (var n in Object(t)) xy.call(t, n) && n != "constructor" && e.push(n);
  return e;
}
function Pe(t) {
...
var _y = Object.prototype,
  ...
  Ka = Ug(function (t, e) {
    ...
    for (var n in e) Iy.call(e, n) && Is(t, n, e[n]);
  });
function wy(t) {
  var e = [];
...
var Cy = Object.prototype,
  ky = Cy.hasOwnProperty;
function Ny(t) {
  if (!Oe(t)) return wy(t);
  var e = qr(t),
    n = [];
  for (var r in t) (r == "constructor" && (e || !ky.call(t, r))) || n.push(r);
  return n;
}
function Ho(t) {
  return Xe(t) ? fd(t, !0) : Ny(t);
}
var by = /\.|\[(?:[^[\]]*|(["'])(?:(?!\1)[^\\]|\\.)*?\1)\]/,
  Oy = /^\w*$/;
function Wo(t, e) {
  ...
  return n == "number" || n == "symbol" || n == "boolean" || t == null || Es(t)
    ? !0
    : Oy.test(t) || !by.test(t) || (e != null && t in Object(e));
}
...
function Gy(t) {
  ...
  return Fy.call(e, t) ? e[t] : void 0;
}
var Uy = Object.prototype,
  By = Uy.hasOwnProperty;
function jy(t) {
  var e = this.__data__;
  return Dr ? e[t] !== void 0 : By.call(e, t);
}
var Ky = "__lodash_hash_undefined__";
function Hy(t, e) {
  var n = this.__data__;
  return ((this.size += this.has(t) ? 0 : 1), (n[t] = Dr && e === void 0 ? Ky : e), this);
}
function Vt(t) {
  var e = -1,
    n = t == null ? 0 : t.length;
...
Vt.prototype.clear = Py;
Vt.prototype.delete = Ly;
Vt.prototype.get = Gy;
Vt.prototype.has = jy;
Vt.prototype.set = Hy;
function Wy() {
...
function ks(t, e) {
  for (var n = t.length; n--; ) if (zr(t[n][0], e)) return n;
  return -1;
}
...
pt.prototype.clear = Wy;
pt.prototype.delete = qy;
pt.prototype.get = Yy;
pt.prototype.has = Xy;
pt.prototype.set = Jy;
var Fr = en(Ye, "Map");
function Zy() {
  ((this.size = 0), (this.__data__ = { hash: new Vt(), map: new (Fr || pt)(), string: new Vt() }));
}
function Qy(t) {
  var e = typeof t;
...
mt.prototype.clear = Zy;
mt.prototype.delete = eT;
mt.prototype.get = tT;
mt.prototype.has = nT;
mt.prototype.set = rT;
var iT = "Expected a function";
function zo(t, e) {
  if (typeof t != "function" || (e != null && typeof e != "function")) throw new TypeError(iT);
  var n = function () {
    var r = arguments,
...
var oT =
  ...
  uT = aT(function (t) {
    ...
    return (
      ...
      t.replace(oT, function (n, r, i, s) {
        e.push(i ? s.replace(lT, "$1") : r || n);
      }),
      e
    );
  });
...
function Vo(t, e) {
  e = bs(e, t);
  for (var n = 0, r = e.length; t != null && n < r; ) t = t[Yr(e[n++])];
...
function vT(t, e) {
  ...
  if (n instanceof pt) {
    var r = n.__data__;
    if (!Fr || r.length < TT - 1) return (r.push([t, e]), (this.size = ++n.size), this);
...
Ve.prototype.clear = pT;
Ve.prototype.delete = mT;
Ve.prototype.get = gT;
Ve.prototype.has = yT;
Ve.prototype.set = vT;
function $T(t, e) {
  return t && Vr(e, Pe(e), t);
}
function RT(t, e) {
  return t && Vr(e, Ho(e), t);
}
var gd = typeof exports == "object" && exports && !exports.nodeType && exports,
  zl = gd && typeof module == "object" && module && !module.nodeType && module,
  AT = zl && zl.exports === gd,
  Vl = AT ? Ye.Buffer : void 0,
  ql = Vl ? Vl.allocUnsafe : void 0;
function ET(t, e) {
  var n = t.length,
    r = ql ? ql(n) : new t.constructor(n);
  return (t.copy(r), r);
}
function Xo(t, e) {
...
var Wa = en(Ye, "DataView"),
  ...
  LT = Qt(ja),
  Ce = kt;
((Wa && Ce(new Wa(new ArrayBuffer(1))) != eu) ||
  (Fr && Ce(new Fr()) != Xl) ||
  (za && Ce(za.resolve()) != Jl) ||
  (pn && Ce(new pn()) != Zl) ||
  (ja && Ce(new ja()) != Ql)) &&
...
var tu = be ? be.prototype : void 0,
  nu = tu ? tu.valueOf : void 0;
function KT(t) {
...
var WT = "[object Boolean]",
  ...
  lv = "[object Uint16Array]",
  uv = "[object Uint32Array]";
function cv(t, e, n) {
  var r = t.constructor;
  switch (e) {
    case QT:
...
function fv(t) {
  return typeof t.constructor == "function" && !qr(t) ? Ag(pd(t)) : {};
}
var dv = "[object Map]";
function hv(t) {
  return Ue(t) && Ce(t) == dv;
...
function ki(t, e, n, r, i, s) {
  ...
  if (!Oe(t)) return t;
  var l = M(t);
  if (l) return ((a = FT(t)), Sg(t, a));
  var u = Ce(t),
    c = u == Rd || u == Ev;
  if (Mr(t)) return ET(t);
  if (u == Ad || u == $d || (c && !i))
    return ((a = c ? {} : fv(t)), o ? wT(t, RT(a, t)) : _T(t, $T(a, t)));
  if (!G[u]) return i ? t : {};
  ((a = cv(t, u)), s || (s = new Ve()));
  var f = s.get(t);
  if (f) return f;
  ...
  return (
    id(h || t, function (m, g) {
      (h && ((g = m), (m = t[g])), Is(a, g, ki(m, e, n, g, t, s)));
    }),
    a
  );
}
...
function Hv(t) {
  return (this.__data__.set(t, Kv), this);
}
function Wv(t) {
  return this.__data__.has(t);
}
...
Pn.prototype.add = Pn.prototype.push = Hv;
Pn.prototype.has = Wv;
function Ed(t, e) {
...
function Sd(t, e, n, r, i, s) {
  ...
  var f = -1,
    d = !0,
    h = n & Vv ? new Pn() : void 0;
  for (s.set(t, e), s.set(e, t); ++f < o; ) {
    var m = t[f],
      g = e[f];
    if (r) var v = a ? r(g, m, f, e, t, s) : r(m, g, f, t, e, s);
    if (v !== void 0) {
      if (v) continue;
      d = !1;
      break;
    ...
    if (h) {
      if (
        !Ed(e, function (y, R) {
          if (!Zo(h, R) && (m === y || i(m, y, n, r, s))) return h.push(R);
        })
      ) {
        d = !1;
        break;
...
var Yv = 1,
  ...
  o$ = "[object DataView]",
  su = be ? be.prototype : void 0,
  ha = su ? su.valueOf : void 0;
function l$(t, e, n, r, i, s, a) {
  switch (n) {
    ...
    case r$:
      var l = r & Yv;
      if ((o || (o = Qo), t.size != e.size && !l)) return !1;
      var u = a.get(t);
      if (u) return u == e;
      ((r |= Xv), a.set(t, e));
      var c = Sd(o(t), o(e), r, i, s, a);
      return (a.delete(t), c);
    case s$:
      if (ha) return ha.call(t) == ha.call(e);
  }
  return !1;
}
var u$ = 1,
...
function d$(t, e, n, r, i, s) {
  ...
  for (var f = l; f--; ) {
    var d = o[f];
    if (!(a ? d in e : f$.call(e, d))) return !1;
  }
  var h = s.get(t),
    m = s.get(e);
  ...
  for (var v = a; ++f < l; ) {
    ...
    var y = t[d],
      R = e[d];
    if (r) var $ = a ? r(R, y, d, e, t, s) : r(y, R, d, t, e, s);
  ...
  if (g && !v) {
    ...
    S != O &&
      "constructor" in t &&
      "constructor" in e &&
      !(typeof S == "function" && S instanceof S && typeof O == "function" && O instanceof O) &&
      (g = !1);
  }
...
function m$(t, e, n, r, i, s) {
  ...
  if (d && !c)
    return (s || (s = new Ve()), a || Ko(t) ? Sd(t, e, n, r, i, s) : l$(t, e, l, n, r, i, s));
  if (!(n & h$)) {
    var h = c && lu.call(t, "__wrapped__"),
      m = f && lu.call(e, "__wrapped__");
    if (h || m) {
      var g = h ? t.value() : t,
        v = m ? e.value() : e;
  ...
  return d ? (s || (s = new Ve()), d$(t, e, n, r, i, s)) : !1;
}
function el(t, e, n, r, i) {
  return t === e
    ? !0
    : t == null || e == null || (!Ue(t) && !Ue(e))
      ? t !== t && e !== e
      : m$(t, e, n, r, el, i);
}
var g$ = 1,
...
function T$(t, e, n, r) {
  ...
  for (; ++i < s; ) {
    ...
    if (a[2]) {
      ...
      var c = new Ve(),
        f;
      if (!(f === void 0 ? el(u, l, g$ | y$, r, c) : f)) return !1;
    }
  }
  return !0;
}
...
function Id(t, e, n) {
  ...
  for (var r = -1, i = e.length, s = !1; ++r < i; ) {
    var a = Yr(e[r]);
    if (!(s = t != null && n(t, a))) break;
    t = t[a];
  }
  return s || ++r != i
    ? s
    : ((i = t == null ? 0 : t.length), !!i && jo(i) && _s(a, i) && (M(t) || ws(t)));
}
function A$(t, e) {
  return t != null && Id(t, e, R$);
}
var E$ = 1,
  S$ = 2;
function x$(t, e) {
  return Wo(t) && xd(e)
    ...
    : function (n) {
        var r = fT(n, t);
        return r === void 0 && r === e ? A$(n, t) : el(e, r, E$ | S$);
      };
}
function _$(t) {
  return function (e) {
  ...
  tl = Bo(function (t, e) {
    ...
    for (i && od(e[0], e[1], i) && (r = 1); ++n < r; )
      for (var s = e[n], a = Ho(s), o = -1, l = a.length; ++o < l; ) {
        var u = a[o],
          c = t[u];
        (c === void 0 || (zr(c, wd[u]) && !M$.call(t, u))) && (t[u] = s[u]);
      }
    return t;
  });
function uu(t) {
...
function F$(t, e, n, r) {
  var i = -1,
    ...
    u = e.length;
  if (!o) return l;
  e.length >= D$ && ((s = Zo), (a = !1), (e = new Pn(e)));
  e: for (; ++i < o; ) {
    var c = t[i],
      f = c;
    if (((c = c !== 0 ? c : 0), a && f === f)) {
      for (var d = u; d--; ) if (e[d] === f) continue e;
      l.push(c);
...
function ne(t, e, n) {
  ...
  return r ? ((e = e === void 0 ? 1 : xs(e)), md(t, e < 0 ? 0 : e, r)) : [];
}
function Gr(t, e, n) {
  var r = t == null ? 0 : t.length;
  return r ? ((e = e === void 0 ? 1 : xs(e)), (e = r - e), md(t, 0, e < 0 ? 0 : e)) : [];
}
function G$(t) {
...
function H$(t, e, n) {
  ...
  if (!r) return -1;
  var i = n == null ? 0 : xs(n);
  return (i < 0 && (i = K$(r + i, 0)), sd(t, Je(e), i));
}
var Mn = j$(H$);
function Be(t) {
...
var z$ = Object.prototype,
  V$ = z$.hasOwnProperty,
  q$ = L$(function (t, e, n) {
    V$.call(t, n) ? t[n].push(e) : Uo(t, n, [e]);
  }),
  Y$ = Object.prototype,
  X$ = Y$.hasOwnProperty;
function J$(t, e) {
...
function w(t, e) {
  return t != null && Id(t, e, J$);
}
var Z$ = "[object String]";
function je(t) {
  return typeof t == "string" || (!M(t) && Ue(t) && kt(t) == Z$);
}
function Q$(t, e) {
  return Ss(e, function (n) {
    return t[n];
  });
}
function Z(t) {
  return t == null ? [] : Q$(t, Pe(t));
}
var eR = Math.max;
function ge(t, e, n, r) {
  ...
  return (
    n < 0 && (n = eR(i + n, 0)),
    je(t) ? n <= i && t.indexOf(e, n) > -1 : !!i && Go(t, e, n) > -1
  );
}
function cu(t, e, n) {
  var r = t == null ? 0 : t.length;
...
function U(t) {
  ...
  if (
    Xe(t) &&
    (M(t) || typeof t == "string" || typeof t.splice == "function" || Mr(t) || Ko(t) || ws(t))
  )
    return !t.length;
  var e = Ce(t);
  if (e == tR || e == nR) return !t.size;
  if (qr(t)) return !hd(t).length;
  for (var n in t) if (iR.call(t, n)) return !1;
  return !0;
}
var sR = "[object RegExp]";
function aR(t) {
  return Ue(t) && kt(t) == sR;
}
var fu = At && At.isRegExp,
  Et = fu ? Cs(fu) : aR;
function ct(t) {
  return t === void 0;
}
...
function lR(t) {
  if (typeof t != "function") throw new TypeError(oR);
  return function () {
    var e = arguments;
    switch (e.length) {
      case 0:
...
function uR(t, e, n, r) {
  ...
  for (var i = -1, s = e.length, a = s - 1, o = t; o != null && ++i < s; ) {
    ...
    if (i != a) {
      var c = o[l];
      ((u = void 0), u === void 0 && (u = Oe(c) ? c : _s(e[i + 1]) ? [] : {}));
    }
    (Is(o, l, u), (o = o[l]));
  }
  return t;
...
var Od = typeof global == "object" && global && global.Object === Object && global,
  ...
  gt = Od || vR || Function("return this")(),
  St = gt.Symbol,
  Pd = Object.prototype,
  $R = Pd.hasOwnProperty,
  RR = Pd.toString,
  Vn = St ? St.toStringTag : void 0;
function AR(t) {
  var e = $R.call(t, Vn),
    n = t[Vn];
  try {
...
var _R = "[object Null]",
  IR = "[object Undefined]",
  du = St ? St.toStringTag : void 0;
function Nt(t) {
  return t == null ? (t === void 0 ? IR : _R) : du && du in Object(t) ? AR(t) : xR(t);
}
function xt(t) {
  return t != null && typeof t == "object";
}
...
function Ls(t) {
  return typeof t == "symbol" || (xt(t) && Nt(t) == wR);
}
function Ms(t, e) {
  for (var n = -1, r = t == null ? 0 : t.length, i = Array(r); ++n < r; ) i[n] = e(t[n], n, t);
  return i;
...
var pe = Array.isArray,
  hu = St ? St.prototype : void 0,
  pu = hu ? hu.toString : void 0;
function Ld(t) {
  if (typeof t == "string") return t;
  if (pe(t)) return Ms(t, Ld) + "";
  if (Ls(t)) return pu ? pu.call(t) : "";
  var e = t + "";
  return e == "0" && 1 / t == -1 / 0 ? "-0" : e;
}
var CR = /\s/;
...
var NR = /^\s+/;
function bR(t) {
  return t && t.slice(0, kR(t) + 1).replace(NR, "");
}
function ft(t) {
  var e = typeof t;
  return t != null && (e == "object" || e == "function");
...
function DR(t) {
  ...
  t = bR(t);
  var n = PR.test(t);
  return n || LR.test(t) ? MR(t.slice(2), n ? 2 : 8) : OR.test(t) ? mu : +t;
}
var gu = 1 / 0,
  FR = 17976931348623157e292;
function GR(t) {
  if (!t) return t === 0 ? t : 0;
  if (((t = DR(t)), t === gu || t === -gu)) {
    var e = t < 0 ? -1 : 1;
...
function Md(t) {
  if (!ft(t)) return !1;
  var e = Nt(t);
  return e == jR || e == KR || e == BR || e == HR;
}
var pa = gt["__core-js_shared__"],
  yu = (function () {
...
var qR = /[\\^$.*+?()[\]{}|]/g,
  YR = /^\[object .+?Constructor\]$/,
  XR = Function.prototype,
  JR = Object.prototype,
  ZR = XR.toString,
  QR = JR.hasOwnProperty,
  eA = RegExp(
    "^" +
      ZR.call(QR)
        .replace(qR, "\\$&")
...
var Xi = (function () {
  ...
  uA = Xi
    ? function (t, e) {
        return Xi(t, "toString", { configurable: !0, enumerable: !1, value: lA(e), writable: !0 });
      }
    : Ds,
  cA = oA(uA);
function fA(t, e) {
...
function Fs(t, e) {
  ...
  return (
    (e = e ?? gA),
    !!e && (n == "number" || (n != "symbol" && yA.test(t))) && t > -1 && t % 1 == 0 && t < e
  );
}
function Dd(t, e, n) {
  e == "__proto__" && Xi
    ? Xi(t, e, { configurable: !0, enumerable: !0, value: n, writable: !0 })
    : (t[e] = n);
}
function Gs(t, e) {
  return t === e || (t !== t && e !== e);
...
function rl(t, e, n) {
  var r = t[e];
  (!(vA.call(t, e) && Gs(r, n)) || (n === void 0 && !(e in t))) && Dd(t, e, n);
}
function $A(t, e, n, r) {
  var i = !n;
  n || (n = {});
...
function RA(t, e, n) {
  return (
    ...
    function () {
      ...
      i = -1;
      for (var o = Array(e + 1); ++i < e; ) o[i] = r[i];
      return ((o[e] = n(a)), rA(t, this, o));
    }
  );
}
function AA(t, e) {
  return cA(RA(t, e, Ds), t + "");
}
var EA = 9007199254740991;
function il(t) {
  return typeof t == "number" && t > -1 && t % 1 == 0 && t <= EA;
}
function sn(t) {
...
function xA(t) {
  return AA(function (e, n) {
    ...
    for (
      s = t.length > 3 && typeof s == "function" ? (i--, s) : void 0,
        a && SA(n[0], n[1], a) && ((s = i < 3 ? void 0 : s), (i = 1)),
        e = Object(e);
      ++r < i;
    ) {
      var o = n[r];
...
function sl(t) {
  var e = t && t.constructor,
    n = (typeof e == "function" && e.prototype) || _A;
  return t === n;
}
function IA(t, e) {
  for (var n = -1, r = Array(t); ++n < t; ) r[n] = e(n);
...
var Fd = Object.prototype,
  CA = Fd.hasOwnProperty,
  kA = Fd.propertyIsEnumerable,
  Gd = vu(
    (function () {
      return arguments;
    })()
    ...
    ? vu
    : function (t) {
        return xt(t) && CA.call(t, "callee") && !kA.call(t, "callee");
      };
function NA() {
  return !1;
}
var Ud = typeof exports == "object" && exports && !exports.nodeType && exports,
  $u = Ud && typeof module == "object" && module && !module.nodeType && module,
  bA = $u && $u.exports === Ud,
  Ru = bA ? gt.Buffer : void 0,
  OA = Ru ? Ru.isBuffer : void 0,
  Ya = OA || NA,
  PA = "[object Arguments]",
  LA = "[object Array]",
  MA = "[object Boolean]",
  ...
  j = {};
j[YA] = j[XA] = j[JA] = j[ZA] = j[QA] = j[eE] = j[tE] = j[nE] = j[rE] = !0;
j[PA] =
  j[LA] =
  j[VA] =
  j[MA] =
  ...
  j[zA] =
    !1;
function iE(t) {
  return xt(t) && il(t.length) && !!j[Nt(t)];
}
function Bd(t) {
  return function (e) {
    return t(e);
...
var jd = typeof exports == "object" && exports && !exports.nodeType && exports,
  Or = jd && typeof module == "object" && module && !module.nodeType && module,
  sE = Or && Or.exports === jd,
  ma = sE && Od.process,
  Ji = (function () {
    try {
...
var lE = Wd(Object.keys, Object),
  uE = Object.prototype,
  cE = uE.hasOwnProperty;
function fE(t) {
  if (!sl(t)) return lE(t);
  var e = [];
  for (var n in Object(t)) cE.call(t, n) && n != "constructor" && e.push(n);
  return e;
}
function Jr(t) {
  return sn(t) ? Hd(t) : fE(t);
}
var dE = Object.prototype,
  ...
  Ze = xA(function (t, e) {
    ...
    for (var n in e) hE.call(e, n) && rl(t, n, e[n]);
  });
function pE(t) {
  var e = [];
  if (t != null) for (var n in Object(t)) e.push(n);
...
function yE(t) {
  ...
  var e = sl(t),
    n = [];
  for (var r in t) (r == "constructor" && (e || !gE.call(t, r))) || n.push(r);
  return n;
}
function TE(t) {
  return sn(t) ? Hd(t, !0) : yE(t);
}
var vE = /\.|\[(?:[^[\]]*|(["'])(?:(?!\1)[^\\]|\\.)*?\1)\]/,
  $E = /^\w*$/;
function al(t, e) {
  if (pe(t)) return !1;
  var n = typeof t;
  return n == "number" || n == "symbol" || n == "boolean" || t == null || Ls(t)
    ? !0
    : $E.test(t) || !vE.test(t) || (e != null && t in Object(e));
}
...
function CE(t) {
  var e = this.__data__;
  return Ur ? e[t] !== void 0 : wE.call(e, t);
}
var kE = "__lodash_hash_undefined__";
function NE(t, e) {
  var n = this.__data__;
  return ((this.size += this.has(t) ? 0 : 1), (n[t] = Ur && e === void 0 ? kE : e), this);
}
function qt(t) {
  var e = -1,
    n = t == null ? 0 : t.length;
...
qt.prototype.clear = RE;
qt.prototype.delete = AE;
qt.prototype.get = _E;
qt.prototype.has = CE;
qt.prototype.set = NE;
function bE() {
...
function LE(t) {
  ...
  if (n < 0) return !1;
  var r = e.length - 1;
  return (n == r ? e.pop() : PE.call(e, n, 1), --this.size, !0);
}
function ME(t) {
  var e = this.__data__,
    n = Us(e, t);
...
yt.prototype.clear = bE;
yt.prototype.delete = LE;
yt.prototype.get = ME;
yt.prototype.has = DE;
yt.prototype.set = FE;
var Br = rn(gt, "Map");
function GE() {
  ((this.size = 0), (this.__data__ = { hash: new qt(), map: new (Br || yt)(), string: new qt() }));
}
function UE(t) {
  var e = typeof t;
  return e == "string" || e == "number" || e == "symbol" || e == "boolean"
...
function Bs(t, e) {
  var n = t.__data__;
  return UE(e) ? n[typeof e == "string" ? "string" : "hash"] : n.map;
}
function BE(t) {
...
function ol(t, e) {
  if (typeof t != "function" || (e != null && typeof e != "function")) throw new TypeError(WE);
  var n = function () {
    var r = arguments,
      i = e ? e.apply(this, r) : r[0],
      s = n.cache;
...
var qE =
  ...
  XE = VE(function (t) {
    ...
    return (
      t.charCodeAt(0) === 46 && e.push(""),
      t.replace(qE, function (n, r, i, s) {
        e.push(i ? s.replace(YE, "$1") : r || n);
      }),
      e
    );
  });
...
function js(t, e) {
  return pe(t) ? t : al(t, e) ? [t] : XE(JE(t));
}
function Zr(t) {
...
function ll(t, e) {
  e = js(e, t);
  for (var n = 0, r = e.length; t != null && n < r; ) t = t[Zr(e[n++])];
  return n && n == r ? t : void 0;
}
function ZE(t, e, n) {
...
var QE = Wd(Object.getPrototypeOf, Object);
function eS() {
...
function sS(t, e) {
  ...
  if (n instanceof yt) {
    var r = n.__data__;
    if (!Br || r.length < iS - 1) return (r.push([t, e]), (this.size = ++n.size), this);
...
ut.prototype.clear = eS;
ut.prototype.delete = tS;
ut.prototype.get = nS;
ut.prototype.has = rS;
ut.prototype.set = sS;
function aS(t, e) {
...
var Xa = rn(gt, "DataView"),
  ...
  yS = nn(qa),
  $t = Nt;
((Xa && $t(new Xa(new ArrayBuffer(1))) != Cu) ||
  (Br && $t(new Br()) != xu) ||
  (Ja && $t(Ja.resolve()) != _u) ||
  (Za && $t(new Za()) != Iu) ||
  (qa && $t(new qa()) != wu)) &&
...
var ku = gt.Uint8Array,
  TS = "__lodash_hash_undefined__";
function vS(t) {
  return (this.__data__.set(t, TS), this);
}
function $S(t) {
  return this.__data__.has(t);
}
...
Zi.prototype.add = Zi.prototype.push = vS;
Zi.prototype.has = $S;
function Xd(t, e) {
  for (var n = -1, r = t == null ? 0 : t.length; ++n < r; ) if (e(t[n], n, t)) return !0;
  return !1;
...
function Jd(t, e, n, r, i, s) {
  ...
  for (s.set(t, e), s.set(e, t); ++f < o; ) {
    ...
    if (h) {
      if (
        !Xd(e, function (y, R) {
          if (!RS(h, R) && (m === y || i(m, y, n, r, s))) return h.push(R);
        })
      ) {
        d = !1;
        break;
...
var _S = 1,
  ...
  FS = "[object DataView]",
  Nu = St ? St.prototype : void 0,
  ga = Nu ? Nu.valueOf : void 0;
function GS(t, e, n, r, i, s, a) {
  switch (n) {
    ...
    case PS:
      var l = r & _S;
      if ((o || (o = xS), t.size != e.size && !l)) return !1;
      var u = a.get(t);
      if (u) return u == e;
      ((r |= IS), a.set(t, e));
...
function KS(t, e, n, r, i, s) {
  ...
  for (var f = l; f--; ) {
    var d = o[f];
    if (!(a ? d in e : jS.call(e, d))) return !1;
  }
  var h = s.get(t),
    m = s.get(e);
  if (h && m) return h == e && m == t;
...
function zS(t, e, n, r, i, s) {
  ...
  if (d && !c)
    return (s || (s = new ut()), a || Kd(t) ? Jd(t, e, n, r, i, s) : GS(t, e, l, n, r, i, s));
  if (!(n & HS)) {
    var h = c && Pu.call(t, "__wrapped__"),
      m = f && Pu.call(e, "__wrapped__");
    if (h || m) {
      var g = h ? t.value() : t,
        v = m ? e.value() : e;
  ...
  return d ? (s || (s = new ut()), KS(t, e, n, r, i, s)) : !1;
}
function ul(t, e, n, r, i) {
  return t === e
    ? !0
    : t == null || e == null || (!xt(t) && !xt(e))
      ? t !== t && e !== e
      : zS(t, e, n, r, ul, i);
}
var VS = 1,
...
function YS(t, e, n, r) {
  ...
  for (; ++i < s; ) {
    ...
    if (a[2]) {
      ...
      var c = new ut(),
        f;
      if (!(f === void 0 ? ul(u, l, VS | qS, r, c) : f)) return !1;
    }
  }
  return !0;
}
...
function QS(t, e, n) {
  ...
  return s || ++r != i
    ? s
    : ((i = t == null ? 0 : t.length), !!i && il(i) && Fs(a, i) && (pe(t) || Gd(t)));
}
function ex(t, e) {
  return t != null && QS(t, e, ZS);
}
var tx = 1,
  nx = 2;
function rx(t, e) {
  return al(t) && Zd(e)
    ...
    : function (n) {
        var r = ZE(n, t);
        return r === void 0 && r === e ? ex(n, t) : ul(e, r, tx | nx);
      };
}
function ix(t) {
  return function (e) {
...
var yx = "[object String]";
function Qi(t) {
  return typeof t == "string" || (!pe(t) && xt(t) && Nt(t) == yx);
}
function Tx(t, e) {
...
function vx(t) {
  return t == null ? [] : Tx(t, Jr(t));
}
var $x = Math.max;
function Rx(t, e, n, r) {
  ((t = sn(t) ? t : vx(t)), (n = n ? UR(n) : 0));
  var i = t.length;
  return (
    n < 0 && (n = $x(i + n, 0)),
    Qi(t) ? n <= i && t.indexOf(e, n) > -1 : !!i && mA(t, e, n) > -1
  );
}
var Ax = "[object RegExp]";
function Ex(t) {
  return xt(t) && Nt(t) == Ax;
}
var Lu = Ji && Ji.isRegExp,
  Sx = Lu ? Bd(Lu) : Ex;
function xx(t, e, n, r) {
  if (!ft(t)) return t;
  e = js(e, t);
...
function Ni(t) {
  ...
  if (t instanceof fe) {
    ...
    if (t instanceof me) return { type: "Alternative", definition: e(t.definition) };
    if (t instanceof se) return { type: "Option", idx: t.idx, definition: e(t.definition) };
    if (t instanceof xe)
    ...
    if (t instanceof K) {
      const n = {
        ...
        label: Cx(t.terminalType),
        idx: t.idx,
      };
      Qi(t.label) && (n.terminalLabel = t.label);
      const r = t.terminalType.PATTERN;
      return (t.terminalType.PATTERN && (n.pattern = Sx(r) ? r.source : r), n);
    } else {
      if (t instanceof jn)
...
function es(t, e = []) {
  return t instanceof se || t instanceof q || t instanceof ye
    ? !0
    : t instanceof Te
      ? wx(t.definition, (r) => es(r, e))
      : t instanceof fe && Rx(e, t)
        ? !1
        : t instanceof et
          ? (t instanceof fe && e.push(t), mx(t.definition, (r) => es(r, e)))
          : !1;
}
function Ox(t) {
...
function We(t) {
  if (t instanceof fe) return "SUBRULE";
  if (t instanceof se) return "OPTION";
  if (t instanceof Te) return "OR";
  if (t instanceof xe) return "AT_LEAST_ONE";
  if (t instanceof _e) return "AT_LEAST_ONE_SEP";
...
class Ws {
  walk(e, n = []) {
    k(e.definition, (r, i) => {
      ...
      if (r instanceof fe) this.walkProdRef(r, s, n);
      else if (r instanceof K) this.walkTerminal(r, s, n);
      else if (r instanceof me) this.walkFlat(r, s, n);
      else if (r instanceof se) this.walkOption(r, s, n);
      else if (r instanceof xe) this.walkAtLeastOne(r, s, n);
      else if (r instanceof _e) this.walkAtLeastOneSep(r, s, n);
      else if (r instanceof ye) this.walkManySep(r, s, n);
      else if (r instanceof q) this.walkMany(r, s, n);
      else if (r instanceof Te) this.walkOr(r, s, n);
  ...
  walkAtLeastOne(e, n, r) {
    const i = [new se({ definition: e.definition })].concat(n, r);
    this.walk(e, i);
  }
...
function Mu(t, e, n) {
  return [
    new se({ definition: [new K({ terminalType: t.separator })].concat(t.definition) }),
  ].concat(e, n);
}
function Qr(t) {
  if (t instanceof fe) return Qr(t.referencedRule);
  if (t instanceof K) return Mx(t);
  if (bx(t)) return Px(t);
  if (Ox(t)) return Lx(t);
  throw Error("non exhaustive match");
}
...
class Dx extends Ws {
  ...
  walkTerminal(e, n, r) {}
  walkProdRef(e, n, r) {
    const i = Gx(e.referencedRule, e.idx) + this.topProd.name,
      s = n.concat(r),
      a = new me({ definition: s }),
      o = Qr(a);
    this.follows[i] = o;
  }
}
...
const nh = "Complement Sets are not supported for first char optimization",
  ts = `Unable to use "first char" lexer optimizations:
`;
function jx(t, e = !1) {
  try {
    const n = zs(t);
    ...
    if (n.message === nh)
      e &&
        kd(`${ts}	Unable to optimize: < ${t.toString()} >
...
function Qa(t, e, n) {
  switch (t.type) {
    case "Disjunction":
      for (let i = 0; i < t.value.length; i++) Qa(t.value[i], e, n);
      break;
    case "Alternative":
      const r = t.value;
      for (let i = 0; i < r.length; i++) {
        ...
        switch (a.type) {
          case "Character":
            ...
            break;
          case "Set":
            if (a.complement === !0) throw Error(nh);
            k(a.value, (l) => {
              if (typeof l == "number") yi(l, e, n);
              else {
                const u = l;
                if (n === !0) for (let c = u.from; c <= u.to; c++) yi(c, e, n);
                else {
                  for (let c = u.from; c <= u.to && c < xr; c++) yi(c, e, n);
                  if (u.to >= xr) {
                    const c = u.from >= xr ? u.from : xr,
                      f = u.to,
                      d = _t(c),
                      h = _t(f);
                    for (let m = d; m <= h; m++) e[m] = m;
                  }
                }
              }
            });
        ...
        if ((a.type === "Group" && eo(a) === !1) || (a.type !== "Group" && o === !1)) break;
      }
      break;
    default:
      throw Error("non exhaustive match!");
...
function Du(t, e) {
  return Mn(t.value, (n) => {
    if (typeof n == "number") return ge(e, n);
    {
      const r = n;
...
class Hx extends Rs {
  ...
  visitSet(e) {
    e.complement
      ? Du(e, this.targetCharCodes) === void 0 && (this.found = !0)
      : Du(e, this.targetCharCodes) !== void 0 && (this.found = !0);
  }
}
function cl(t, e) {
  ...
  } else return Mn(e, (n) => ge(t, n.charCodeAt(0))) !== void 0;
}
const Yt = "PATTERN",
  Sr = "defaultMode",
  Ti = "modes";
...
`,
  ...
  n("Transform Patterns", () => {
    ((i = !1),
      (s = I(r, (R) => {
        ...
        if (Et($)) {
          const S = $.source;
          return S.length === 1 && S !== "^" && S !== "$" && S !== "." && !$.ignoreCase
            ? S
            : S.length === 2 &&
                S[0] === "\\" &&
                !ge(
          ...
          if (ht($)) return ((i = !0), { exec: $ });
          if (typeof $ == "object") return ((i = !0), $);
          if (typeof $ == "string") {
            if ($.length === 1) return $;
            {
              const S = $.replace(/[\\^$.*+?()[\]{}|]/g, "\\$&"),
  ...
  n("misc mapping", () => {
    ((a = I(r, (R) => R.tokenTypeIdx)),
      ...
      (l = I(r, (R) => {
        const $ = R.LONGER_ALT;
        if ($) return M($) ? I($, (O) => cu(r, O)) : [cu(r, $)];
      })),
      (u = I(r, (R) => R.PUSH_MODE)),
      (c = I(r, (R) => w(R, "POP_MODE"))));
  });
  let f;
  n("Line Terminator Handling", () => {
    ...
    ((f = I(r, ($) => !1)),
      e.positionTracking !== "onlyOffset" &&
        (f = I(r, ($) =>
          w($, "LINE_BREAKS") ? !!$.LINE_BREAKS : sh($, R) === !1 && cl(R, $.PATTERN)
        )));
  });
  let d, h, m, g;
  n("Misc Mapping #2", () => {
        ...
        y = Se(
          ...
          (R, $, S) => {
            if (typeof $.PATTERN == "string") {
              const O = $.PATTERN.charCodeAt(0),
                oe = _t(O);
              ya(R, oe, g[S]);
            } else if (M($.START_CHARS_HINT)) {
              let O;
              k($.START_CHARS_HINT, (oe) => {
                const Me = typeof oe == "string" ? oe.charCodeAt(0) : oe,
                  ve = _t(Me);
              ...
              if ($.PATTERN.unicode)
                ((v = !1),
                  e.ensureOptimizations &&
                    Va(`${ts}	Unable to analyze < ${$.PATTERN.toString()} > pattern.
	The regexp unicode flag is not currently supported by the regexp-to-ast library.
	This will disable the lexer's first char optimizations.
	For details See: https://chevrotain.io/docs/guide/resolving_lexer_errors.html#UNICODE_OPTIMIZE`));
              else {
                const O = jx($.PATTERN, e.ensureOptimizations);
                (U(O) && (v = !1),
                  k(O, (oe) => {
                    ya(R, oe, g[S]);
                  }));
              ...
              (e.ensureOptimizations &&
                Va(`${ts}	TokenType: <${$.name}> is using a custom token pattern without providing <start_chars_hint> parameter.
	This will disable the lexer's first char optimizations.
...
function Yx(t) {
  const e = Le(t, (i) => {
      const s = i[Yt];
      return !Et(s) && !ht(s) && !w(s, "exec") && !je(s);
    }),
    n = I(e, (i) => ({
      message:
        "Token Type: ->" +
...
function n_(t) {
  ...
  let n = I(t, (s) =>
    Se(
      t,
      (a, o) => (
        s.PATTERN.source === o.PATTERN.source &&
          !ge(e, o) &&
          o.PATTERN !== he.NA &&
          (e.push(o), a.push(o)),
        a
...
function r_(t) {
  const e = Le(t, (r) => {
    if (!w(r, "GROUP")) return !1;
    const i = r.GROUP;
    return i !== he.SKIPPED && i !== he.NA && !je(i);
  });
  return I(e, (r) => ({
    message:
      "Token Type: ->" + r.name + "<- static 'GROUP' can only be Lexer.SKIPPED/Lexer.NA/A String",
        ...
        return (
          a === he.NA ||
            (je(a)
              ...
              : Et(a) && o_(a) && r.push({ str: a.source, idx: s, tokenType: i })),
          r
        );
      },
      []
  ...
  return (
    k(t, (r, i) => {
      k(n, ({ str: s, idx: a, tokenType: o }) => {
        if (i < a && a_(s, r.PATTERN)) {
          const l = `Token: ->${o.name}<- can never be matched.
Because it appears AFTER the Token Type ->${r.name}<-in the lexer's definition.
See https://chevrotain.io/docs/guide/resolving_lexer_errors.html#UNREACHABLE`;
          e.push({ message: l, type: Y.UNREACHABLE_PATTERN, tokenTypes: [r, o] });
        }
      });
    }),
    e
...
function a_(t, e) {
  if (Et(e)) {
    ...
    if (ht(e)) return e(t, 0, [], {});
    if (w(e, "exec")) return e.exec(t, 0, [], {});
...
`,
    ...
    w(t, Ti) &&
      w(t, Sr) &&
      !w(t.modes, t.defaultMode) &&
      r.push({
        message: `A MultiMode Lexer cannot be initialized with a ${Sr}: <${t.defaultMode}>which does not exist
`,
  ...
  return (
    e &&
      k(a, (l) => {
        const u = sh(l, o);
        if (u !== !1) {
          const f = { message: h_(l, u), type: u.issue, tokenType: l };
          r.push(f);
        } else
          w(l, "LINE_BREAKS") ? l.LINE_BREAKS === !0 && (i = !0) : cl(o, l.PATTERN) && (i = !0);
      }),
    e &&
      !i &&
      r.push({
...
const d_ = {
  test: function (t) {
    ...
    for (let n = this.lastIndex; n < e; n++) {
      ...
      if (r === 13)
        return (
          t.charCodeAt(n + 1) === 10 ? (this.lastIndex = n + 2) : (this.lastIndex = n + 1),
          !0
        );
    }
    return !1;
...
function sh(t, e) {
  if (w(t, "LINE_BREAKS")) return !1;
  if (Et(t.PATTERN)) {
    try {
      cl(e, t.PATTERN);
    } catch (n) {
      return { issue: Y.IDENTIFY_TERMINATOR, errMsg: n.message };
    }
    return !1;
  } else {
    if (je(t.PATTERN)) return !1;
    if (ih(t)) return { issue: Y.CUSTOM_LINE_BREAK };
    throw Error("non exhaustive match");
  }
}
function h_(t, e) {
...
function ah(t) {
  return I(t, (n) => (je(n) ? n.charCodeAt(0) : n));
}
function ya(t, e, n) {
...
function p_() {
  if (U(Oi)) {
    Oi = new Array(65536);
    for (let t = 0; t < 65536; t++) Oi[t] = t > 255 ? 255 + ~~(t / 255) : t;
  }
}
function ei(t, e) {
...
function g_(t) {
  k(t, (e) => {
    (uh(e) || ((oh[Uu] = e), (e.tokenTypeIdx = Uu++)),
      Bu(e) && !M(e.CATEGORIES) && (e.CATEGORIES = [e.CATEGORIES]),
      Bu(e) || (e.CATEGORIES = []),
      v_(e) || (e.categoryMatches = []),
      $_(e) || (e.categoryMatchesMap = {}));
  });
}
function y_(t) {
  k(t, (e) => {
    ((e.categoryMatches = []),
      k(e.categoryMatchesMap, (n, r) => {
...
function uh(t) {
  return w(t, "tokenTypeIdx");
}
function Bu(t) {
  return w(t, "CATEGORIES");
}
function v_(t) {
  return w(t, "categoryMatches");
}
function $_(t) {
  return w(t, "categoryMatchesMap");
}
function R_(t) {
  return w(t, "tokenTypeIdx");
}
    ...
    if (
      ...
      (this.TRACE_INIT = (i, s) => {
        if (this.traceInitPerf === !0) {
          ...
          const { time: o, value: l } = Nd(s),
            u = o > 10 ? console.warn : console.log;
          return (
            this.traceInitIndent < this.traceInitMaxIdent && u(`${a}<-- <${i}> time: ${o}ms`),
            this.traceInitIndent--,
            l
          );
        } else return s();
...
a boolean 2nd argument is no longer supported`);
    ...
    (r === !0
      ...
      this.TRACE_INIT("Lexer Constructor", () => {
        ...
        (this.TRACE_INIT("Lexer Config handling", () => {
          if (this.config.lineTerminatorsPattern === _r.lineTerminatorsPattern)
            this.config.lineTerminatorsPattern = d_;
          else if (this.config.lineTerminatorCharacters === _r.lineTerminatorCharacters)
	...
	For details See: https://chevrotain.io/docs/guide/resolving_lexer_errors.html#MISSING_LINE_TERM_CHARS`);
          ...
          ((this.trackStartLines = /full|onlyStart/i.test(this.config.positionTracking)),
            ...
            M(e)
              ? (i = { modes: { defaultMode: ae(e) }, defaultMode: Sr })
              : ((s = !1), (i = ae(e))));
        }),
          this.config.skipValidations === !1 &&
            (this.TRACE_INIT("performRuntimeChecks", () => {
              this.lexerDefinitionErrors = this.lexerDefinitionErrors.concat(
                l_(i, this.trackStartLines, this.config.lineTerminatorCharacters)
              );
            }),
            this.TRACE_INIT("performWarningRuntimeChecks", () => {
              this.lexerDefinitionWarning = this.lexerDefinitionWarning.concat(
                u_(i, this.trackStartLines, this.config.lineTerminatorCharacters)
              );
            })),
          (i.modes = i.modes ? i.modes : {}),
          k(i.modes, (o, l) => {
            i.modes[l] = Ps(o, (u) => ct(u));
          }));
        const a = Pe(i.modes);
        if (
          (k(i.modes, (o, l) => {
              ...
              if (
                ...
                this.config.skipValidations === !1 &&
                  this.TRACE_INIT("validatePatterns", () => {
                    this.lexerDefinitionErrors = this.lexerDefinitionErrors.concat(zx(o, a));
                  }),
                ...
                (this.TRACE_INIT("analyzeTokenTypes", () => {
                  ...
                  (this.emptyGroups = Ka({}, this.emptyGroups, u.emptyGroups)),
          ...
          !U(this.lexerDefinitionErrors) && !this.config.deferDefinitionErrorsHandling)
        ) {
...
` + l
        ...
        (k(this.lexerDefinitionWarning, (o) => {
          ...
          this.TRACE_INIT("Choosing sub-methods implementations", () => {
            if (
              (rh
                ? ((this.chopInput = On), (this.match = this.matchWithTest))
                : ((this.updateLastIndex = J), (this.match = this.matchWithExec)),
              s && (this.handleModes = J),
              this.trackStartLines === !1 && (this.computeNewColumn = On),
          ...
          this.TRACE_INIT("Failed Optimization Warnings", () => {
            const o = Se(this.canModeBeOptimized, (l, u, c) => (u === !1 && l.push(c), l), []);
...
` + i
  ...
  tokenizeInternal(e, n) {
    ...
    let S = 0,
      O = 0;
    const oe = this.hasCustom ? 0 : Math.floor(e.length / 10),
      Me = new Array(oe),
      ve = [];
    let He = this.trackStartLines ? 1 : void 0,
      Ie = this.trackStartLines ? 1 : void 0;
    const E = c_(this.emptyGroups),
      T = this.trackStartLines,
    ...
    const wp = (le) => {
      if (N.length === 1 && le.tokenType.PUSH_MODE === void 0) {
        const we = this.config.errorMessageProvider.buildUnableToPopLexerModeMessage(le);
        ve.push({
        ...
        N.pop();
        const we = Ln(N);
        ((P = this.patternIdxToConfig[we]),
          (b = this.charCodeToPatternIdxToConfig[we]),
          (x = P.length));
        const un = this.canModeBeOptimized[we] && this.config.safeMode === !1;
        b && un ? (Q = Ft) : (Q = V);
      }
    };
    function Sl(le) {
      (N.push(le),
        (b = this.charCodeToPatternIdxToConfig[le]),
        (P = this.patternIdxToConfig[le]),
        (x = P.length),
        (x = P.length));
      const we = this.canModeBeOptimized[le] && this.config.safeMode === !1;
      b && we ? (Q = Ft) : (Q = V);
    }
    Sl.call(this, n);
    let De;
    ...
    for (; S < $; ) {
      ...
      for (r = 0; r < un; r++) {
        ...
        if (
          (tt !== !1
            ...
            : De.isCustom === !0
              ? ((y = Re.exec(R, S, Me, E)),
                y !== null ? ((l = y[0]), y.payload !== void 0 && (u = y.payload)) : (l = null))
              : (this.updateLastIndex(Re, S), (l = this.match(Re, e, S))),
          l !== null)
        ) {
          if (((o = De.longerAlt), o !== void 0)) {
            ...
            for (s = 0; s < vt; s++) {
              ...
              if (
                ...
                nt.isCustom === !0
                  ? ((y = Gt.exec(R, S, Me, E)),
                    y !== null ? ((a = y[0]), y.payload !== void 0 && (c = y.payload)) : (a = null))
                  : (this.updateLastIndex(Gt, S), (a = this.match(Gt, e, S))),
                a && a.length > l.length)
              ) {
                ((l = a), (u = c), (De = nt));
                break;
      ...
      if (l !== null) {
        if (
          ...
          d !== void 0 &&
            ((h = De.tokenTypeIdx),
            (m = this.createTokenInstance(l, S, h, De.tokenType, He, Ie, f)),
            this.handlePayload(m, u),
            d === !1 ? (O = this.addToken(Me, O, m)) : E[d].push(m)),
          (e = this.chopInput(e, f)),
          (S = S + f),
          (Ie = this.computeNewColumn(Ie, f)),
          T === !0 && De.canLineTerminator === !0)
        ) {
          let Re = 0,
            tt,
            vt;
          _.lastIndex = 0;
          do ((tt = _.test(l)), tt === !0 && ((vt = _.lastIndex - 1), Re++));
          while (tt === !0);
          Re !== 0 &&
            ((He = He + Re),
            (Ie = f - vt),
            this.updateTokenEndLineColumnLocation(m, d, vt, Re, He, Ie, f));
        }
        this.handleModes(De, wp, Sl, m);
      } else {
        const Re = S,
          tt = He,
          vt = Ie;
        ...
        for (; nt === !1 && S < $; )
          for (e = this.chopInput(e, 1), S++, i = 0; i < x; i++) {
            ...
            if (
              (_l !== !1
                ? R.charCodeAt(S) === _l && (nt = !0)
                : Gt.isCustom === !0
                  ? (nt = ta.exec(R, S, Me, E) !== null)
                  : (this.updateLastIndex(ta, S), (nt = ta.exec(e) !== null)),
              nt === !0)
            )
              break;
          }
        if (
          ...
          (v = this.config.errorMessageProvider.buildUnexpectedCharactersMessage(R, Re, g, tt, vt)),
          ve.push({ offset: Re, line: tt, column: vt, length: g, message: v }),
          xl === !1)
        )
          break;
      }
    }
    return (this.hasCustom || (Me.length = O), { tokens: Me, groups: E, errors: ve });
  }
  handleModes(e, n, r, i) {
    if (e.pop === !0) {
      const s = e.push;
  ...
  updateTokenEndLineColumnLocation(e, n, r, i, s, a, o) {
    ...
    n !== void 0 &&
      ((l = r === o - 1),
      (u = l ? -1 : 0),
      (i === 1 && l === !0) || ((e.endLine = s + u), (e.endColumn = a - 1 + -u)));
  }
...
function E_(t) {
  const e = t.pattern,
    n = {};
  if (((n.name = t.name), ct(e) || (n.PATTERN = e), w(t, A_)))
    throw `The parent property is no longer supported.
See: https://github.com/chevrotain/chevrotain/issues/564#issuecomment-349062346 for details.`;
  return (
    w(t, ju) && (n.CATEGORIES = t[ju]),
    ti([n]),
    w(t, Ku) && (n.LABEL = t[Ku]),
    w(t, Hu) && (n.GROUP = t[Hu]),
    w(t, zu) && (n.POP_MODE = t[zu]),
    w(t, Wu) && (n.PUSH_MODE = t[Wu]),
    w(t, Vu) && (n.LONGER_ALT = t[Vu]),
    w(t, qu) && (n.LINE_BREAKS = t[qu]),
    w(t, Yu) && (n.START_CHARS_HINT = t[Yu]),
    n
  );
}
const It = fh({ name: "EOF", pattern: he.NA });
ti([It]);
...
but found: '` +
    ...
    if (r) return s + r + o;
    {
      const l = Se(t, (d, h) => d.concat(h), []),
        u = I(l, (d) => `[${I(d, (h) => mn(h)).join(", ")}]`),
...
and Non-Terminal names start with a lower case letter.`;
    ...
    buildAlternationPrefixAmbiguityError(t) {
      const e = I(t.prefixPath, (i) => mn(i)).join(", "),
 ...
 has ${t.alternation.definition.length + 1} alternatives.`;
    ...
    buildLeftRecursionError(t) {
      const e = t.topLevelRule.name,
        n = I(t.leftRecursionPath, (s) => s.name),
        r = `${e} --> ${n.concat([e]).join(" --> ")}`;
...
see: https://en.wikipedia.org/wiki/LL_parser#Left_factoring.`;
    ...
    buildDuplicateRuleNameError(t) {
      let e;
      return (
        t.topLevelRule instanceof jn ? (e = t.topLevelRule.name) : (e = t.topLevelRule),
...
class I_ extends Ws {
  ...
  startWalking() {
    ...
    return (
      (this.ruleStack = ae(this.path.ruleStack).reverse()),
      (this.occurrenceStack = ae(this.path.occurrenceStack).reverse()),
      this.ruleStack.pop(),
  ...
  walkMany(e, n, r) {
    if (e.idx === this.occurrence) {
      ...
      ((this.result.isEndOfRule = i === void 0),
        i instanceof K && ((this.result.token = i.terminalType), (this.result.occurrence = i.idx)));
...
function no(t, e, n = []) {
  ...
  for (; n.length < e && i < t.length; ) {
    const o = t[i];
    if (o instanceof me) return a(o.definition);
    if (o instanceof fe) return a(o.definition);
    if (o instanceof se) r = a(o.definition);
    else if (o instanceof xe) {
      const l = o.definition.concat([new q({ definition: o.definition })]);
      return a(l);
    } else if (o instanceof _e) {
      const l = [
        new me({ definition: o.definition }),
        new q({ definition: [new K({ terminalType: o.separator })].concat(o.definition) }),
      ];
      return a(l);
      ...
      if (o instanceof K) n.push(o.terminalType);
      else throw Error("non exhaustive match");
    }
    i++;
  }
  return (r.push({ partialPath: n, suffixDef: ne(t, i) }), r);
}
function hh(t, e, n, r) {
  ...
  const l = e.length,
    ...
    c = [],
    f = [];
  for (f.push({ idx: -1, def: t, ruleStack: [], occurrenceStack: [] }); !U(f); ) {
    const d = f.pop();
    if (d === a) {
      o && Ln(f).idx <= u && f.pop();
      continue;
    ...
    const y = h[0];
    if (y === i) {
      const R = { idx: m, def: ne(h), ruleStack: Gr(g), occurrenceStack: Gr(v) };
      f.push(R);
      ...
      if (m < l - 1) {
        const R = m + 1,
          $ = e[R];
        if (n($, y.terminalType)) {
          const S = { idx: R, def: ne(h), ruleStack: g, occurrenceStack: v };
          f.push(S);
        }
      } else if (m === l - 1)
        (c.push({
      ...
      const $ = ae(v);
      $.push(y.idx);
      const S = { idx: m, def: y.definition.concat(s, ne(h)), ruleStack: R, occurrenceStack: $ };
      f.push(S);
    } else if (y instanceof se) {
      const R = { idx: m, def: ne(h), ruleStack: g, occurrenceStack: v };
      (f.push(R), f.push(a));
      const $ = { idx: m, def: y.definition.concat(ne(h)), ruleStack: g, occurrenceStack: v };
      f.push($);
    } else if (y instanceof xe) {
      const R = new q({ definition: y.definition, idx: y.idx }),
        $ = y.definition.concat([R], ne(h)),
        S = { idx: m, def: $, ruleStack: g, occurrenceStack: v };
      f.push(S);
    } else if (y instanceof _e) {
      const R = new K({ terminalType: y.separator }),
        $ = new q({ definition: [R].concat(y.definition), idx: y.idx }),
        S = y.definition.concat([$], ne(h)),
        O = { idx: m, def: S, ruleStack: g, occurrenceStack: v };
      f.push(O);
    } else if (y instanceof ye) {
      const R = { idx: m, def: ne(h), ruleStack: g, occurrenceStack: v };
      (f.push(R), f.push(a));
      const $ = new K({ terminalType: y.separator }),
        S = new q({ definition: [$].concat(y.definition), idx: y.idx }),
        O = y.definition.concat([S], ne(h)),
        oe = { idx: m, def: O, ruleStack: g, occurrenceStack: v };
      f.push(oe);
    } else if (y instanceof q) {
      const R = { idx: m, def: ne(h), ruleStack: g, occurrenceStack: v };
      (f.push(R), f.push(a));
      const $ = new q({ definition: y.definition, idx: y.idx }),
        S = y.definition.concat([$], ne(h)),
        O = { idx: m, def: S, ruleStack: g, occurrenceStack: v };
      f.push(O);
    } else if (y instanceof Te)
      for (let R = y.definition.length - 1; R >= 0; R--) {
        const $ = y.definition[R],
          S = { idx: m, def: $.definition.concat(ne(h)), ruleStack: g, occurrenceStack: v };
        (f.push(S), f.push(a));
      }
    else if (y instanceof me)
      f.push({ idx: m, def: y.definition.concat(ne(h)), ruleStack: g, occurrenceStack: v });
    else if (y instanceof jn) f.push(N_(y, m, g, v));
    else throw Error("non exhaustive match");
  }
  return c;
}
...
function dl(t) {
  if (t instanceof se || t === "Option") return W.OPTION;
  if (t instanceof q || t === "Repetition") return W.REPETITION;
  if (t instanceof xe || t === "RepetitionMandatory") return W.REPETITION_MANDATORY;
  if (t instanceof _e || t === "RepetitionMandatoryWithSeparator")
    return W.REPETITION_MANDATORY_WITH_SEPARATOR;
  if (t instanceof ye || t === "RepetitionWithSeparator") return W.REPETITION_WITH_SEPARATOR;
  if (t instanceof Te || t === "Alternation") return W.ALTERNATION;
  throw Error("non exhaustive match");
}
function Zu(t) {
  ...
  if (s && !r) {
    const a = I(t, (l) => Ge(l)),
      o = Se(
        ...
        (l, u, c) => (
          k(u, (f) => {
            (w(l, f.tokenTypeIdx) || (l[f.tokenTypeIdx] = c),
              k(f.categoryMatches, (d) => {
                w(l, d) || (l[d] = c);
              }));
          }),
          l
...
class M_ extends Ws {
  ...
  checkIsTarget(e, n, r, i) {
    return e.idx === this.targetOccurrence && this.targetProdType === n
  ...
  for (let a = 1; a <= e; a++) {
    ...
    for (let l = 0; l < o.length; l++) {
      ...
      for (let c = 0; c < u.length; c++) {
        const f = u[c].partialPath,
          d = u[c].suffixDef,
          h = Ta(f);
        if (D_(i, h, l) || U(d) || f.length === e) {
          const g = r[l];
          if (ro(g, f) === !1) {
            g.push(f);
...
function Ys(t, e, n, r) {
  ...
  e.accept(i);
  const s = i.result,
    o = new M_(e, t, n).startWalking(),
    l = new me({ definition: s }),
...
function G_(t) {
  ...
  return I(e, (n) => Object.assign({ type: de.CUSTOM_LOOKAHEAD_VALIDATION }, n));
}
function U_(t, e, n, r) {
  const i = ke(t, (l) => B_(l, n)),
    s = Q_(t, e, n),
    a = ke(t, (l) => Y_(l, n)),
    o = ke(t, (l) => H_(l, t, r, n));
...
function B_(t, e) {
  ...
  return I(Z(s), (o) => {
    const l = Be(o),
      u = e.buildDuplicateFoundError(t, o),
      c = We(l),
      f = {
        message: u,
...
function H_(t, e, n, r) {
  const i = [];
  if (Se(e, (a, o) => (o.name === t.name ? a + 1 : a), 0) > 1) {
    const a = r.buildDuplicateRuleNameError({ topLevelRule: t, grammarName: n });
    i.push({ message: a, type: de.DUPLICATE_RULE_NAME, ruleName: t.name });
  }
  return i;
}
function W_(t, e, n) {
  ...
  return (
    ge(e, t) ||
      ...
      r.push({ message: i, type: de.INVALID_RULE_OVERRIDE, ruleName: t })),
    r
  );
}
function Th(t, e, n, r = []) {
...
function Pi(t) {
  ...
  if (U(t)) return e;
  const n = Be(t);
  if (n instanceof fe) e.push(n.referencedRule);
  else if (
    n instanceof me ||
    n instanceof se ||
    n instanceof xe ||
    ...
    e = e.concat(Pi(n.definition));
  else if (n instanceof Te) e = Ge(I(n.definition, (s) => Pi(s.definition)));
  else if (!(n instanceof K)) throw Error("non exhaustive match");
  const r = es(n),
    i = t.length > 1;
  if (r && i) {
    const s = ne(t);
    return e.concat(Pi(s));
  } else return e;
}
class hl extends Kn {
  constructor() {
...
function V_(t, e, n) {
  ...
  return (
    (i = Ps(i, (a) => a.ignoreAmbiguities === !0)),
    ke(i, (a) => {
      const o = a.idx,
        l = a.maxLookahead || e,
        u = qs(o, t, l, a),
    ...
    k(t, (i) => {
      ...
      k(a, (o) => {
        ...
        if (U(Ge(d))) {
          ...
          r.push({ message: h, type: de.NO_NON_EMPTY_LOOKAHEAD, ruleName: i.name });
        }
      });
    }),
    r
      ...
      (o, l, u) => (
        e.definition[u].ignoreAmbiguities === !0 ||
          k(l, (c) => {
            const f = [u];
            (k(t, (d, h) => {
              u !== h && ro(d, c) && e.definition[h].ignoreAmbiguities !== !0 && f.push(h);
            }),
              f.length > 1 && !ro(i, c) && (i.push(c), o.push({ alts: f, path: c })));
          }),
        o
      ),
      []
  ...
  return Xr(
    ke(i, (a) => {
      ...
      const l = a.idx,
        ...
        c = Le(
          i,
          (d) => e.definition[d.idx].ignoreAmbiguities !== !0 && d.idx < l && F_(d.path, u)
        );
      return I(c, (d) => {
        const h = [d.idx + 1, l + 1],
          m = e.idx === 0 ? "" : e.idx;
  ...
  return (
    k(t, (s) => {
      ...
      if (ge(i, a)) {
        ...
        r.push({ message: o, type: de.CONFLICT_TOKENS_RULES_NAMESPACE, ruleName: a });
      }
    }),
    r
  );
...
function eI(t) {
  const e = tl(t, { errMsgProvider: S_ }),
    n = {};
  return (
    k(t.rules, (r) => {
      n[r.name] = r;
    }),
    x_(n, e.errMsgProvider)
  );
}
function tI(t) {
  return (
    (t = tl(t, { errMsgProvider: Kt })),
    U_(t.rules, t.tokenTypes, t.errMsgProvider, t.grammarName)
  );
}
const vh = "MismatchedTokenException",
  $h = "NoViableAltException",
  Rh = "EarlyExitException",
  Ah = "NotAllInputParsedException",
  Eh = [vh, $h, Rh, Ah];
Object.freeze(Eh);
function rs(t) {
  return ge(Eh, t.name);
...
class aI {
  initRecoverable(e) {
    ((this.firstAfterRepMap = {}),
      (this.resyncFollows = {}),
      (this.recoveryEnabled = w(e, "recoveryEnabled") ? e.recoveryEnabled : dt.recoveryEnabled),
      this.recoveryEnabled && (this.attemptInRepetitionRecovery = oI));
  }
  getTokenToInsert(e) {
  ...
  tryInRepetitionRecovery(e, n, r, i) {
    ...
    for (; !l; )
      if (this.tokenMatcher(c, i)) {
        ...
        this.tokenMatcher(c, s)
          ? (l = !0)
          : ((c = this.SKIP_TOKEN()), this.addToResyncTokens(c, o));
  ...
  tryInRuleRecovery(e, n) {
    ...
    throw new sI("sad sad panda");
  }
  canPerformInRuleRecovery(e, n) {
    return (
      this.canRecoverWithSingleTokenInsertion(e, n) || this.canRecoverWithSingleTokenDeletion(e)
    );
  }
  canRecoverWithSingleTokenInsertion(e, n) {
    if (!this.canTokenTypeBeInsertedInRecovery(e) || U(n)) return !1;
    const r = this.LA(1);
  ...
  getCurrFollowKey() {
    if (this.RULE_STACK.length === 1) return va;
  ...
  addToResyncTokens(e, n) {
    return (this.tokenMatcher(e, It) || n.push(e), n);
  }
  reSyncTo(e) {
    const n = [];
    let r = this.LA(1);
  ...
  getCurrentGrammarPath(e, n) {
    const r = this.getHumanReadableRuleStack(),
      i = ae(this.RULE_OCCURRENCE_STACK);
...
function oI(t, e, n, r, i, s, a) {
  ...
  (this.RULE_STACK.length === 1 && f && u === void 0 && ((u = It), (c = 1)),
    !(u === void 0 || c === void 0) &&
      this.shouldInRepetitionRecoveryBeTried(u, c, a) &&
      this.tryInRepetitionRecovery(t, e, n, u));
}
const lI = 4,
  bt = 8,
  _h = 1 << bt,
...
class pl {
  ...
  validateEmptyOrAlternatives(e) {
    return ke(e, (n) => z_(n, Kt));
  }
  validateAmbiguousAlternationAlternatives(e, n) {
    return ke(e, (r) => V_(r, n, Kt));
  }
  ...
  buildLookaheadForOptional(e) {
    return O_(e.prodOccurrence, e.rule, e.maxLookahead, e.dynamicTokensEnabled, dl(e.prodType), L_);
  }
}
class uI {
  initLooksAhead(e) {
    ((this.dynamicTokensEnabled = w(e, "dynamicTokensEnabled")
      ? e.dynamicTokensEnabled
      : dt.dynamicTokensEnabled),
      (this.maxLookahead = w(e, "maxLookahead") ? e.maxLookahead : dt.maxLookahead),
      (this.lookaheadStrategy = w(e, "lookaheadStrategy")
        ? e.lookaheadStrategy
        : new pl({ maxLookahead: this.maxLookahead })),
        ...
        (k(r, (u) => {
          ...
          this.TRACE_INIT(`${We(u)}${c}`, () => {
            const f = this.lookaheadStrategy.buildLookaheadForAlternation({
              ...
              d = $a(this.fullRuleNameToShort[n.name], _h, u.idx);
...
const pI = "name";
function wh(t, e) {
  Object.defineProperty(t, pI, { enumerable: !1, configurable: !0, writable: !1, value: e });
}
function mI(t, e) {
  const n = Pe(t),
    r = n.length;
...
function gI(t, e) {
  ...
  const r = {
    visit: function (i, s) {
      if ((M(i) && (i = i[0]), !ct(i))) return this[i.name](i.children, s);
    },
...
class $I {
  initTreeBuilder(e) {
    if (
      ...
      (this.nodeLocationTracking = w(e, "nodeLocationTracking")
        ? e.nodeLocationTracking
        : dt.nodeLocationTracking),
      !this.outputCst)
    )
      ...
      this.recoveryEnabled
        ? ((this.setNodeLocationFromToken = tc),
          (this.setNodeLocationFromNode = tc),
          (this.cstPostRule = J),
      ...
      this.recoveryEnabled
        ? ((this.setNodeLocationFromToken = ec),
          (this.setNodeLocationFromNode = ec),
          (this.cstPostRule = J),
  ...
  cstPostTerminal(e, n) {
    ...
    (dI(r, n, e), this.setNodeLocationFromToken(r.location, n));
  }
  cstPostNonTerminal(e, n) {
    const r = this.CST_STACK[this.CST_STACK.length - 1];
    (hI(r, n, e), this.setNodeLocationFromNode(r.location, e.location));
  }
  getBaseCstVisitorConstructor() {
    if (ct(this.baseCstVisitorConstructor)) {
      const e = gI(this.className, Pe(this.gastProductionsCache));
...
class AI {
  ...
  RULE(e, n, r = as) {
    if (ge(this.definedRulesNames, e)) {
      const a = {
        message: Kt.buildDuplicateRuleNameError({ topLevelRule: e, grammarName: this.className }),
  ...
  OVERRIDE_RULE(e, n, r = as) {
    const i = W_(e, this.definedRulesNames, this.className);
  ...
  getSerializedGastProductions() {
    return Nx(Z(this.gastProductionsCache));
  }
}
class EI {
  initRecognizerEngine(e, n) {
    ...
    if (M(e)) this.tokensMap = Se(e, (s, a) => ((s[a.name] = a), s), {});
    else if (w(e, "modes") && qe(Ge(Z(e.modes)), R_)) {
      const s = Ge(Z(e.modes)),
        a = nl(s);
      this.tokensMap = Se(a, (o, l) => ((o[l.name] = l), o), {});
    } else if (Oe(e)) this.tokensMap = ae(e);
    else
      throw new Error(
    ...
    const r = w(e, "modes") ? Ge(Z(e.modes)) : Z(e),
      i = qe(r, (s) => U(s.categoryMatches));
...
Make sure that all grammar rule definitions are done before 'performSelfAnalysis' is called.`);
    const i = w(r, "resyncEnabled") ? r.resyncEnabled : as.resyncEnabled,
      s = w(r, "recoveryValueFunc") ? r.recoveryValueFunc : as.recoveryValueFunc,
      a = this.ruleShortNameIdx << (lI + bt);
  ...
  atLeastOneInternalLogic(e, n, r) {
    ...
    } else throw this.raiseEarlyExitException(e, W.REPETITION_MANDATORY, n.ERR_MSG);
    this.attemptInRepetitionRecovery(this.atLeastOneInternal, [e, n], i, so, e, k_);
  }
  ...
  atLeastOneSepFirstInternalLogic(e, n, r) {
    ...
    } else throw this.raiseEarlyExitException(e, W.REPETITION_MANDATORY_WITH_SEPARATOR, n.ERR_MSG);
  }
  manyInternal(e, n) {
  ...
  manyInternalLogic(e, n, r) {
    ...
    let a = !0;
    for (; i.call(this) === !0 && a === !0; ) a = this.doSingleRepetition(s);
    this.attemptInRepetitionRecovery(this.manyInternal, [e, n], i, io, e, C_, a);
  }
  ...
  orInternal(e, n) {
    const r = this.getKeyForAutomaticLookahead(_h, n),
      i = M(e) ? e : e.DEF,
...
class SI {
  initErrorHandler(e) {
    ((this._errors = []),
      (this.errorMessageProvider = w(e, "errorMessageProvider")
        ? e.errorMessageProvider
        : dt.errorMessageProvider));
  }
  SAVE_ERROR(e) {
    if (rs(e))
      return (
  ...
  raiseEarlyExitException(e, n, r) {
    const i = this.getCurrRuleFullName(),
      ...
      o = Ys(e, s, n, this.maxLookahead)[0],
      l = [];
  ...
  raiseNoAltException(e, n) {
    ...
    throw this.SAVE_ERROR(new nI(l, this.LA(1), o));
  }
}
class xI {
  initContentAssist() {}
  computeContentAssist(e, n) {
    ...
    if (ct(r)) throw Error(`Rule ->${e}<- does not exist in this grammar.`);
    return hh([r], n, this.tokenMatcher, this.maxLookahead);
  }
  getNextPossibleTokenTypes(e) {
    const n = Be(e.ruleStack),
      i = this.getGAstProductions()[n];
    return new w_(i, e).startWalking();
  }
}
const Js = { description: "This Object indicates the Parser is during Recording Phase" };
Object.freeze(Js);
const nc = !0,
  rc = Math.pow(2, bt) - 1,
  Ch = fh({ name: "RECORDING_PHASE_TOKEN", pattern: he.NA });
ti([Ch]);
const kh = fl(
  Ch,
...
class II {
  ...
  orInternalRecord(e, n) {
    return wI.call(this, e, n);
  }
  subruleInternalRecord(e, n, r) {
    if ((is(n), !e || w(e, "ruleName") === !1)) {
      const o =
        new Error(`<SUBRULE${ic(n)}> argument is invalid expecting a Parser method reference but got: <${JSON.stringify(e)}>
 inside top level rule: <${this.recordingProdStack[0].name}>`);
      throw ((o.KNOWN_RECORDER_ERROR = !0), o);
    }
    const i = Ln(this.recordingProdStack),
      s = e.ruleName,
      a = new fe({ idx: n, nonTerminalName: s, label: r?.LABEL, referencedRule: void 0 });
    return (i.definition.push(a), this.outputCst ? _I : Js);
  }
  consumeInternalRecord(e, n, r) {
    if ((is(n), !uh(e))) {
      const a =
        new Error(`<CONSUME${ic(n)}> argument is invalid expecting a TokenType reference but got: <${JSON.stringify(e)}>
 inside top level rule: <${this.recordingProdStack[0].name}>`);
      throw ((a.KNOWN_RECORDER_ERROR = !0), a);
    }
    const i = Ln(this.recordingProdStack),
      s = new K({ idx: n, terminalType: e, label: r?.LABEL });
...
function qn(t, e, n, r = !1) {
  ...
  return (
    r && (a.separator = e.SEP),
    w(e, "MAX_LOOKAHEAD") && (a.maxLookahead = e.MAX_LOOKAHEAD),
...
function wI(t, e) {
  is(e);
  const n = Ln(this.recordingProdStack),
    r = M(t) === !1,
    i = r === !1 ? t : t.DEF,
    s = new Te({ definition: [], idx: e, ignoreAmbiguities: r && t.IGNORE_AMBIGUITIES === !0 });
  w(t, "MAX_LOOKAHEAD") && (s.maxLookahead = t.MAX_LOOKAHEAD);
  const a = pR(i, (o) => ht(o.GATE));
  return (
    (s.hasPredicates = a),
    n.definition.push(s),
    k(i, (o) => {
      ...
      (s.definition.push(l),
        w(o, "IGNORE_AMBIGUITIES")
          ? (l.ignoreAmbiguities = o.IGNORE_AMBIGUITIES)
          : w(o, "GATE") && (l.ignoreAmbiguities = !0),
...
class CI {
  initPerformanceTracer(e) {
    if (w(e, "traceInitPerf")) {
      const n = e.traceInitPerf,
        r = typeof n == "number";
      ((this.traceInitMaxIdent = r ? n : 1 / 0), (this.traceInitPerf = r ? n > 0 : n));
    } else ((this.traceInitMaxIdent = 0), (this.traceInitPerf = dt.traceInitPerf));
    this.traceInitIndent = -1;
  }
  TRACE_INIT(e, n) {
    if (this.traceInitPerf === !0) {
...
const ss = fl(It, "", NaN, NaN, NaN, NaN, NaN, NaN);
Object.freeze(ss);
const dt = Object.freeze({
  ...
  as = Object.freeze({ recoveryValueFunc: () => {}, resyncEnabled: !0 });
var de;
(function (t) {
    ...
    this.TRACE_INIT("performSelfAnalysis", () => {
      ...
      if (
        (this.TRACE_INIT("Grammar Resolving", () => {
          ((r = eI({ rules: Z(this.gastProductionsCache) })),
        ...
        U(this.definitionErrors) &&
          (this.recoveryEnabled &&
            this.TRACE_INIT("computeAllProdsFollows", () => {
              const i = Fx(Z(this.gastProductionsCache));
          ...
          this.TRACE_INIT("ComputeLookaheadFunctions", () => {
            ...
            ((s = (i = this.lookaheadStrategy).initialize) === null ||
              s === void 0 ||
              s.call(i, { rules: Z(this.gastProductionsCache) }),
...
`)}`)
  ...
  constructor(e, n) {
	...
	For further details.`);
    this.skipValidations = w(n, "skipValidations") ? n.skipValidations : dt.skipValidations;
  }
}
ni.DEFER_DEFINITION_ERRORS_HANDLING = !1;
kI(ni, [aI, uI, $I, RI, EI, AI, SI, xI, II, CI]);
class NI extends ni {
  constructor(e, n = dt) {
    const r = ae(n);
...
function UI(t, e, n) {
  ...
  Ot(t, r);
  const i = Hn(t, e, r, n, an(t, e, n)),
    s = Tl(t, e, n.separator, n);
  return Dh(t, e, n, i, s);
}
function BI(t, e, n) {
  const r = ee(t, e, n, { type: Nh });
  Ot(t, r);
  const i = Hn(t, e, r, n, an(t, e, n));
  return Mh(t, e, n, i);
}
...
function an(t, e, n) {
  const r = Lp(
    ot(n.definition, (i) => Lh(t, e, i)),
    (i) => i !== void 0
  );
  return r.length === 1 ? r[0] : r.length === 0 ? void 0 : VI(t, r);
}
function Mh(t, e, n, r, i) {
  const s = r.left,
    ...
    o = ee(t, e, n, { type: MI });
  Ot(t, o);
  const l = ee(t, e, n, { type: Oh });
  return (
    (s.loopback = o),
    (l.loopback = o),
    (t.decisionMap[Dn(e, i ? "RepetitionMandatoryWithSeparator" : "RepetitionMandatory", n.idx)] =
      o),
    X(a, o),
    i === void 0 ? (X(o, s), X(o, l)) : (X(o, l), X(o, i.left), X(i.right, s)),
    { left: s, right: l }
  );
}
function Dh(t, e, n, r, i) {
  ...
  return (
    ...
    X(o, l),
    X(a, u),
    i !== void 0 ? (X(u, l), X(u, i.left), X(i.right, s)) : X(u, o),
    (t.decisionMap[Dn(e, i ? "RepetitionWithSeparator" : "Repetition", n.idx)] = o),
    { left: o, right: l }
  );
}
function WI(t, e, n, r) {
...
function Hn(t, e, n, r, ...i) {
  const s = ee(t, e, r, { type: OI, start: n });
  n.end = s;
  for (const o of i) o !== void 0 ? (X(n, o.left), X(o.right, s)) : X(n, s);
  const a = { left: n, right: s };
  return ((t.decisionMap[Dn(e, zI(r), r.idx)] = n), a);
}
function zI(t) {
  if (t instanceof Te) return "Alternation";
  if (t instanceof se) return "Option";
  if (t instanceof q) return "Repetition";
  if (t instanceof ye) return "RepetitionWithSeparator";
  if (t instanceof xe) return "RepetitionMandatory";
  if (t instanceof _e) return "RepetitionMandatoryWithSeparator";
...
function VI(t, e) {
  ...
  for (let s = 0; s < n - 1; s++) {
    ...
    const l = o instanceof yl,
      u = o,
      c = e[s + 1].left;
    a.left.type === wt &&
    a.right.type === wt &&
    o !== void 0 &&
    ((l && u.followState === a.right) || o.target === a.right)
      ? (l ? (u.followState = c) : (o.target = c), XI(t, a.right))
      : X(a.right, c);
  }
  const r = e[0],
    i = e[n - 1];
...
function Tl(t, e, n, r) {
  const i = ee(t, e, r, { type: wt }),
    s = ee(t, e, r, { type: wt });
  return (vl(i, new gl(s, n)), { left: i, right: s });
}
function qI(t, e, n) {
...
function YI(t, e, n) {
  ...
  return (X(n.right, i), { left: r, right: i });
}
function X(t, e) {
  const n = new Ph(e);
  vl(t, n);
...
class ZI extends pl {
  constructor(e) {
    var n;
    (super(),
      (this.logging = (n = e?.logging) !== null && n !== void 0 ? n : (r) => console.log(r)));
  }
  initialize(e) {
    ((this.atn = DI(e.rules)), (this.dfas = QI(this.atn)));
  }
  ...
  buildLookaheadForAlternation(e) {
    const { prodOccurrence: n, rule: r, hasPredicates: i, dynamicTokensEnabled: s } = e,
      a = this.dfas,
      o = this.logging,
      l = Dn(r, "Alternation", n),
      c = this.atn.decisionMap[l].decision,
      f = ot(Zu({ maxLookahead: 1, occurrence: n, prodType: "Alternation", rule: r }), (d) =>
        ot(d, (h) => h[0])
      );
    if (oc(f, !1) && !s) {
      const d = Il(
  ...
  buildLookaheadForOptional(e) {
    const { prodOccurrence: n, rule: r, prodType: i, dynamicTokensEnabled: s } = e,
      ...
      l = Dn(r, i, n),
      c = this.atn.decisionMap[l].decision,
      f = ot(Zu({ maxLookahead: 1, occurrence: n, prodType: i, rule: r }), (d) =>
        ot(d, (h) => h[0])
      );
    if (oc(f) && f[0][0] && !s) {
      const d = f[0],
        h = kp(d);
      if (h.length === 1 && Cp(h[0].categoryMatches)) {
...
function QI(t) {
  const e = t.decisionStates.length,
    n = Array(e);
  for (let r = 0; r < e; r++) n[r] = JI(t.decisionStates[r], r);
  return n;
}
function Ra(t, e, n, r) {
  const i = t[e](n);
  let s = i.start;
  if (s === void 0) {
    const o = cw(i.atnStartState);
    ((s = Bh(i, Uh(o))), (i.start = s));
  }
  return ew.apply(this, [i, s, n, r]);
}
function ew(t, e, n, r) {
  let i = e,
    s = 1;
  ...
  for (;;) {
    let l = aw(i, o);
    if ((l === void 0 && (l = tw.apply(this, [t, i, o, s, n, r])), l === os)) return sw(a, i, o);
    if (l.isAcceptState === !0) return l.prediction;
    ((i = l), a.push(o), (o = this.LA(s++)));
  }
}
function tw(t, e, n, r, i, s) {
  const a = ow(e.configs, n, i);
  if (a.size === 0) return (lc(t, e, n, os), os);
  let o = Uh(a);
  const l = uw(a, i);
...
function nw(t, e, n, r) {
  ...
  const s = t.atnStartState,
    a = s.rule,
    o = s.production,
    l = rw({ topLevelRule: a, ambiguityIndices: n, production: o, prefixPath: i });
  r(l);
}
function rw(t) {
  const e = ot(t.prefixPath, (i) => mn(i)).join(", "),
    n = t.production.idx === 0 ? "" : t.production.idx;
  let r = `Ambiguous Alternatives Detected: <${t.ambiguityIndices.join(", ")}> in <${iw(t.production)}${n}> inside <${t.topLevelRule.name}> Rule,
<${e}> may appears as a prefix path in all these alternatives.
`;
  return (
    (r =
...
function sw(t, e, n) {
  const r = Mp(e.configs.elements, (s) => s.state.transitions),
    i = Dp(
      r.filter((s) => s instanceof gl).map((s) => s.tokenType),
      (s) => s.tokenTypeIdx
    );
  ...
  for (const a of t.elements) {
    ...
    for (let l = 0; l < o; l++) {
      const u = a.state.transitions[l],
        c = lw(u, e);
      c !== void 0 && r.add({ state: c, alt: a.alt, stack: a.stack });
    }
  }
  let s;
  if ((i.length === 0 && r.size === 1 && (s = r), s === void 0)) {
    s = new lo();
    for (const a of r.elements) ls(a, s);
  }
  if (i.length > 0 && !dw(s)) for (const a of i) s.add(a);
  return s;
}
function lw(t, e) {
  if (t instanceof gl && dh(e, t.tokenType)) return t.target;
}
function uw(t, e) {
  let n;
...
function fw(t, e) {
  if (e instanceof Ph) return { state: e.target, alt: t.alt, stack: t.stack };
  if (e instanceof yl) {
...
function dw(t) {
  for (const e of t.elements) if (e.state.type === ri) return !0;
  return !1;
}
function hw(t) {
  for (const e of t.elements) if (e.state.type !== ri) return !1;
  return !0;
}
function pw(t) {
  if (hw(t)) return !0;
  const e = mw(t.elements);
  return gw(e) && !yw(e);
}
function mw(t) {
  const e = new Map();
...
(function (t) {
  function e(r, i) {
    return (
      r === Number.MAX_VALUE && (r = us.MAX_VALUE),
      i === Number.MAX_VALUE && (i = us.MAX_VALUE),
      { line: r, character: i }
    );
  }
  t.create = e;
...
(function (t) {
  function e(r, i, s, a) {
    ...
    if (D.is(r) && D.is(i)) return { start: r, end: i };
...
(function (t) {
  ...
  function n(r) {
    ...
    return (
      p.objectLiteral(i) &&
      L.is(i.targetRange) &&
      p.string(i.targetUri) &&
      L.is(i.targetSelectionRange) &&
      (L.is(i.originSelectionRange) || p.undefined(i.originSelectionRange))
    );
  }
  t.is = n;
})(fc || (fc = {}));
...
(function (t) {
  ...
  function n(r) {
    ...
    return (
      p.objectLiteral(i) &&
      p.numberRange(i.red, 0, 1) &&
      p.numberRange(i.green, 0, 1) &&
      p.numberRange(i.blue, 0, 1) &&
      p.numberRange(i.alpha, 0, 1)
    );
  }
  t.is = n;
})(co || (co = {}));
...
(function (t) {
  ...
  function n(r) {
    const i = r;
    return p.objectLiteral(i) && L.is(i.range) && co.is(i.color);
  }
  t.is = n;
})(dc || (dc = {}));
var hc;
(function (t) {
  ...
  function n(r) {
    ...
    return (
      p.objectLiteral(i) &&
      p.string(i.label) &&
      (p.undefined(i.textEdit) || Gn.is(i)) &&
      (p.undefined(i.additionalTextEdits) || p.typedArray(i.additionalTextEdits, Gn.is))
    );
  }
  t.is = n;
})(hc || (hc = {}));
...
(function (t) {
  function e(r, i, s, a, o, l) {
    ...
    return (
      p.defined(s) && (u.startCharacter = s),
      p.defined(a) && (u.endCharacter = a),
      p.defined(o) && (u.kind = o),
      p.defined(l) && (u.collapsedText = l),
      u
    );
  }
  t.create = e;
  function n(r) {
    ...
    return (
      p.objectLiteral(i) &&
      p.uinteger(i.startLine) &&
      p.uinteger(i.startLine) &&
      (p.undefined(i.startCharacter) || p.uinteger(i.startCharacter)) &&
      (p.undefined(i.endCharacter) || p.uinteger(i.endCharacter)) &&
      (p.undefined(i.kind) || p.string(i.kind))
    );
  }
  t.is = n;
})(mc || (mc = {}));
...
(function (t) {
  function e(r, i, s, a, o, l) {
    ...
    return (
      p.defined(s) && (u.severity = s),
      p.defined(a) && (u.code = a),
      p.defined(o) && (u.source = o),
      p.defined(l) && (u.relatedInformation = l),
      u
    );
  }
  t.create = e;
  function n(r) {
    ...
    return (
      ...
      L.is(s.range) &&
      p.string(s.message) &&
      (p.number(s.severity) || p.undefined(s.severity)) &&
      (p.integer(s.code) || p.string(s.code) || p.undefined(s.code)) &&
      (p.undefined(s.codeDescription) ||
        p.string((i = s.codeDescription) === null || i === void 0 ? void 0 : i.href)) &&
      (p.string(s.source) || p.undefined(s.source)) &&
      (p.undefined(s.relatedInformation) || p.typedArray(s.relatedInformation, fo.is))
    );
  }
  t.is = n;
})(fs || (fs = {}));
...
(function (t) {
  ...
  function n(r) {
    ...
    return (
      p.objectLiteral(i) &&
      p.string(i.label) &&
      (p.boolean(i.needsConfirmation) || i.needsConfirmation === void 0) &&
      (p.string(i.description) || i.description === void 0)
    );
  }
  t.is = n;
})(ho || (ho = {}));
...
(function (t) {
  ...
  function n(r) {
    ...
    return (
      ...
      p.string(i.uri) &&
      (i.options === void 0 ||
        ((i.options.overwrite === void 0 || p.boolean(i.options.overwrite)) &&
          (i.options.ignoreIfExists === void 0 || p.boolean(i.options.ignoreIfExists)))) &&
      (i.annotationId === void 0 || Un.is(i.annotationId))
    );
  }
  t.is = n;
})(mo || (mo = {}));
...
(function (t) {
  ...
  function n(r) {
    ...
    return (
      ...
      p.string(i.uri) &&
      (i.options === void 0 ||
        ((i.options.recursive === void 0 || p.boolean(i.options.recursive)) &&
          (i.options.ignoreIfNotExists === void 0 || p.boolean(i.options.ignoreIfNotExists)))) &&
      (i.annotationId === void 0 || Un.is(i.annotationId))
    );
  }
  t.is = n;
    ...
    return (
      ...
      (r.documentChanges === void 0 ||
        r.documentChanges.every((i) =>
          p.string(i.kind) ? mo.is(i) || go.is(i) || yo.is(i) : po.is(i)
        ))
    );
  }
  t.is = e;
...
(function (t) {
  function e(n) {
    ...
    return (
      r &&
      (p.string(r.detail) || r.detail === void 0) &&
      (p.string(r.description) || r.description === void 0)
    );
  }
  t.is = e;
})(wc || (wc = {}));
...
(function (t) {
  function e(n) {
    ...
    return (
      !!r &&
      p.objectLiteral(r) &&
      (jr.is(r.contents) || ds.is(r.contents) || p.typedArray(r.contents, ds.is)) &&
      (n.range === void 0 || L.is(n.range))
    );
  }
  t.is = e;
})(Nc || (Nc = {}));
...
(function (t) {
  function e(n, r, ...i) {
    let s = { label: n };
    return (
      p.defined(r) && (s.documentation = r),
      p.defined(i) ? (s.parameters = i) : (s.parameters = []),
      s
    );
  }
  t.create = e;
...
(function (t) {
  ...
  function n(r) {
    ...
    return (
      ...
      p.number(i.kind) &&
      L.is(i.range) &&
      L.is(i.selectionRange) &&
      (i.detail === void 0 || p.string(i.detail)) &&
      (i.deprecated === void 0 || p.boolean(i.deprecated)) &&
...
(function (t) {
  ...
  function n(r) {
    ...
    return (
      p.defined(i) &&
      p.typedArray(i.diagnostics, fs.is) &&
      (i.only === void 0 || p.typedArray(i.only, p.string)) &&
      (i.triggerKind === void 0 || i.triggerKind === hs.Invoked || i.triggerKind === hs.Automatic)
    );
  }
  t.is = n;
})(jc || (jc = {}));
...
(function (t) {
  function e(r, i, s) {
    let a = { title: r },
      o = !0;
    return (
      typeof i == "string" ? ((o = !1), (a.kind = i)) : Fn.is(i) ? (a.command = i) : (a.edit = i),
      o && s !== void 0 && (a.kind = s),
      a
    );
  }
  ...
  function n(r) {
    ...
    return (
      i &&
      p.string(i.title) &&
      (i.diagnostics === void 0 || p.typedArray(i.diagnostics, fs.is)) &&
      (i.kind === void 0 || p.string(i.kind)) &&
      (i.edit !== void 0 || i.command !== void 0) &&
      (i.command === void 0 || Fn.is(i.command)) &&
      (i.isPreferred === void 0 || p.boolean(i.isPreferred)) &&
      (i.edit === void 0 || To.is(i.edit))
    );
  }
  t.is = n;
})(Kc || (Kc = {}));
...
(function (t) {
  ...
  function n(r) {
    let i = r;
    return p.defined(i) && L.is(i.range) && (p.undefined(i.command) || Fn.is(i.command));
  }
  t.is = n;
})(Hc || (Hc = {}));
var Wc;
...
(function (t) {
  ...
  function n(r) {
    ...
    return (
      i != null &&
      L.is(i.range) &&
      p.boolean(i.caseSensitiveLookup) &&
      (p.string(i.variableName) || i.variableName === void 0)
    );
  }
  t.is = n;
})(Zc || (Zc = {}));
...
(function (t) {
  ...
  function n(r) {
    ...
    return (
      p.objectLiteral(i) &&
      (i.tooltip === void 0 || p.string(i.tooltip) || jr.is(i.tooltip)) &&
      (i.location === void 0 || cs.is(i.location)) &&
      (i.command === void 0 || Fn.is(i.command))
    );
  }
  t.is = n;
...
(function (t) {
  ...
  function n(r) {
    ...
    return (
      (p.objectLiteral(i) &&
        D.is(i.position) &&
        (p.string(i.label) || p.typedArray(i.label, Ao.is)) &&
        (i.kind === void 0 || Ro.is(i.kind)) &&
        i.textEdits === void 0) ||
      (p.typedArray(i.textEdits, Gn.is) &&
        (i.tooltip === void 0 || p.string(i.tooltip) || jr.is(i.tooltip)) &&
        (i.paddingLeft === void 0 || p.boolean(i.paddingLeft)) &&
        (i.paddingRight === void 0 || p.boolean(i.paddingRight)))
    );
  }
  t.is = n;
})(tf || (tf = {}));
...
(function (t) {
  ...
  function n(s) {
    ...
    return !!(
      p.defined(a) &&
      p.string(a.uri) &&
      (p.undefined(a.languageId) || p.string(a.languageId)) &&
      p.uinteger(a.lineCount) &&
      p.func(a.getText) &&
      p.func(a.positionAt) &&
      p.func(a.offsetAt)
    );
  ...
  function r(s, a) {
    ...
    for (let c = l.length - 1; c >= 0; c--) {
      ...
      if (h <= u) o = o.substring(0, d) + f.newText + o.substring(h, o.length);
...
class vw {
  ...
  get current() {
    var e;
    return (e = this.nodeStack[this.nodeStack.length - 1]) !== null && e !== void 0
      ? e
      : this.rootNode;
  }
  buildRootNode(e) {
    return (
      (this.rootNode = new Kh(e)),
...
class $l extends jh {
  ...
  get offset() {
    var e, n;
    return (n = (e = this.firstNonHiddenNode) === null || e === void 0 ? void 0 : e.offset) !==
      null && n !== void 0
      ? n
      : 0;
  }
  ...
  get end() {
    var e, n;
    return (n = (e = this.lastNonHiddenNode) === null || e === void 0 ? void 0 : e.end) !== null &&
      n !== void 0
      ? n
      : 0;
  }
...
const So = Symbol("Datatype");
function Aa(t) {
  return t.$type === So;
}
const ff = "​",
  Hh = (t) => (t.endsWith(ff) ? t : t + ff);
class Wh {
  constructor(e) {
...
class $w extends Wh {
  ...
  rule(e, n) {
    const r = this.computeRuleType(e),
      i = this.wrapper.DEFINE_RULE(Hh(e.name), this.startImplementation(r, n).bind(this));
  ...
  startImplementation(e, n) {
    return (r) => {
      ...
      if (i) {
        const a = { $type: e };
        (this.stack.push(a), e === So && (a.value = ""));
      }
      let s;
      try {
        s = n(r);
  ...
  construct() {
    ...
    return (
      ...
      this.stack.pop(),
      Aa(e) ? this.converter.convert(e.value, e.$cstNode) : (fm(this.astReflection, e), e)
    );
  }
  getAssignment(e) {
    if (!this.assignmentMap.has(e)) {
      const n = $s(e, Ht);
      this.assignmentMap.set(e, { assignment: n, isCrossRef: n ? No(n.terminal) : !1 });
    }
  ...
  assign(e, n, r, i, s) {
    ...
    let o;
    switch (
      (s && typeof r == "string" ? (o = this.linker.buildReference(a, n, i, r)) : (o = r), e)
    ) {
      case "=": {
        a[n] = o;
        break;
  ...
  assignWithoutOverride(e, n) {
    for (const [i, s] of Object.entries(n)) {
      ...
      a === void 0
        ? (e[i] = s)
        : Array.isArray(a) && Array.isArray(s) && (s.push(...a), (e[i] = s));
    }
    const r = e.$cstNode;
...
class Sw extends NI {
  constructor(e, n) {
    ...
    super(
      e,
      Object.assign(
        Object.assign(Object.assign({}, Ew), {
          lookaheadStrategy: r
            ? new pl({ maxLookahead: n.maxLookahead })
            : new ZI({ logging: n.skipValidations ? () => {} : void 0 }),
        }),
        n
      )
    );
...
function Vh(t, e, n) {
  return (xw({ parser: e, tokens: n, ruleNames: new Map() }, t), e);
}
function xw(t, e) {
  const n = qf(e, !1),
    r = ie(e.rules)
...
function Xt(t, e, n = !1) {
  let r;
  if (Wt(e)) r = bw(t, e);
  else if (vs(e)) r = _w(t, e);
  else if (Ht(e)) r = Xt(t, e.terminal);
  else if (No(e)) r = qh(t, e);
  else if (zt(e)) r = Iw(t, e);
  else if (jf(e)) r = Cw(t, e);
  else if (Kf(e)) r = kw(t, e);
  else if (bo(e)) r = Nw(t, e);
  else if (nm(e)) {
    const i = t.consume++;
    r = () => t.parser.consume(i, It, e);
  } else throw new Ff(e.$cstNode, `Unexpected element type: ${e.$type}`);
...
function Iw(t, e) {
  ...
  if (Ne(n)) {
    const r = t.subrule++,
      i = n.fragment,
      s = e.arguments.length > 0 ? ww(n, e.arguments) : () => ({});
  ...
  else throw new Ff(e.$cstNode, `Undefined rule: ${e.rule.$refText}`);
}
function ww(t, e) {
...
function Cw(t, e) {
  if (e.elements.length === 1) return Xt(t, e.elements[0]);
  {
    const n = [];
    for (const i of e.elements) {
      const s = { ALT: Xt(t, i, !0) },
        a = ps(i);
...
function ps(t) {
  if (bo(t)) return t.guardCondition;
}
function qh(t, e, n = e.terminal) {
  if (n)
    ...
    const r = Jf(e.type.ref),
      i = r?.terminal;
    if (!i) throw new Error("Could not find name assignment for type: " + Mo(e.type.ref));
    return qh(t, e, i);
  }
}
function bw(t, e) {
...
function Ow(t, e) {
  ...
  if (t.ruleNames.has(e)) return t.ruleNames.get(e);
  {
    let n = e,
      ...
      i = e.$type;
    for (; !Ne(r); )
      ((bo(r) || jf(r) || Kf(r)) && (i = r.elements.indexOf(n).toString() + ":" + i),
        (n = r),
        (r = r.$container));
...
class Jh {
  ...
  buildTerminalToken(e) {
    ...
    return (
      typeof r == "function" && (i.LINE_BREAKS = !0),
      e.hidden && (i.GROUP = Ba(n) ? he.SKIPPED : "hidden"),
      i
    );
  }
  ...
  buildKeywordTokens(e, n, r) {
    return e
      .filter(Ne)
      .flatMap((i) => Wr(i).filter(Wt))
      .distinct((i) => i.value)
      .toArray()
      .sort((i, s) => s.value.length - i.value.length)
      .map((i) => this.buildKeywordToken(i, n, !!r?.caseInsensitive));
  }
  ...
  buildKeywordPattern(e, n) {
    return n ? new RegExp($m(e.value)) : e.value;
  }
  findLongerAlt(e, n) {
    return n.reduce((r, i) => {
      const s = i?.PATTERN;
      return (s?.source && Rm("^" + s.source + "$", e.value) && r.push(i), r);
    }, []);
  }
}
class Zh {
  ...
  runConverter(e, n, r) {
    ...
    switch ((i = bm(e)) === null || i === void 0 ? void 0 : i.toLowerCase()) {
      case "number":
...
function ep() {
  ...
  return ((jt.Emitter = r), (r._noop = function () {}), jt);
}
var mf;
function Fw() {
  if (mf) return Bt;
  ((mf = 1),
    ...
    (Bt.CancellationTokenSource = Bt.CancellationToken = void 0));
  const t = Qh(),
    e = Dw(),
    n = ep();
  var r;
  (function (o) {
    ...
    function l(u) {
      ...
      return (
        ...
        (c === o.None ||
          c === o.Cancelled ||
          (e.boolean(c.isCancellationRequested) && !!c.onCancellationRequested))
      );
    }
    o.is = l;
...
const ms = Symbol("OperationCancelled");
function Zs(t) {
  return t === ms;
}
async function Ee(t) {
  if (t === z.CancellationToken.None) return;
  const e = performance.now();
  if ((e - Mi >= Uw && ((Mi = e), await Gw(), (Mi = performance.now())), t.isCancellationRequested))
    throw ms;
}
class Al {
  constructor() {
...
class Kr {
  ...
  update(e, n) {
    for (const r of e)
      if (Kr.isIncremental(r)) {
        ...
        this._content =
          this._content.substring(0, s) + r.text + this._content.substring(a, this._content.length);
        const o = Math.max(i.start.line, 0),
          l = Math.max(i.end.line, 0);
        let u = this._lineOffsets;
        const c = gf(r.text, !1, s);
        if (l - o === c.length) for (let d = 0, h = c.length; d < h; d++) u[d + o + 1] = c[d];
        else
          c.length < 1e4
            ? u.splice(o + 1, l - o, ...c)
            : (this._lineOffsets = u = u.slice(0, o + 1).concat(c, u.slice(l + 1)));
        const f = r.text.length - (a - s);
        if (f !== 0) for (let d = o + 1 + c.length, h = u.length; d < h; d++) u[d] = u[d] + f;
      } else if (Kr.isFull(r)) ((this._content = r.text), (this._lineOffsets = void 0));
      else throw new Error("Unknown change event received");
    this._version = n;
  }
  getLineOffsets() {
    return (
      this._lineOffsets === void 0 && (this._lineOffsets = gf(this._content, !0)),
      this._lineOffsets
    );
  }
  positionAt(e) {
  ...
  ensureBeforeEOL(e, n) {
    for (; e > n && tp(this._content.charCodeAt(e - 1)); ) e--;
    return e;
  }
  get lineCount() {
    return this.getLineOffsets().length;
...
(function (t) {
  ...
  t.create = e;
  function n(i, s, a) {
    if (i instanceof Kr) return (i.update(s, a), i);
            ...
            if (c === 47) {
              if (!(h === g - 1 || m === 1))
                if (h !== g - 1 && m === 2) {
                  if (
                    ...
                    if (f.length > 2) {
                      ...
                      if (v !== f.length - 1) {
                        (v === -1
                          ? ((f = ""), (d = 0))
                          : (d = (f = f.slice(0, v)).length - 1 - f.lastIndexOf("/")),
                          (h = g),
                          (m = 0));
                        continue;
                      }
                  ...
                  (f.length > 0 ? (f += "/" + l.slice(h + 1, g)) : (f = l.slice(h + 1, g)),
                    (d = g - h - 1));
              ((h = g), (m = 0));
            } else c === 46 && m !== -1 ? ++m : (m = -1);
          }
        ...
        var o = {
          resolve: function () {
            for (var l, u = "", c = !1, f = arguments.length - 1; f >= -1 && !c; f--) {
              ...
              (f >= 0 ? (d = arguments[f]) : (l === void 0 && (l = process.cwd()), (d = l)),
                s(d),
                d.length !== 0 && ((u = d + "/" + u), (c = d.charCodeAt(0) === 47)));
            }
          ...
          normalize: function (l) {
            ...
            var u = l.charCodeAt(0) === 47,
              c = l.charCodeAt(l.length - 1) === 47;
            return (
              (l = a(l, !u)).length !== 0 || u || (l = "."),
              l.length > 0 && c && (l += "/"),
              u ? "/" + l : l
            );
          },
          ...
          relative: function (l, u) {
            ...
            var $ = "";
            for (y = c + v + 1; y <= f; ++y)
              (y !== f && l.charCodeAt(y) !== 47) || ($.length === 0 ? ($ += "..") : ($ += "/.."));
            return $.length > 0
              ? $ + u.slice(h + v)
              : ((h += v), u.charCodeAt(h) === 47 && ++h, u.slice(h));
          },
          ...
          dirname: function (l) {
            if ((s(l), l.length === 0)) return ".";
            for (
              var u = l.charCodeAt(0), c = u === 47, f = -1, d = !0, h = l.length - 1;
              h >= 1;
              --h
            )
              if ((u = l.charCodeAt(h)) === 47) {
                if (!d) {
                  f = h;
                  break;
                }
            ...
            if (u !== void 0 && u.length > 0 && u.length <= l.length) {
              ...
              for (c = l.length - 1; c >= 0; --c) {
                ...
                if (v === 47) {
                  ...
                  (g === -1 && ((h = !1), (g = c + 1)),
                    m >= 0 && (v === u.charCodeAt(m) ? --m == -1 && (d = c) : ((m = -1), (d = g))));
              }
          ...
          extname: function (l) {
            ...
            for (var u = -1, c = 0, f = -1, d = !0, h = 0, m = l.length - 1; m >= 0; --m) {
              ...
              if (g !== 47)
                (f === -1 && ((d = !1), (f = m + 1)),
                  g === 46 ? (u === -1 ? (u = m) : h !== 1 && (h = 1)) : u !== -1 && (h = -1));
              else if (!d) {
                c = m + 1;
                break;
              }
            }
            return u === -1 || f === -1 || h === 0 || (h === 1 && u === f - 1 && u === c + 1)
              ? ""
              : l.slice(u, f);
          },
          format: function (l) {
          ...
          parse: function (l) {
            ...
            var c,
              ...
              d = f === 47;
            d ? ((u.root = "/"), (c = 1)) : (c = 0);
            for (var h = -1, m = 0, g = -1, v = !0, y = l.length - 1, R = 0; y >= c; --y)
              if ((f = l.charCodeAt(y)) !== 47)
                (g === -1 && ((v = !1), (g = y + 1)),
                  f === 46 ? (h === -1 ? (h = y) : R !== 1 && (R = 1)) : h !== -1 && (R = -1));
              else if (!v) {
                m = y + 1;
                break;
              }
            return (
              h === -1 || g === -1 || R === 0 || (R === 1 && h === g - 1 && h === m + 1)
                ? g !== -1 && (u.base = u.name = m === 0 && d ? l.slice(1, g) : l.slice(m, g))
                : (m === 0 && d
                    ? ((u.name = l.slice(1, h)), (u.base = l.slice(1, g)))
                    : ((u.name = l.slice(m, h)), (u.base = l.slice(m, g))),
                  (u.ext = l.slice(h, g))),
              m > 0 ? (u.dir = l.slice(0, m - 1)) : d && (u.dir = "/"),
              u
            );
          },
          sep: "/",
  ...
  ((() => {
    ...
    class d {
      ...
      constructor(T, _, x, P, b, N = !1) {
        typeof T == "object"
          ...
          : ((this.scheme = (function ($e, Q) {
              return $e || Q ? $e : "file";
            })(T, N)),
            (this.authority = _ || u),
            (this.path = (function ($e, Q) {
              switch ($e) {
                case "https":
                case "http":
                case "file":
      ...
      with(T) {
        if (!T) return this;
        let { scheme: _, authority: x, path: P, query: b, fragment: N } = T;
        return (
          _ === void 0 ? (_ = this.scheme) : _ === null && (_ = u),
          x === void 0 ? (x = this.authority) : x === null && (x = u),
          P === void 0 ? (P = this.path) : P === null && (P = u),
          b === void 0 ? (b = this.query) : b === null && (b = u),
      ...
      static parse(T, _ = !1) {
        const x = f.exec(T);
        return x
          ? new m(x[2] || u, oe(x[4] || u), oe(x[5] || u), oe(x[7] || u), oe(x[9] || u), _)
          : new m(u, u, u, u, u);
      }
      static file(T) {
        let _ = u;
        if ((i && (T = T.replace(/\\/g, c)), T[0] === c && T[1] === c)) {
          ...
          x === -1
            ? ((_ = T.substring(2)), (T = c))
            : ((_ = T.substring(2, x)), (T = T.substring(x) || c));
        }
        return new m("file", _, T, u, u);
      }
      static from(T) {
        const _ = new m(T.scheme, T.authority, T.path, T.query, T.fragment);
        return (l(_, !0), _);
      }
      toString(T = !1) {
        return $(this, T);
      ...
      static revive(T) {
        if (T) {
          ...
          {
            const _ = new m(T);
            return ((_._formatted = T.external), (_._fsPath = T._sep === h ? T.fsPath : null), _);
          }
        }
        return T;
      }
    ...
    class m extends d {
      ...
      toString(T = !1) {
        return T
          ? $(this, !0)
          : (this._formatted || (this._formatted = $(this, !1)), this._formatted);
      }
      toJSON() {
        const T = { $mid: 1 };
        return (
          this._fsPath && ((T.fsPath = this._fsPath), (T._sep = h)),
    ...
    function v(E, T, _) {
      ...
      for (let b = 0; b < E.length; b++) {
        ...
        if (
          ...
          (P !== -1 && ((x += encodeURIComponent(E.substring(P, b))), (P = -1)),
            x !== void 0 && (x += E.charAt(b)));
        else {
          x === void 0 && (x = E.substr(0, b));
          const $e = g[N];
          $e !== void 0
            ? (P !== -1 && ((x += encodeURIComponent(E.substring(P, b))), (P = -1)), (x += $e))
            : P === -1 && (P = b);
        }
      }
      return (P !== -1 && (x += encodeURIComponent(E.substring(P))), x !== void 0 ? x : E);
    }
    function y(E) {
      let T;
      for (let _ = 0; _ < E.length; _++) {
        const x = E.charCodeAt(_);
        x === 35 || x === 63
          ? (T === void 0 && (T = E.substr(0, _)), (T += g[x]))
          : T !== void 0 && (T += E[_]);
      }
      return T !== void 0 ? T : E;
    }
    ...
    function $(E, T) {
      const _ = T ? y : v;
      let x = "",
        { scheme: P, authority: b, path: N, query: $e, fragment: Q } = E;
      if ((P && ((x += P), (x += ":")), (b || P === "file") && ((x += c), (x += c)), b)) {
        let V = b.indexOf("@");
        if (V !== -1) {
          ...
          ((b = b.substr(V + 1)),
            ...
            V === -1
              ? (x += _(Ft, !1, !1))
              : ((x += _(Ft.substr(0, V), !1, !1)), (x += ":"), (x += _(Ft.substr(V + 1), !1, !0))),
            (x += "@"));
        }
        ((b = b.toLowerCase()),
          (V = b.lastIndexOf(":")),
          V === -1 ? (x += _(b, !1, !0)) : ((x += _(b.substr(0, V), !1, !0)), (x += b.substr(V))));
      }
      if (N) {
    ...
    function oe(E) {
      return E.match(O) ? E.replace(O, (T) => S(T)) : E;
    }
    var Me = n(470);
    const ve = Me.posix || Me,
      He = "/";
    var Ie;
    (function (E) {
      ((E.joinPath = function (T, ..._) {
        return T.with({ path: ve.join(T.path, ..._) });
      }),
        (E.resolvePath = function (T, ..._) {
          let x = T.path,
            P = !1;
          x[0] !== He && ((x = He + x), (P = !0));
          let b = ve.resolve(x, ..._);
          return (P && b[0] === He && !T.authority && (b = b.substring(1)), T.with({ path: b }));
        }),
        (E.dirname = function (T) {
          if (T.path.length === 0 || T.path === He) return T;
          let _ = ve.dirname(T.path);
          return (_.length === 1 && _.charCodeAt(0) === 46 && (_ = ""), T.with({ path: _ }));
        }),
...
var Ct;
(function (t) {
  ((t.basename = Yn.basename),
    (t.dirname = Yn.dirname),
    (t.extname = Yn.extname),
    (t.joinPath = Yn.joinPath),
    (t.resolvePath = Yn.resolvePath));
  function e(i, s) {
  ...
  function n(i, s) {
    const a = typeof i == "string" ? i : i.path,
      o = typeof s == "string" ? s : s.path,
      l = a.split("/").filter((h) => h.length > 0),
      u = o.split("/").filter((h) => h.length > 0);
    let c = 0;
    for (; c < l.length && l[c] === u[c]; c++);
    const f = "../".repeat(l.length - c),
      d = u.slice(c).join("/");
    return f + d;
  }
  t.relative = n;
...
class Kw {
  ...
  fromTextDocument(e, n, r) {
    return (
      (n = n ?? Jt.parse(e.uri)),
      z.CancellationToken.is(r) ? this.createAsync(n, e, r) : this.create(n, e, r)
    );
  }
  fromString(e, n, r) {
  ...
  createLangiumDocument(e, n, r, i) {
    let s;
    if (r) s = { parseResult: e, uri: n, state: H.Parsed, references: [], textDocument: r };
    else {
  ...
  async update(e, n) {
    ...
    const s =
      ...
      a = (i = this.textDocuments) === null || i === void 0 ? void 0 : i.get(e.uri.toString()),
      o = a ? a.getText() : await this.fileSystemProvider.readFile(e.uri);
    ...
    return (
      s !== o &&
        ((e.parseResult = await this.parseAsync(e.uri, o, n)), (e.parseResult.value.$document = e)),
      (e.state = H.Parsed),
      e
    );
  }
  ...
  createTextDocumentGetter(e, n) {
    ...
    let i;
    return () =>
      i ?? (i = _o.create(e.toString(), r.getServices(e).LanguageMetaData.languageId, 0, n ?? ""));
  }
}
class Hw {
  constructor(e) {
...
class Ww {
  ...
  async link(e, n = z.CancellationToken.None) {
    for (const r of hn(e.parseResult.value)) (await Ee(n), Wf(r).forEach((i) => this.doLink(i, e)));
  }
  doLink(e, n) {
    var r;
    const i = e.reference;
    if (i._ref === void 0) {
      ...
      try {
        ...
        i._ref = Object.assign(Object.assign({}, e), {
          message: `An error occurred while resolving reference to '${i.$refText}': ${a}`,
        });
      }
      n.references.push(i);
    }
  ...
  unlink(e) {
    for (const n of e.references) (delete n._ref, delete n._nodeDescription);
    e.references = [];
  }
  getCandidate(e) {
    ...
    const s = this,
      a = {
        ...
        get ref() {
          ...
          if (Fp(this._nodeDescription)) {
            const l = s.loadAstNode(this._nodeDescription);
            this._ref =
              l ??
              s.createLinkingError(
                { reference: a, container: e, property: n },
                this._nodeDescription
              );
          } else if (this._ref === void 0) {
            this._ref = Ea;
            const l = Ua(e).$document,
              u = s.getLinkedNode({ reference: a, container: e, property: n });
            if (u.error && l && l.state < H.ComputedScopes) return (this._ref = void 0);
            ((this._ref = (o = u.node) !== null && o !== void 0 ? o : u.error),
              (this._nodeDescription = u.descr),
              l?.references.push(this));
          } else if (this._ref === Ea)
            throw new Error(
              `Cyclic reference resolution detected: ${s.astNodeLocator.getAstNodePath(e)}/${n} (symbol '${i}')`
            );
  ...
  getLinkedNode(e) {
    ...
    try {
      ...
      if (wi(r)) return { error: r };
      const i = this.loadAstNode(r);
      return i ? { node: i, descr: r } : { descr: r, error: this.createLinkingError(e, r) };
    } catch (r) {
...
class qw {
  ...
  findReferences(e, n) {
    ...
    return (
      n.documentUri && (i = i.filter((s) => Ct.equals(s.sourceUri, n.documentUri))),
      r.push(...i),
      ie(r)
    );
  }
...
class Yw {
  ...
  async computeExportsForNode(e, n, r = Oo, i = z.CancellationToken.None) {
    ...
    for (const a of r(e)) (await Ee(i), this.exportNode(a, s, n));
    return s;
  }
  exportNode(e, n, r) {
  ...
  async computeLocalScopes(e, n = z.CancellationToken.None) {
    const r = e.parseResult.value,
      i = new gs();
    for (const s of Wr(r)) (await Ee(n), this.processNode(s, e, i));
    return i;
  }
  processNode(e, n, r) {
    const i = e.$container;
...
class eC {
  constructor(e) {
    ((this.reflection = e.shared.AstReflection),
      ...
      (this.globalScopeCache = new Qw(e.shared)));
  }
  getScope(e) {
    const n = [],
      r = this.reflection.getReferenceType(e),
      i = Rt(e.container).precomputedScopes;
    if (i) {
      let a = e.container;
      do {
        const o = i.get(a);
        (o.length > 0 && n.push(ie(o).filter((l) => this.reflection.isSubtype(l.type, r))),
          (a = a.$container));
      } while (a);
    }
  ...
  getGlobalScope(e, n) {
    return this.globalScopeCache.get(e, () => new Xw(this.indexManager.allElements(e)));
  }
}
function tC(t) {
...
class nC {
  ...
  replacer(e, n, { refText: r, sourceText: i, textRegions: s, comments: a, uriConverter: o }) {
    ...
    if (!this.ignoreProperties.has(e))
      if (ze(n)) {
        const d = n.ref,
          h = r ? n.$refText : void 0;
        if (d) {
          const m = Rt(d);
          let g = "";
          this.currentDocument &&
            this.currentDocument !== m &&
            (o ? (g = o(m.uri, n)) : (g = m.uri.toString()));
          const v = this.astNodeLocator.getAstNodePath(d);
          return { $ref: `${g}#${v}`, $refText: h };
        } else
          return {
            $error:
              (u = (l = n.error) === null || l === void 0 ? void 0 : l.message) !== null &&
              u !== void 0
                ? u
        ...
        if (
          (s &&
            ((d = this.addAstNodeRegionWithAssignmentsTo(Object.assign({}, n))),
            (!e || n.$document) &&
              d?.$textRegion &&
              (d.$textRegion.documentURI =
                (c = this.currentDocument) === null || c === void 0 ? void 0 : c.uri.toString())),
          i &&
            !e &&
            (d ?? (d = Object.assign({}, n)),
            (d.$sourceText = (f = n.$cstNode) === null || f === void 0 ? void 0 : f.text)),
          a)
        ) {
          d ?? (d = Object.assign({}, n));
    ...
    for (const [l, u] of Object.entries(e))
      if (Array.isArray(u))
        for (let c = 0; c < u.length; c++) {
          const f = u[c];
          vf(f)
            ? (u[c] = this.reviveReference(e, l, n, f, r))
            : ue(f) && this.linkNode(f, n, r, e, l, c);
        }
      else
        vf(u)
          ? (e[l] = this.reviveReference(e, l, n, u, r))
          : ue(u) && this.linkNode(u, n, r, e, l);
    const o = e;
  ...
  reviveReference(e, n, r, i, s) {
    ...
    if (i.$ref) {
      ...
      if (ue(l)) return (a || (a = this.nameProvider.getName(l)), { $refText: a ?? "", ref: l });
      o = l;
    }
    if (o) {
      const l = { $refText: a ?? "" };
      return ((l.error = { container: e, property: n, message: o, reference: l }), l);
    } else return;
  }
  getRefNode(e, n, r) {
    try {
      ...
      if (i < 0) {
        const l = r ? r(n) : Jt.parse(n),
          u = this.langiumDocuments.getDocument(l);
        return u ? u.parseResult.value : "Could not find document for URI: " + n;
      }
      const s = r ? r(n.substring(0, i)) : Jt.parse(n.substring(0, i)),
...
class rC {
  ...
  register(e) {
    ...
    for (const r of n.fileExtensions)
      (this.fileExtensionMap.has(r) &&
        console.warn(
          `The file extension ${r} is used by multiple languages. It is now assigned to '${n.languageId}'.`
        ),
        this.fileExtensionMap.set(r, e));
    (this.languageIdMap.set(n.languageId, e),
      this.languageIdMap.size === 1 ? (this.singleton = e) : (this.singleton = void 0));
  }
  getServices(e) {
    var n, r;
    ...
    const i =
      (r = (n = this.textDocuments) === null || n === void 0 ? void 0 : n.get(e)) === null ||
      r === void 0
        ? void 0
        : r.languageId;
    if (i !== void 0) {
    ...
    const s = Ct.extname(e),
      a = this.fileExtensionMap.get(s);
    if (!a)
      throw i
        ? new Error(
...
class iC {
  ...
  register(e, n = this, r = "fast") {
    ...
    for (const [i, s] of Object.entries(e)) {
      ...
      if (Array.isArray(a))
        for (const o of a) {
          const l = { check: this.wrapValidationException(o, n), category: r };
          this.addEntry(i, l);
        }
  ...
  registerBeforeDocument(e, n = this) {
    this.entriesBefore.push(
      this.wrapPreparationException(e, "An error occurred during set-up of the validation", n)
    );
  }
  registerAfterDocument(e, n = this) {
    this.entriesAfter.push(
      this.wrapPreparationException(e, "An error occurred during tear-down of the validation", n)
    );
  }
...
class sC {
  ...
  processLexingErrors(e, n, r) {
    ...
    const o = [
      ...e.lexerErrors,
      ...((s = (i = e.lexerReport) === null || i === void 0 ? void 0 : i.diagnostics) !== null &&
      s !== void 0
        ? s
        : []),
    ];
    for (const l of o) {
      const u = (a = l.severity) !== null && a !== void 0 ? a : "error",
        c = {
          severity: Sa(u),
          range: {
  ...
  async validateAstNodes(e, n, r, i = z.CancellationToken.None) {
    await Promise.all(
      hn(e).map(async (s) => {
        ...
        for (const o of a) await o(s, r, i);
      })
    );
  }
...
function aC(t) {
  ...
  return (
    typeof t.property == "string"
      ...
      : typeof t.keyword == "string" && (e = wm(t.node.$cstNode, t.keyword, t.index)),
    e ?? (e = t.node.$cstNode),
...
class lC {
  ...
  createDescription(e, n, r) {
    ...
    const o = () => {
      ...
      return (
        a ??
        (a = Wi((l = this.nameProvider.getNameNode(e)) !== null && l !== void 0 ? l : e.$cstNode))
      );
    };
    return {
      node: e,
...
class uC {
  ...
  createDescription(e) {
    const n = e.reference.$nodeDescription,
...
class dC {
  constructor(e) {
    ((this._ready = new Al()),
      ...
      (this.onConfigurationSectionUpdateEmitter = new fC.Emitter()),
      (this.serviceRegistry = e.ServiceRegistry));
  }
  get ready() {
  ...
  initialize(e) {
    ...
    this.workspaceConfig =
      (r = (n = e.capabilities.workspace) === null || n === void 0 ? void 0 : n.configuration) !==
        null && r !== void 0
        ? r
        : !1;
  }
  ...
  updateConfiguration(e) {
    e.settings &&
      Object.keys(e.settings).forEach((n) => {
...
class hC {
  constructor(e) {
    ((this.updateBuildOptions = { validation: { categories: ["built-in", "fast"] } }),
      ...
      (this.buildPhaseListeners = new gs()),
      (this.documentPhaseListeners = new gs()),
      ...
      if (a.state === H.Validated) {
        if (typeof n.validation == "boolean" && n.validation)
          ...
          const l = this.buildState.get(o),
            u = (i = l?.result) === null || i === void 0 ? void 0 : i.validationChecks;
          if (u) {
            const f = ((s = n.validation.categories) !== null && s !== void 0 ? s : ys.all).filter(
              (d) => !u.includes(d)
            );
            f.length > 0 &&
  ...
  async update(e, n, r = z.CancellationToken.None) {
    ...
    (this.langiumDocuments.all
      .filter((a) => !i.has(a.uri.toString()) && this.shouldRelink(a, i))
      .forEach((a) => {
        (this.serviceRegistry.getServices(a.uri).references.Linker.unlink(a),
          (a.state = Math.min(a.state, H.ComputedScopes)),
          (a.diagnostics = void 0));
      }),
      await this.emitUpdate(e, n),
      await Ee(r));
    const s = this.sortDocuments(
      this.langiumDocuments.all
        .filter((a) => {
          var o;
          return (
            a.state < H.Linked ||
            !(
              !((o = this.buildState.get(a.uri.toString())) === null || o === void 0) && o.completed
            )
          );
        })
        .toArray()
  ...
  async buildDocuments(e, n, r) {
    (this.prepareBuild(e, n),
      await this.runCancelable(e, H.Parsed, r, (s) => this.langiumDocumentFactory.update(s, r)),
      await this.runCancelable(e, H.IndexedContent, r, (s) =>
        this.indexManager.updateContent(s, r)
      ),
      await this.runCancelable(e, H.ComputedScopes, r, async (s) => {
      ...
      await this.runCancelable(e, H.Linked, r, (s) =>
        this.serviceRegistry.getServices(s.uri).references.Linker.link(s, r)
      ),
      await this.runCancelable(e, H.IndexedReferences, r, (s) =>
        this.indexManager.updateReferences(s, r)
      ));
  ...
  prepareBuild(e, n) {
    for (const r of e) {
      ...
      (!s || s.completed) &&
        this.buildState.set(i, { completed: !1, options: n, result: s?.result });
    }
  }
  ...
  async notifyBuildPhase(e, n, r) {
    ...
    for (const a of s) (await Ee(r), await a(e, r));
  }
  shouldValidate(e) {
  ...
  async validate(e, n) {
    ...
    const s = this.serviceRegistry.getServices(e.uri).validation.DocumentValidator,
      a = this.getBuildOptions(e).validation,
      o = typeof a == "object" ? a : void 0,
      l = await s.validateDocument(e, o, n);
  ...
  getBuildOptions(e) {
    var n, r;
    return (r =
      (n = this.buildState.get(e.uri.toString())) === null || n === void 0 ? void 0 : n.options) !==
      null && r !== void 0
      ? r
      : {};
  }
...
class pC {
  ...
  getFileDescriptions(e, n) {
    ...
    return n
      ? this.symbolByTypeIndex.get(e, n, () => {
          var s;
          return ((s = this.symbolIndex.get(e)) !== null && s !== void 0 ? s : []).filter((o) =>
            this.astReflection.isSubtype(o.type, n)
          );
        })
  ...
  async updateContent(e, n = z.CancellationToken.None) {
    const i = await this.serviceRegistry
        .getServices(e.uri)
        .references.ScopeComputation.computeExports(e, n),
      s = e.uri.toString();
...
class mC {
  ...
  async performStartup(e) {
    const n = this.serviceRegistry.all.flatMap((s) => s.LanguageMetaData.fileExtensions),
      r = [],
      i = (s) => {
        (r.push(s),
          this.langiumDocuments.hasDocument(s.uri) || this.langiumDocuments.addDocument(s));
      };
    return (
      await this.loadAdditionalDocuments(e, i),
      await Promise.all(
        e.map((s) => [s, this.getRootFolder(s)]).map(async (s) => this.traverseFolder(...s, n, i))
      ),
      this._ready.resolve(),
      r
    );
    ...
    await Promise.all(
      s.map(async (a) => {
        if (this.includeEntry(e, a, r)) {
          if (a.isDirectory) await this.traverseFolder(e, a.uri, r, i);
          else if (a.isFile) {
  ...
  includeEntry(e, n, r) {
    ...
    if (n.isDirectory) return i !== "node_modules" && i !== "out";
    if (n.isFile) {
...
class TC {
  ...
  tokenize(e, n = yC) {
    ...
    return {
      ...
      report:
        (s = (i = this.tokenBuilder).flushLexingReport) === null || s === void 0
          ? void 0
          : s.call(i, e),
    };
  }
  toTokenTypeDictionary(e) {
    if ($f(e)) return e;
    const n = sp(e) ? Object.values(e.modes).flat() : e,
      r = {};
...
function $C(t, e, n) {
  let r, i;
  (typeof t == "string" ? ((i = e), (r = n)) : ((i = t.range.start), (r = e)),
    i || (i = D.create(0, 0)));
  const s = ap(t),
    a = El(r),
    o = EC({ lines: s, position: i, options: a });
  return wC({ index: 0, tokens: o, position: i });
}
function RC(t, e) {
  const n = El(e),
    r = ap(t);
...
function ap(t) {
  let e = "";
  return (typeof t == "string" ? (e = t) : (e = t.text), e.split(mm));
}
...
function EC(t) {
  ...
  let s = t.position.line,
    a = t.position.character;
  for (let o = 0; o < t.lines.length; o++) {
    const l = o === 0,
      u = o === t.lines.length - 1;
    let c = t.lines[o],
      f = 0;
    ...
    if (((c = c.substring(0, IC(c))), wo(c, f) >= c.length)) {
      if (i.length > 0) {
        ...
        i.push({ type: "break", content: "", range: L.create(h, h) });
      }
    } else {
      Rf.lastIndex = f;
      const h = Rf.exec(c);
      if (h) {
        const m = h[0],
          g = h[1],
          v = D.create(s, a + f),
          y = D.create(s, a + f + m.length);
        (i.push({ type: "tag", content: g, range: L.create(v, y) }),
          (f += m.length),
          (f = wo(c, f)));
      }
      if (f < c.length) {
        const m = c.substring(f),
          g = Array.from(m.matchAll(AC));
        i.push(...SC(g, m, s, a + f));
      }
    }
    (s++, (a = 0));
...
function SC(t, e, n, r) {
  const i = [];
  if (t.length === 0) {
    const s = D.create(n, r),
      a = D.create(n, r + e.length);
    i.push({ type: "text", content: e, range: L.create(s, a) });
  } else {
    let s = 0;
    for (const o of t) {
      const l = o.index,
...
function wC(t) {
  ...
  if (t.tokens.length === 0) return new Af([], L.create(s, s));
  const a = [];
  for (; t.index < t.tokens.length; ) {
    const u = CC(t, a[a.length - 1]);
    u && a.push(u);
  }
  const o =
      (n = (e = a[0]) === null || e === void 0 ? void 0 : e.range.start) !== null && n !== void 0
        ? n
        : s,
    l =
      (i = (r = a[a.length - 1]) === null || r === void 0 ? void 0 : r.range.end) !== null &&
      i !== void 0
        ? i
        : s;
  return new Af(a, L.create(o, l));
}
function CC(t, e) {
  const n = t.tokens[t.index];
  if (n.type === "tag") return lp(t, !1);
  if (n.type === "text" || n.type === "inline-tag") return op(t);
  (kC(n, e), t.index++);
}
function kC(t, e) {
  if (e) {
...
function op(t) {
  ...
  for (; e && e.type !== "break" && e.type !== "tag"; )
    (i.push(NC(t)), (r = e), (e = t.tokens[t.index]));
  return new Co(i, L.create(n.range.start, r.range.end));
}
function NC(t) {
...
function lp(t, e) {
  ...
  if (i?.type === "text")
    if (e) {
      const s = up(t);
      return new _a(r, new Co([s], s.range), e, L.create(n.range.start, s.range.end));
    } else {
      const s = op(t);
      return new _a(r, s, e, L.create(n.range.start, s.range.end));
    }
  else {
    const s = n.range;
    return new _a(r, new Co([], s), e, s);
  }
}
function up(t) {
...
function El(t) {
  if (!t) return El({ start: "/**", end: "*/", line: "*" });
  const { start: e, end: n, line: r } = t;
  return { start: xa(e, !0), end: xa(n, !1), line: xa(r, !0) };
}
function xa(t, e) {
...
${n}`),
  ...
  toMarkdown(e) {
    var n, r;
    return (r = (n = e?.renderTag) === null || n === void 0 ? void 0 : n.call(e, this)) !== null &&
      r !== void 0
      ? r
...
function bC(t, e, n) {
  ...
  if (t === "linkplain" || t === "linkcode" || t === "link") {
    ...
    return (
      (t === "linkcode" || (t === "link" && n.link === "code")) && (a = `\`${a}\``),
      (i = (r = n.renderLink) === null || r === void 0 ? void 0 : r.call(n, e, a)) !== null &&
      i !== void 0
        ? i
        : OC(e, a)
    );
...
class PC {
  ...
  documentationLinkRenderer(e, n, r) {
    var i;
    const s =
      (i = this.findNameInPrecomputedScopes(e, n)) !== null && i !== void 0
        ? i
        : this.findNameInGlobalScope(e, n);
    if (s && s.nameSegment) {
      const a = s.nameSegment.range.start.line + 1,
        o = s.nameSegment.range.start.character + 1,
        l = s.documentUri.with({ fragment: `L${a},${o}` });
      return `[${r}](${l.toString()})`;
    } else return;
  }
...
class LC {
  ...
  getComment(e) {
    ...
    return tC(e)
      ? e.$comment
      : (n = Wp(e.$cstNode, this.grammarConfig().multilineCommentRules)) === null || n === void 0
        ? void 0
        : n.text;
  }
}
...
class FC {
  constructor(e) {
    ((this.grammarElementIdMap = new yf()),
      (this.tokenTypeIdMap = new yf()),
  ...
  dehydrate(e) {
    return {
      ...
      parserErrors: e.parserErrors.map((n) =>
        Object.assign(Object.assign({}, n), { message: n.message })
      ),
  ...
  createDehyrationContext(e) {
    const n = new Map(),
      r = new Map();
    for (const i of hn(e)) n.set(i, {});
    if (e.$cstNode) for (const i of Fa(e.$cstNode)) r.set(i, {});
    ...
    for (const [i, s] of Object.entries(e))
      if (!i.startsWith("$"))
        if (Array.isArray(s)) {
          ...
          for (const o of s)
            ue(o)
              ? a.push(this.dehydrateAstNode(o, n))
              : ze(o)
                ? a.push(this.dehydrateReference(o, n))
                : a.push(o);
        } else
          ue(s)
  ...
  createHydrationContext(e) {
    const n = new Map(),
      r = new Map();
    for (const s of hn(e)) n.set(s, {});
    let i;
    if (e.$cstNode)
      for (const s of Fa(e.$cstNode)) {
        let a;
        ("fullText" in s
          ? ((a = new Kh(s.fullText)), (i = a))
          : "content" in s
            ? (a = new $l())
  ...
  hydrateCstLeafNode(e) {
    const n = this.getTokenType(e.tokenType),
      ...
      l = e.endColumn,
      u = e.hidden;
    return new Eo(r, i, { start: { line: s, character: a }, end: { line: o, character: l } }, n, u);
  }
  getTokenType(e) {
  ...
  createGrammarElementIdMap() {
    let e = 0;
    for (const n of hn(this.grammar)) Vp(n) && this.grammarElementIdMap.set(n, e++);
  }
}
function Pt(t) {
  return {
    documentation: { CommentProvider: (e) => new LC(e), DocumentationProvider: (e) => new PC(e) },
    parser: {
      AsyncParser: (e) => new MC(e),
      GrammarConfig: (e) => Fm(e),
      LangiumParser: (e) => Lw(e),
      CompletionParser: (e) => Pw(e),
      ValueConverter: () => new Zh(),
      TokenBuilder: () => new Jh(),
      Lexer: (e) => new TC(e),
      ParserErrorMessageProvider: () => new zh(),
      LexerErrorMessageProvider: () => new gC(),
    },
    workspace: {
      AstNodeLocator: () => new cC(),
      AstNodeDescriptionProvider: (e) => new lC(e),
      ReferenceDescriptionProvider: (e) => new uC(e),
    },
    references: {
      Linker: (e) => new Ww(e),
      NameProvider: () => new Vw(),
      ScopeProvider: (e) => new eC(e),
      ScopeComputation: (e) => new Yw(e),
      References: (e) => new qw(e),
    },
    serializer: { Hydrator: (e) => new FC(e), JsonSerializer: (e) => new nC(e) },
    validation: { DocumentValidator: (e) => new sC(e), ValidationRegistry: (e) => new iC(e) },
    shared: () => t.shared,
  };
}
function Lt(t) {
  return {
    ServiceRegistry: (e) => new rC(e),
    workspace: {
      LangiumDocuments: (e) => new Hw(e),
      LangiumDocumentFactory: (e) => new Kw(e),
      DocumentBuilder: (e) => new hC(e),
      IndexManager: (e) => new pC(e),
      WorkspaceManager: (e) => new mC(e),
      FileSystemProvider: (e) => t.fileSystemProvider(e),
      WorkspaceLock: () => new DC(),
      ConfigurationProvider: (e) => new dC(e),
    },
  };
}
var Sf;
...
const Mt = { fileSystemProvider: () => new UC() },
  BC = {
    Grammar: () => {},
    LanguageMetaData: () => ({
      caseInsensitive: !1,
...
function on(t) {
  var e;
  const n = KC(),
    r = n.serializer.JsonSerializer.deserialize(t);
  return (
    n.shared.workspace.LangiumDocumentFactory.fromModel(
      r,
      Jt.parse(`memory://${(e = r.name) !== null && e !== void 0 ? e : "grammar"}.langium`)
    ),
    r
  );
}
var HC = Object.defineProperty,
  A = (t, e) => HC(t, "name", { value: e, configurable: !0 }),
  If = "Statement",
  Di = "Architecture";
function WC(t) {
...
var Ma = "TreemapRow",
    ...
    ((gn = class extends Lf {
      ...
      getTypeMetaData(e) {
        switch (e) {
          ...
          case Ri:
            return { name: Ri, properties: [{ name: "label" }, { name: "name" }] };
          case wr:
            return { name: wr, properties: [{ name: "name" }, { name: "order" }] };
          case Ai:
            return { name: Ai, properties: [{ name: "branch" }] };
          case Ei:
            return {
              name: Ei,
          ...
          case Ia:
            return { name: Ia, properties: [{ name: "className" }, { name: "styleText" }] };
          case Cr:
            return {
              name: Cr,
              properties: [
          ...
          case ka:
            return { name: ka, properties: [{ name: "axis" }, { name: "value" }] };
          case kr:
            return {
              name: kr,
              properties: [
          ...
          case Si:
            return { name: Si, properties: [{ name: "classSelector" }, { name: "name" }] };
          case ba:
            return { name: ba, properties: [{ name: "id" }, { name: "in" }] };
          case Nr:
            return {
              name: Nr,
              properties: [
          ...
          case ji:
            return { name: ji, properties: [{ name: "label" }, { name: "value" }] };
          case Pa:
            return {
              name: Pa,
              properties: [
          ...
          case Ma:
            return { name: Ma, properties: [{ name: "indent" }, { name: "item" }] };
          case xi:
            return {
              name: xi,
              properties: [
          ...
          case _i:
            return {
              name: _i,
              properties: [{ name: "classSelector" }, { name: "name" }, { name: "value" }],
            };
          case Ii:
            return { name: Ii, properties: [{ name: "classSelector" }, { name: "name" }] };
          default:
            return { name: e, properties: [] };
        }
      }
  ...
  ln = { AstReflection: A(() => new dp(), "AstReflection") },
  gk = {
    Grammar: A(() => nk(), "Grammar"),
    LanguageMetaData: A(() => uk, "LanguageMetaData"),
    parser: {},
  },
  yk = {
    Grammar: A(() => rk(), "Grammar"),
    LanguageMetaData: A(() => ck, "LanguageMetaData"),
    parser: {},
  },
  Tk = {
    Grammar: A(() => ik(), "Grammar"),
    LanguageMetaData: A(() => fk, "LanguageMetaData"),
    parser: {},
  },
  vk = {
    Grammar: A(() => sk(), "Grammar"),
    LanguageMetaData: A(() => dk, "LanguageMetaData"),
    parser: {},
  },
  $k = {
    Grammar: A(() => ak(), "Grammar"),
    LanguageMetaData: A(() => hk, "LanguageMetaData"),
    parser: {},
  },
  Rk = {
    Grammar: A(() => ok(), "Grammar"),
    LanguageMetaData: A(() => pk, "LanguageMetaData"),
    parser: {},
  },
  Ak = {
    Grammar: A(() => lk(), "Grammar"),
    LanguageMetaData: A(() => mk, "LanguageMetaData"),
    parser: {},
  },
  Ek = /accDescr(?:[\t ]*:([^\n\r]*)|\s*{([^}]*)})/,
  Sk = /accTitle[\t ]*:([^\n\r]*)/,
  xk = /title([\t ][^\n\r]*|)/,
  _k = { ACC_DESCR: Ek, ACC_TITLE: Sk, TITLE: xk },
  yn,
  Qs =
    ((yn = class extends Zh {
      runConverter(e, n, r) {
        ...
        return (
          i === void 0 && (i = this.runCustomConverter(e, n, r)),
          i === void 0 ? super.runConverter(e, n, r) : i
        );
      }
...
`
    ...
    A(yn, "AbstractMermaidValueConverter"),
    yn),
  Tn,
  ea =
    ((Tn = class extends Qs {
  ...
  Dt =
    ...
    A(vn, "AbstractMermaidTokenBuilder"),
    vn),
  $n;
(($n = class extends Dt {}), A($n, "CommonTokenBuilder"));
var Rn,
  Ik =
    ((Rn = class extends Dt {
      constructor() {
    ...
    A(Rn, "GitGraphTokenBuilder"),
    Rn),
  hp = {
    parser: {
      TokenBuilder: A(() => new Ik(), "TokenBuilder"),
      ValueConverter: A(() => new ea(), "ValueConverter"),
    },
  };
function pp(t = Mt) {
  const e = ce(Lt(t), ln),
    n = ce(Pt({ shared: e }), $k, hp);
...
var An,
  wk =
    ...
    A(An, "InfoTokenBuilder"),
    An),
  mp = {
    parser: {
      TokenBuilder: A(() => new wk(), "TokenBuilder"),
      ValueConverter: A(() => new ea(), "ValueConverter"),
    },
  };
function gp(t = Mt) {
  const e = ce(Lt(t), ln),
    n = ce(Pt({ shared: e }), gk, mp);
...
var En,
  Ck =
    ...
    A(En, "PacketTokenBuilder"),
    En),
  yp = {
    parser: {
      TokenBuilder: A(() => new Ck(), "TokenBuilder"),
      ValueConverter: A(() => new ea(), "ValueConverter"),
    },
  };
function Tp(t = Mt) {
  const e = ce(Lt(t), ln),
    n = ce(Pt({ shared: e }), yk, yp);
...
var Sn,
  ...
  Nk =
    ...
    A(xn, "PieValueConverter"),
    xn),
  vp = {
    parser: {
      TokenBuilder: A(() => new kk(), "TokenBuilder"),
      ValueConverter: A(() => new Nk(), "ValueConverter"),
    },
  };
function $p(t = Mt) {
  const e = ce(Lt(t), ln),
    n = ce(Pt({ shared: e }), Tk, vp);
...
var _n,
  ...
  Ok =
    ...
    A(In, "ArchitectureValueConverter"),
    In),
  Rp = {
    parser: {
      TokenBuilder: A(() => new bk(), "TokenBuilder"),
      ValueConverter: A(() => new Ok(), "ValueConverter"),
    },
  };
function Ap(t = Mt) {
  const e = ce(Lt(t), ln),
    n = ce(Pt({ shared: e }), vk, Rp);
...
var wn,
  Pk =
    ...
    A(wn, "RadarTokenBuilder"),
    wn),
  Ep = {
    parser: {
      TokenBuilder: A(() => new Pk(), "TokenBuilder"),
      ValueConverter: A(() => new ea(), "ValueConverter"),
    },
  };
function Sp(t = Mt) {
  const e = ce(Lt(t), ln),
    n = ce(Pt({ shared: e }), Rk, Ep);
  return (e.ServiceRegistry.register(n), { shared: e, Radar: n });
}
A(Sp, "createRadarServices");
var Cn,
  Lk =
    ((Cn = class extends Dt {
      constructor() {
    ...
    A(Cn, "TreemapTokenBuilder"),
    Cn),
  Mk = /classDef\s+([A-Z_a-z]\w+)(?:\s+([^\n\r;]*))?;?/,
  kn,
  Dk =
    ((kn = class extends Qs {
      runCustomConverter(e, n, r) {
...
var Nn,
  Fk =
        ...
        for (const i of e.TreemapRows)
          i.item &&
            (r === void 0 && i.indent === void 0
              ? (r = 0)
              : i.indent === void 0
                ? n("error", "Multiple root nodes are not allowed in a treemap.", {
                    node: i,
                    property: "item",
                  })
                : r !== void 0 &&
    ...
    A(Nn, "TreemapValidator"),
    Nn),
  _p = {
    parser: {
      TokenBuilder: A(() => new Lk(), "TokenBuilder"),
      ValueConverter: A(() => new Dk(), "ValueConverter"),
    },
    validation: { TreemapValidator: A(() => new Fk(), "TreemapValidator") },
  };
function Ip(t = Mt) {
  const e = ce(Lt(t), ln),
    n = ce(Pt({ shared: e }), Ak, _p);
...
var it = {},
  Gk = {
    info: A(async () => {
      const { createInfoServices: t } = await Ut(
          async () => {
            const { createInfoServices: n } = await Promise.resolve().then(() => jk);
    ...
    packet: A(async () => {
      const { createPacketServices: t } = await Ut(
          async () => {
            const { createPacketServices: n } = await Promise.resolve().then(() => Kk);
    ...
    pie: A(async () => {
      const { createPieServices: t } = await Ut(
          async () => {
            const { createPieServices: n } = await Promise.resolve().then(() => Hk);
    ...
    architecture: A(async () => {
      const { createArchitectureServices: t } = await Ut(
          async () => {
            const { createArchitectureServices: n } = await Promise.resolve().then(() => Wk);
    ...
    gitGraph: A(async () => {
      const { createGitGraphServices: t } = await Ut(
          async () => {
            const { createGitGraphServices: n } = await Promise.resolve().then(() => zk);
    ...
    radar: A(async () => {
      const { createRadarServices: t } = await Ut(
          async () => {
            const { createRadarServices: n } = await Promise.resolve().then(() => Vk);
    ...
    treemap: A(async () => {
      const { createTreemapServices: t } = await Ut(
          async () => {
            const { createTreemapServices: n } = await Promise.resolve().then(() => qk);
...
async function Uk(t, e) {
  ...
  if (i.lexerErrors.length > 0 || i.parserErrors.length > 0) throw new Bk(i);
  return i.value;
}
A(Uk, "parse");
var bn,
...
`);
    ...
    A(bn, "MermaidParseError"),
    bn);
const jk = Object.freeze(
    Object.defineProperty(
      { __proto__: null, InfoModule: mp, createInfoServices: gp },
      Symbol.toStringTag,
      { value: "Module" }
    )
  ),
  Kk = Object.freeze(
    Object.defineProperty(
      { __proto__: null, PacketModule: yp, createPacketServices: Tp },
      Symbol.toStringTag,
      { value: "Module" }
    )
  ),
  Hk = Object.freeze(
    Object.defineProperty(
      { __proto__: null, PieModule: vp, createPieServices: $p },
      Symbol.toStringTag,
      { value: "Module" }
    )
  ),
  Wk = Object.freeze(
    Object.defineProperty(
      { __proto__: null, ArchitectureModule: Rp, createArchitectureServices: Ap },
      Symbol.toStringTag,
      { value: "Module" }
    )
  ),
  zk = Object.freeze(
    Object.defineProperty(
      { __proto__: null, GitGraphModule: hp, createGitGraphServices: pp },
      Symbol.toStringTag,
      { value: "Module" }
    )
  ),
  Vk = Object.freeze(
    Object.defineProperty(
      { __proto__: null, RadarModule: Ep, createRadarServices: Sp },
      Symbol.toStringTag,
      { value: "Module" }
    )
  ),
  qk = Object.freeze(
    Object.defineProperty(
      { __proto__: null, TreemapModule: _p, createTreemapServices: Ip },
      Symbol.toStringTag,
      { value: "Module" }
    )
  );
