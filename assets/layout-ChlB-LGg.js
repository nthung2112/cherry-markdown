import { b as Ve, G as g, i as m, v as E } from "./graph-VRRTmXQU.js";
import {
  i as X,
  d as C,
  k as Ye,
  ...
  m as I,
  r as B,
} from "./baseUniq-DfLQT-4m.js";
import { f as O, b as me, a as He, c as Ue, m as w, d as P } from "./min-CeHOP0ym.js";
import {
  aZ as M,
  bj as Ze,
  bk as Je,
...
var k = $n(),
  R = ge(function (e, n) {
    ...
    var r = n.length;
    return (
      r > 1 && S(e, n[0], n[1]) ? (n = []) : r > 2 && S(n[0], n[1], n[2]) && (n = [n[0]]),
      Bn(e, Xe(n), [])
    );
  }),
  Dn = 0;
...
function Kn(e) {
  ...
  f(n, function (t) {
    var i = e.edge(t);
    (e.removeEdge(t),
      (i.forwardName = t.name),
      (i.reversed = !0),
      e.setEdge(t.w, t.v, i, J("rev")));
  });
  function r(t) {
    return function (i) {
  ...
  ((t = t.slice(1)),
    f(t, function (i) {
      var o = e.node(i).parent,
        ...
        u = !1;
      (a || ((a = n.edge(o, i)), (u = !0)),
        (n.node(i).rank = n.node(o).rank + (u ? a.minlen : -a.minlen)));
    }));
}
function Er(e, n, r) {
...
function jr(e) {
  ...
  function r(o) {
    return function (a) {
      a.merged ||
        ((m(a.barycenter) || m(o.barycenter) || a.barycenter >= o.barycenter) && Gr(o, a));
    };
  }
  function t(o) {
    return function (a) {
...
function ct(e, n) {
  (f(e.nodes(), function (r) {
    ...
    t &&
      ((t.x = i.x),
      (t.y = i.y),
      n.children(r).length && ((t.width = i.width), (t.height = i.height)));
  }),
    f(e.edges(), function (r) {
      var t = e.edge(r),
        i = n.edge(r);
      ((t.points = i.points),
        Object.prototype.hasOwnProperty.call(i, "x") && ((t.x = i.x), (t.y = i.y)));
    }),
...
function yt(e) {
  ...
  return (
    ...
    f(e.edges(), function (t) {
      var i = W(e.edge(t));
      n.setEdge(t, z({}, mt, q(i, bt), A(i, gt)));
    }),
    n
  );
}
